...
.method private fillSegment(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$FillBlock;Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;)V
    ...
    invoke-direct {v0, v2}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->isDataIndependentAddressing(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;)Z

    move-result v7

    invoke-static {v2}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->getStartingIndex(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;)I

    move-result v6

    iget v3, v2, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;->lane:I

    iget v4, v0, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->laneLength:I

    mul-int/2addr v3, v4

    iget v4, v2, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;->slice:I
    ...
    invoke-direct {v0, v8}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->getPrevOffset(I)I

    move-result v9

    if-eqz v7, :cond_0

    iget-object v3, v1, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$FillBlock;->addressBlock:Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;
    ...
    iget-object v3, v1, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$FillBlock;->zeroBlock:Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;

    invoke-virtual {v3}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;->clear()Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;

    move-result-object v3

    iget-object v4, v1, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$FillBlock;->inputBlock:Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;
    ...
    :goto_0
    iput v6, v2, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;->index:I

    :goto_1
    iget v1, v2, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;->index:I

    iget v6, v0, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->segmentLength:I

    if-ge v1, v6, :cond_3

    invoke-direct {v0, v8, v9}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->rotatePrevOffset(II)I
    ...
    invoke-direct {v0, v2, v9, v10}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->getRefLane(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;J)I

    move-result v11

    iget v12, v2, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;->lane:I
    ...
    :goto_2
    invoke-direct {v0, v2, v9, v10, v12}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->getRefColumn(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;JZ)I

    move-result v9

    iget-object v10, v0, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->memory:[Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;

    aget-object v12, v10, v6

    iget v14, v0, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->laneLength:I
    ...
    invoke-direct {v0, v2}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->isWithXor(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;)Z

    move-result v11

    if-eqz v11, :cond_2

    invoke-static {v1, v12, v9, v10}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$FillBlock;->access$200(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$FillBlock;Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;)V
    ...
    :goto_3
    iget v9, v2, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;->index:I

    add-int/2addr v9, v13

    iput v9, v2, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Position;->index:I
...
.method private static roundFunction(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;IIIIIIIIIIIIIIII)V
    ...
    invoke-static {v0, v4, v5, v10, v15}, Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator;->F(Lorg/bouncycastle/crypto/generators/Argon2BytesGenerator$Block;IIII)V
