...
.method public calculateMacConstantTime(JS[BIII[B)[B
    ...
    iget-object p3, p2, Lorg/bouncycastle/crypto/tls/TlsMac;->context:Lorg/bouncycastle/crypto/tls/TlsContext;

    invoke-static {p3}, Lorg/bouncycastle/crypto/tls/TlsUtils;->isSSL(Lorg/bouncycastle/crypto/tls/TlsContext;)Z
    ...
    invoke-virtual {p0, p3}, Lorg/bouncycastle/crypto/tls/TlsMac;->getDigestBlockCount(I)I
    ...
    iget-object p5, p2, Lorg/bouncycastle/crypto/tls/TlsMac;->mac:Lorg/bouncycastle/crypto/Mac;

    iget p6, p2, Lorg/bouncycastle/crypto/tls/TlsMac;->digestBlockSize:I

    invoke-interface {p5, p8, p3, p6}, Lorg/bouncycastle/crypto/Mac;->update([BII)V

    goto :goto_1

    :cond_1
    iget-object p4, p2, Lorg/bouncycastle/crypto/tls/TlsMac;->mac:Lorg/bouncycastle/crypto/Mac;

    aget-byte p3, p8, p3

    invoke-interface {p4, p3}, Lorg/bouncycastle/crypto/Mac;->update(B)V

    iget-object p3, p2, Lorg/bouncycastle/crypto/tls/TlsMac;->mac:Lorg/bouncycastle/crypto/Mac;

    invoke-interface {p3}, Lorg/bouncycastle/crypto/Mac;->reset()V
