...
.method public constructor <init>(Lorg/jmrtd/cert/CVCPrincipal;Lorg/jmrtd/cert/CVCPrincipal;Ljava/security/PublicKey;Ljava/lang/String;Ljava/util/Date;Ljava/util/Date;Lorg/jmrtd/cert/CVCAuthorizationTemplate$Role;Lorg/jmrtd/cert/CVCAuthorizationTemplate$Permission;[B)V
    ...
    .line 124
    :try_start_0
    new-instance p2, Lorg/ejbca/cvc/CAReferenceField;
    ...
    invoke-direct {p2, v1, v2, p1}, Lorg/ejbca/cvc/CAReferenceField;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    move-object p1, p4

    .line 125
    new-instance p4, Lorg/ejbca/cvc/HolderReferenceField;

    invoke-virtual {v0}, Lorg/jmrtd/cert/CVCPrincipal;->getCountry()Lnet/sf/scuba/data/Country;
    ...
    invoke-virtual {v0}, Lorg/jmrtd/cert/CVCPrincipal;->getMnemonic()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v0}, Lorg/jmrtd/cert/CVCPrincipal;->getSeqNumber()Ljava/lang/String;

    move-result-object v0

    invoke-direct {p4, v1, v2, v0}, Lorg/ejbca/cvc/HolderReferenceField;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    .line 126
    invoke-static {p7}, Lorg/jmrtd/cert/CVCAuthorizationTemplate;->fromRole(Lorg/jmrtd/cert/CVCAuthorizationTemplate$Role;)Lorg/ejbca/cvc/AuthorizationRoleEnum;

    move-result-object p7

    .line 127
    invoke-static {p8}, Lorg/jmrtd/cert/CVCAuthorizationTemplate;->fromPermission(Lorg/jmrtd/cert/CVCAuthorizationTemplate$Permission;)Lorg/ejbca/cvc/AccessRightEnum;
    ...
    .line 128
    new-instance p1, Lorg/ejbca/cvc/CVCertificateBody;

    invoke-static {p3, v0, p7}, Lorg/ejbca/cvc/KeyFactory;->createInstance(Ljava/security/PublicKey;Ljava/lang/String;Lorg/ejbca/cvc/AuthorizationRoleEnum;)Lorg/ejbca/cvc/CVCPublicKey;
    ...
    invoke-direct/range {p1 .. p8}, Lorg/ejbca/cvc/CVCertificateBody;-><init>(Lorg/ejbca/cvc/CAReferenceField;Lorg/ejbca/cvc/CVCPublicKey;Lorg/ejbca/cvc/HolderReferenceField;Lorg/ejbca/cvc/AuthorizationRoleEnum;Lorg/ejbca/cvc/AccessRightEnum;Ljava/util/Date;Ljava/util/Date;)V

    .line 129
    new-instance p2, Lorg/ejbca/cvc/CVCertificate;

    invoke-direct {p2, p1}, Lorg/ejbca/cvc/CVCertificate;-><init>(Lorg/ejbca/cvc/CVCertificateBody;)V

    iput-object p2, p0, Lorg/jmrtd/cert/CardVerifiableCertificate;->cvCertificate:Lorg/ejbca/cvc/CVCertificate;

    .line 130
    invoke-virtual {p2, p9}, Lorg/ejbca/cvc/CVCertificate;->setSignature([B)V

    .line 131
    iget-object p1, p0, Lorg/jmrtd/cert/CardVerifiableCertificate;->cvCertificate:Lorg/ejbca/cvc/CVCertificate;

    invoke-virtual {p1}, Lorg/ejbca/cvc/CVCertificate;->getTBS()[B
    :try_end_0
