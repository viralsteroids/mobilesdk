...
.method public static toECParameterSpec(Lorg/bouncycastle/asn1/x509/AlgorithmIdentifier;)Ljava/security/spec/ECParameterSpec;
    ...
    .line 338
    invoke-static {v0}, Lorg/bouncycastle/asn1/x9/X962NamedCurves;->getName(Lorg/bouncycastle/asn1/ASN1ObjectIdentifier;)Ljava/lang/String;
    ...
    invoke-direct {v5, v7, v0, v6}, Ljava/security/spec/EllipticCurve;-><init>(Ljava/security/spec/ECField;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
    ...
    invoke-direct {p0, v5, v8, v0, v3}, Ljava/security/spec/ECParameterSpec;-><init>(Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;I)V
    ...
    invoke-direct {v2, v5, v8, v0, p0}, Ljava/security/spec/ECParameterSpec;-><init>(Ljava/security/spec/EllipticCurve;Ljava/security/spec/ECPoint;Ljava/math/BigInteger;I)V
    :try_end_1
    ...
    .line 406
    sget-object v0, Lorg/jmrtd/lds/PACEDomainParameterInfo;->LOGGER:Ljava/util/logging/Logger;
