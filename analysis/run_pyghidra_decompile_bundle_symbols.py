...
TARGETS = [
    0x01047838,  # TextEngineImpl::InitFromOwnedZipBuffer
    0x010483b8,  # TextEngineImpl::GetBundleMainFilename
    0x0104e9c0,  # TextEngineImpl::FromEmbeddedBundle
    0x0104ea10,  # TextEngineImpl::HasEmbeddedBundle
    0x0086588c,  # DocEngine::CreateFromEmbeddedBundle
    0x01046748,  # TextEngine::CreateFromEmbeddedBundle
]
...
for addr in TARGETS:
    ...
    out_file = OUT_DIR / f"bundle_symbol_{addr:08x}.c"
