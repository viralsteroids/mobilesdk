...
# imm12 for offsets 0x210 and 0x218 in LDR Xt, [Xn, #imm12*8]
imm_target = {0x210: 0x210 // 8, 0x218: 0x218 // 8}
...
out_path = Path(r"C:\temp\MobileSDK\analysis\full_ldr_offset_0210_0218_hits.md")
