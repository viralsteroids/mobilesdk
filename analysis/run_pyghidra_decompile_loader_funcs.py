...
TARGETS = [
    0x02557a90,  # open_filenames wrapper
    0x026eaef0,  # archive_read_open_memory2 wrapper
    0x02558a08,  # bundle init chain
    0x02557a14,  # helper in chain
]
...
for addr in TARGETS:
    ...
    out_file = OUT_DIR / f"loader_func_{addr:08x}.c"
