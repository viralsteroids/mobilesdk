...
def decode_line(pc, insn):
    # return mnemonic-like string for some ops
...
WINDOW = 16  # instructions before/after
...
out_path = Path(r"C:\temp\MobileSDK\analysis\apktool_zstd_dict_callsite_windows.txt")
