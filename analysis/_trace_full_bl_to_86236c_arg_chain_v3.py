...
def decode_pair_pre(insn):
    if (insn & 0xFFC00000) == 0xA9C00000:  # STP/LDP pre-index
        rt = insn & 0x1F
        rt2 = (insn >> 10) & 0x1F
        rn = (insn >> 5) & 0x1F
        imm7 = (insn >> 15) & 0x7F
...
def decode_pair_post(insn):
    if (insn & 0xFFC00000) == 0xA8C00000:  # STP/LDP post-index
        rt = insn & 0x1F
        rt2 = (insn >> 10) & 0x1F
        rn = (insn >> 5) & 0x1F
        imm7 = (insn >> 15) & 0x7F
...
out_path = Path(r"C:\temp\MobileSDK\analysis\full_bl_to_86236c_arg_chain_v3.md")
