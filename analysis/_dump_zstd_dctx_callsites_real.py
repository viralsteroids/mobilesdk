...
lines = []
lines.append("# ZSTD_decompressDCtx real callsites (BL target 0x0270c984)")
lines.append("")
lines.append(f"Total callsites: {len(callsites)}")

for pc in callsites[:10]:
    lines.append("")
...
Path(r"C:\temp\MobileSDK\analysis\zstd_dctx_callsites_real.md").write_text(
    "\n".join(lines), encoding="ascii", errors="ignore"
)
print(r"C:\temp\MobileSDK\analysis\zstd_dctx_callsites_real.md")
