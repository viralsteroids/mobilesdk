...
public abstract class NavigationBarItemView extends FrameLayout implements MenuView.ItemView {
    ...
    public NavigationBarItemView(Context context) {
        ...
        this.iconContainer = (FrameLayout) findViewById(C2738R.id.navigation_bar_item_icon_container);
        this.activeIndicatorView = findViewById(C2738R.id.navigation_bar_item_active_indicator_view);
        ImageView imageView = (ImageView) findViewById(C2738R.id.navigation_bar_item_icon_view);
        this.icon = imageView;
        ViewGroup viewGroup = (ViewGroup) findViewById(C2738R.id.navigation_bar_item_labels_group);
        this.labelGroup = viewGroup;
        TextView textView = (TextView) findViewById(C2738R.id.navigation_bar_item_small_label_view);
        this.smallLabel = textView;
        TextView textView2 = (TextView) findViewById(C2738R.id.navigation_bar_item_large_label_view);
        this.largeLabel = textView2;
        setBackgroundResource(getItemBackgroundResId());
        this.itemPaddingTop = getResources().getDimensionPixelSize(getItemDefaultMarginResId());
        this.itemPaddingBottom = viewGroup.getPaddingBottom();
        this.activeIndicatorLabelPadding = getResources().getDimensionPixelSize(C2738R.dimen.m3_navigation_item_active_indicator_label_padding);
    ...
    private void maybeAnimateActiveIndicatorToProgress(final float f) {
        ...
        this.activeIndicatorAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C2738R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
        this.activeIndicatorAnimator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C2738R.attr.motionDurationLong2, getResources().getInteger(C2738R.integer.material_motion_duration_long_1)));
    ...
    protected int getItemBackgroundResId() {
        return C2738R.drawable.mtrl_navigation_bar_item_background;
    }

    protected int getItemDefaultMarginResId() {
        return C2738R.dimen.mtrl_navigation_bar_item_default_margin;
    }
