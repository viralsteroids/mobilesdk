...
class FloatingActionButtonImpl {
    ...
    private static final int SHOW_ANIM_DURATION_ATTR = C2738R.attr.motionDurationLong2;
    private static final int SHOW_ANIM_EASING_ATTR = C2738R.attr.motionEasingEmphasizedInterpolator;
    private static final int HIDE_ANIM_DURATION_ATTR = C2738R.attr.motionDurationMedium1;
    private static final int HIDE_ANIM_EASING_ATTR = C2738R.attr.motionEasingEmphasizedAccelerateInterpolator;
    ...
    private AnimatorSet createDefaultAnimator(final float f, final float f2, final float f3, int i, int i2) {
        ...
        AnimatorSetCompat.playTogether(animatorSet, arrayList);
        animatorSet.setDuration(MotionUtils.resolveThemeDuration(this.view.getContext(), i, this.view.getContext().getResources().getInteger(C2738R.integer.material_motion_duration_long_1)));
