...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    private static final int DEF_STYLE_RES = C2738R.style.Widget_MaterialComponents_ExtendedFloatingActionButton_Icon;
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2738R.attr.extendedFloatingActionButtonStyle);
    }
    ...
    public ExtendedFloatingActionButton(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2738R.styleable.ExtendedFloatingActionButton, i, i2, new int[0]);
        MotionSpec motionSpecCreateFromAttribute = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C2738R.styleable.ExtendedFloatingActionButton_showMotionSpec);
        MotionSpec motionSpecCreateFromAttribute2 = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C2738R.styleable.ExtendedFloatingActionButton_hideMotionSpec);
        MotionSpec motionSpecCreateFromAttribute3 = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C2738R.styleable.ExtendedFloatingActionButton_extendMotionSpec);
        MotionSpec motionSpecCreateFromAttribute4 = MotionSpec.createFromAttribute(context2, typedArrayObtainStyledAttributes, C2738R.styleable.ExtendedFloatingActionButton_shrinkMotionSpec);
        this.collapsedSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2738R.styleable.ExtendedFloatingActionButton_collapsedSize, -1);
        int i3 = typedArrayObtainStyledAttributes.getInt(C2738R.styleable.ExtendedFloatingActionButton_extendStrategy, 1);
    ...
    protected static class ExtendedFloatingActionButtonBehavior<T extends ExtendedFloatingActionButton> extends CoordinatorLayout.Behavior<T> {
        ...
        public ExtendedFloatingActionButtonBehavior(Context context, AttributeSet attributeSet) {
            ...
            TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C2738R.styleable.ExtendedFloatingActionButton_Behavior_Layout);
            this.autoHideEnabled = typedArrayObtainStyledAttributes.getBoolean(C2738R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoHide, false);
            this.autoShrinkEnabled = typedArrayObtainStyledAttributes.getBoolean(C2738R.styleable.ExtendedFloatingActionButton_Behavior_Layout_behavior_autoShrink, true);
            typedArrayObtainStyledAttributes.recycle();
        }
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public int getDefaultMotionSpecResource() {
            if (this.extending) {
                return C2738R.animator.mtrl_extended_fab_change_size_expand_motion_spec;
            }
            return C2738R.animator.mtrl_extended_fab_change_size_collapse_motion_spec;
        }
    ...
    class ShowStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C2738R.animator.mtrl_extended_fab_show_motion_spec;
        }
    ...
    class HideStrategy extends BaseMotionStrategy {
        ...
        @Override // com.google.android.material.floatingactionbutton.MotionStrategy
        public int getDefaultMotionSpecResource() {
            return C2738R.animator.mtrl_extended_fab_hide_motion_spec;
        }
