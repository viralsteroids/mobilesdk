...
public class MaterialDivider extends View {
    ...
    public MaterialDivider(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2738R.attr.materialDividerStyle);
    }
    ...
    public MaterialDivider(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2738R.styleable.MaterialDivider, i, i2, new int[0]);
        this.thickness = typedArrayObtainStyledAttributes.getDimensionPixelSize(C2738R.styleable.MaterialDivider_dividerThickness, getResources().getDimensionPixelSize(C2738R.dimen.material_divider_thickness));
        ...
        setDividerColor(MaterialResources.getColorStateList(context2, typedArrayObtainStyledAttributes, C2738R.styleable.MaterialDivider_dividerColor).getDefaultColor());
