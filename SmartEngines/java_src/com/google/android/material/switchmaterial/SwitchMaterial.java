...
public class SwitchMaterial extends SwitchCompat {
    private static final int DEF_STYLE_RES = C2738R.style.Widget_MaterialComponents_CompoundButton_Switch;
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2738R.attr.switchStyle);
    }
    ...
    public SwitchMaterial(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2738R.styleable.SwitchMaterial, i, i2, new int[0]);
        this.useMaterialThemeColors = typedArrayObtainStyledAttributes.getBoolean(C2738R.styleable.SwitchMaterial_useMaterialThemeColors, false);
    ...
    private ColorStateList getMaterialThemeColorsThumbTintList() throws Resources.NotFoundException {
        if (this.materialThemeColorsThumbTintList == null) {
            int color = MaterialColors.getColor(this, C2738R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C2738R.attr.colorControlActivated);
            float dimension = getResources().getDimension(C2738R.dimen.mtrl_switch_thumb_elevation);
    ...
    private ColorStateList getMaterialThemeColorsTrackTintList() {
        if (this.materialThemeColorsTrackTintList == null) {
            ...
            int color = MaterialColors.getColor(this, C2738R.attr.colorSurface);
            int color2 = MaterialColors.getColor(this, C2738R.attr.colorControlActivated);
            int color3 = MaterialColors.getColor(this, C2738R.attr.colorOnSurface);
