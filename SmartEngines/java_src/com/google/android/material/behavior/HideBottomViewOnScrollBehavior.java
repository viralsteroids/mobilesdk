...
public class HideBottomViewOnScrollBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    private static final int ENTER_ANIM_DURATION_ATTR = C2738R.attr.motionDurationLong2;
    private static final int EXIT_ANIM_DURATION_ATTR = C2738R.attr.motionDurationMedium4;
    private static final int ENTER_EXIT_ANIM_EASING_ATTR = C2738R.attr.motionEasingEmphasizedInterpolator;
