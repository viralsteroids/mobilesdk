...
class PasswordToggleEndIconDelegate extends EndIconDelegate {
    ...
    /* synthetic */ void m474x4cc26475(View view) {
    ...
    PasswordToggleEndIconDelegate(EndCompoundLayout endCompoundLayout, int i) {
        ...
        this.iconResId = C2738R.drawable.design_password_eye;
    ...
    int getIconContentDescriptionResId() {
        return C2738R.string.password_toggle_content_description;
    }
