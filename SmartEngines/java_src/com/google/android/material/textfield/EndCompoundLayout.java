...
class EndCompoundLayout extends LinearLayout {
    ...
    EndCompoundLayout(TextInputLayout textInputLayout, TintTypedArray tintTypedArray) {
        ...
        CheckableImageButton checkableImageButtonCreateIconView = createIconView(this, layoutInflaterFrom, C2738R.id.text_input_error_icon);
        this.errorIconView = checkableImageButtonCreateIconView;
        CheckableImageButton checkableImageButtonCreateIconView2 = createIconView(frameLayout, layoutInflaterFrom, C2738R.id.text_input_end_icon);
    ...
    private CheckableImageButton createIconView(ViewGroup viewGroup, LayoutInflater layoutInflater, int i) {
        CheckableImageButton checkableImageButton = (CheckableImageButton) layoutInflater.inflate(C2738R.layout.design_text_input_end_icon, viewGroup, false);
    ...
    private void initErrorIconView(TintTypedArray tintTypedArray) {
        if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_errorIconTint)) {
            this.errorIconTintList = MaterialResources.getColorStateList(getContext(), tintTypedArray, C2738R.styleable.TextInputLayout_errorIconTint);
        }
        if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_errorIconTintMode)) {
            this.errorIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(C2738R.styleable.TextInputLayout_errorIconTintMode, -1), null);
        }
        if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_errorIconDrawable)) {
            setErrorIconDrawable(tintTypedArray.getDrawable(C2738R.styleable.TextInputLayout_errorIconDrawable));
        }
        this.errorIconView.setContentDescription(getResources().getText(C2738R.string.error_icon_content_description));
    ...
    private void initEndIconView(TintTypedArray tintTypedArray) {
        if (!tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_passwordToggleEnabled)) {
            if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_endIconTint)) {
                this.endIconTintList = MaterialResources.getColorStateList(getContext(), tintTypedArray, C2738R.styleable.TextInputLayout_endIconTint);
            }
            if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_endIconTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(C2738R.styleable.TextInputLayout_endIconTintMode, -1), null);
            }
        }
        if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_endIconMode)) {
            setEndIconMode(tintTypedArray.getInt(C2738R.styleable.TextInputLayout_endIconMode, 0));
            if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_endIconContentDescription)) {
                setEndIconContentDescription(tintTypedArray.getText(C2738R.styleable.TextInputLayout_endIconContentDescription));
            }
            setEndIconCheckable(tintTypedArray.getBoolean(C2738R.styleable.TextInputLayout_endIconCheckable, true));
        } else if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_passwordToggleEnabled)) {
            if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_passwordToggleTint)) {
                this.endIconTintList = MaterialResources.getColorStateList(getContext(), tintTypedArray, C2738R.styleable.TextInputLayout_passwordToggleTint);
            }
            if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_passwordToggleTintMode)) {
                this.endIconTintMode = ViewUtils.parseTintMode(tintTypedArray.getInt(C2738R.styleable.TextInputLayout_passwordToggleTintMode, -1), null);
            }
            setEndIconMode(tintTypedArray.getBoolean(C2738R.styleable.TextInputLayout_passwordToggleEnabled, false) ? 1 : 0);
            setEndIconContentDescription(tintTypedArray.getText(C2738R.styleable.TextInputLayout_passwordToggleContentDescription));
        }
        setEndIconMinSize(tintTypedArray.getDimensionPixelSize(C2738R.styleable.TextInputLayout_endIconMinSize, getResources().getDimensionPixelSize(C2738R.dimen.mtrl_min_touch_target_size)));
        if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_endIconScaleType)) {
            setEndIconScaleType(IconHelper.convertScaleType(tintTypedArray.getInt(C2738R.styleable.TextInputLayout_endIconScaleType, -1)));
        }
    }

    private void initSuffixTextView(TintTypedArray tintTypedArray) {
        this.suffixTextView.setVisibility(8);
        this.suffixTextView.setId(C2738R.id.textinput_suffix_text);
        ...
        setSuffixTextAppearance(tintTypedArray.getResourceId(C2738R.styleable.TextInputLayout_suffixTextAppearance, 0));
        if (tintTypedArray.hasValue(C2738R.styleable.TextInputLayout_suffixTextColor)) {
            setSuffixTextColor(tintTypedArray.getColorStateList(C2738R.styleable.TextInputLayout_suffixTextColor));
        }
        setSuffixText(tintTypedArray.getText(C2738R.styleable.TextInputLayout_suffixText));
    }
    ...
    private static class EndIconDelegates {
        ...
        EndIconDelegates(EndCompoundLayout endCompoundLayout, TintTypedArray tintTypedArray) {
            ...
            this.customEndIconDrawableId = tintTypedArray.getResourceId(C2738R.styleable.TextInputLayout_endIconDrawable, 0);
            this.passwordIconDrawableId = tintTypedArray.getResourceId(C2738R.styleable.TextInputLayout_passwordToggleDrawable, 0);
        }
