...
public class TextInputLayout extends LinearLayout implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private static final int DEF_STYLE_RES = C2738R.style.Widget_Design_TextInputLayout;
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2738R.attr.textInputStyle);
    }
    ...
    public TextInputLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C2738R.styleable.TextInputLayout, i, i2, C2738R.styleable.TextInputLayout_counterTextAppearance, C2738R.styleable.TextInputLayout_counterOverflowTextAppearance, C2738R.styleable.TextInputLayout_errorTextAppearance, C2738R.styleable.TextInputLayout_helperTextTextAppearance, C2738R.styleable.TextInputLayout_hintTextAppearance);
        ...
        this.hintEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.TextInputLayout_hintEnabled, true);
        setHint(tintTypedArrayObtainTintedStyledAttributes.getText(C2738R.styleable.TextInputLayout_android_hint));
        this.hintAnimationEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.TextInputLayout_hintAnimationEnabled, true);
        this.expandedHintEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.TextInputLayout_expandedHintEnabled, true);
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_android_minEms)) {
            setMinEms(tintTypedArrayObtainTintedStyledAttributes.getInt(C2738R.styleable.TextInputLayout_android_minEms, -1));
        } else if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_android_minWidth)) {
            setMinWidth(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C2738R.styleable.TextInputLayout_android_minWidth, -1));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_android_maxEms)) {
            setMaxEms(tintTypedArrayObtainTintedStyledAttributes.getInt(C2738R.styleable.TextInputLayout_android_maxEms, -1));
        } else if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_android_maxWidth)) {
            setMaxWidth(tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C2738R.styleable.TextInputLayout_android_maxWidth, -1));
        }
        this.shapeAppearanceModel = ShapeAppearanceModel.builder(context2, attributeSet, i, i2).build();
        this.boxLabelCutoutPaddingPx = context2.getResources().getDimensionPixelOffset(C2738R.dimen.mtrl_textinput_box_label_cutout_padding);
        this.boxCollapsedPaddingTopPx = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelOffset(C2738R.styleable.TextInputLayout_boxCollapsedPaddingTop, 0);
        this.boxStrokeWidthDefaultPx = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C2738R.styleable.TextInputLayout_boxStrokeWidth, context2.getResources().getDimensionPixelSize(C2738R.dimen.mtrl_textinput_box_stroke_width_default));
        this.boxStrokeWidthFocusedPx = tintTypedArrayObtainTintedStyledAttributes.getDimensionPixelSize(C2738R.styleable.TextInputLayout_boxStrokeWidthFocused, context2.getResources().getDimensionPixelSize(C2738R.dimen.mtrl_textinput_box_stroke_width_focused));
        this.boxStrokeWidthPx = this.boxStrokeWidthDefaultPx;
        float dimension = tintTypedArrayObtainTintedStyledAttributes.getDimension(C2738R.styleable.TextInputLayout_boxCornerRadiusTopStart, -1.0f);
        float dimension2 = tintTypedArrayObtainTintedStyledAttributes.getDimension(C2738R.styleable.TextInputLayout_boxCornerRadiusTopEnd, -1.0f);
        float dimension3 = tintTypedArrayObtainTintedStyledAttributes.getDimension(C2738R.styleable.TextInputLayout_boxCornerRadiusBottomEnd, -1.0f);
        float dimension4 = tintTypedArrayObtainTintedStyledAttributes.getDimension(C2738R.styleable.TextInputLayout_boxCornerRadiusBottomStart, -1.0f);
        ...
        ColorStateList colorStateList = MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C2738R.styleable.TextInputLayout_boxBackgroundColor);
        if (colorStateList != null) {
            ...
            if (colorStateList.isStateful()) {
                ...
                ColorStateList colorStateList2 = AppCompatResources.getColorStateList(context2, C2738R.color.mtrl_filled_background_color);
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_android_textColorHint)) {
            ColorStateList colorStateList3 = tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_android_textColorHint);
            this.focusedTextColor = colorStateList3;
            this.defaultHintTextColor = colorStateList3;
        }
        ColorStateList colorStateList4 = MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C2738R.styleable.TextInputLayout_boxStrokeColor);
        this.focusedStrokeColor = tintTypedArrayObtainTintedStyledAttributes.getColor(C2738R.styleable.TextInputLayout_boxStrokeColor, 0);
        this.defaultStrokeColor = ContextCompat.getColor(context2, C2738R.color.mtrl_textinput_default_box_stroke_color);
        this.disabledColor = ContextCompat.getColor(context2, C2738R.color.mtrl_textinput_disabled_color);
        this.hoveredStrokeColor = ContextCompat.getColor(context2, C2738R.color.mtrl_textinput_hovered_box_stroke_color);
        if (colorStateList4 != null) {
            setBoxStrokeColorStateList(colorStateList4);
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_boxStrokeErrorColor)) {
            setBoxStrokeErrorColor(MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C2738R.styleable.TextInputLayout_boxStrokeErrorColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.getResourceId(C2738R.styleable.TextInputLayout_hintTextAppearance, -1) != -1) {
            setHintTextAppearance(tintTypedArrayObtainTintedStyledAttributes.getResourceId(C2738R.styleable.TextInputLayout_hintTextAppearance, 0));
        }
        this.cursorColor = tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_cursorColor);
        this.cursorErrorColor = tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_cursorErrorColor);
        int resourceId = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C2738R.styleable.TextInputLayout_errorTextAppearance, 0);
        CharSequence text = tintTypedArrayObtainTintedStyledAttributes.getText(C2738R.styleable.TextInputLayout_errorContentDescription);
        int i3 = tintTypedArrayObtainTintedStyledAttributes.getInt(C2738R.styleable.TextInputLayout_errorAccessibilityLiveRegion, 1);
        boolean z = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.TextInputLayout_errorEnabled, false);
        int resourceId2 = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C2738R.styleable.TextInputLayout_helperTextTextAppearance, 0);
        boolean z2 = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.TextInputLayout_helperTextEnabled, false);
        CharSequence text2 = tintTypedArrayObtainTintedStyledAttributes.getText(C2738R.styleable.TextInputLayout_helperText);
        int resourceId3 = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C2738R.styleable.TextInputLayout_placeholderTextAppearance, 0);
        CharSequence text3 = tintTypedArrayObtainTintedStyledAttributes.getText(C2738R.styleable.TextInputLayout_placeholderText);
        boolean z3 = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.TextInputLayout_counterEnabled, false);
        setCounterMaxLength(tintTypedArrayObtainTintedStyledAttributes.getInt(C2738R.styleable.TextInputLayout_counterMaxLength, -1));
        this.counterTextAppearance = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C2738R.styleable.TextInputLayout_counterTextAppearance, 0);
        this.counterOverflowTextAppearance = tintTypedArrayObtainTintedStyledAttributes.getResourceId(C2738R.styleable.TextInputLayout_counterOverflowTextAppearance, 0);
        setBoxBackgroundMode(tintTypedArrayObtainTintedStyledAttributes.getInt(C2738R.styleable.TextInputLayout_boxBackgroundMode, 0));
        ...
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_errorTextColor)) {
            setErrorTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_errorTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_helperTextTextColor)) {
            setHelperTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_helperTextTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_hintTextColor)) {
            setHintTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_hintTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_counterTextColor)) {
            setCounterTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_counterTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_counterOverflowTextColor)) {
            setCounterOverflowTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_counterOverflowTextColor));
        }
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.TextInputLayout_placeholderTextColor)) {
            setPlaceholderTextColor(tintTypedArrayObtainTintedStyledAttributes.getColorStateList(C2738R.styleable.TextInputLayout_placeholderTextColor));
        }
        EndCompoundLayout endCompoundLayout = new EndCompoundLayout(this, tintTypedArrayObtainTintedStyledAttributes);
        this.endLayout = endCompoundLayout;
        boolean z4 = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.TextInputLayout_android_enabled, true);
    ...
    private Drawable getEditTextBoxBackground() {
        ...
        int color = MaterialColors.getColor(this.editText, C2738R.attr.colorControlHighlight);
        int i = this.boxBackgroundMode;
        if (i == 2) {
    ...
    private static Drawable getOutlinedBoxBackgroundWithRipple(Context context, MaterialShapeDrawable materialShapeDrawable, int i, int[][] iArr) {
        int color = MaterialColors.getColor(context, C2738R.attr.colorSurface, LOG_TAG);
    ...
    private MaterialShapeDrawable getDropDownMaterialShapeDrawable(boolean z) throws Resources.NotFoundException {
        ...
        float dimensionPixelOffset2 = getResources().getDimensionPixelOffset(C2738R.dimen.mtrl_shape_corner_size_small_component);
        ...
        if (editText instanceof MaterialAutoCompleteTextView) {
            ...
            dimensionPixelOffset = getResources().getDimensionPixelOffset(C2738R.dimen.m3_comp_outlined_autocomplete_menu_container_elevation);
        }
        int dimensionPixelOffset3 = getResources().getDimensionPixelOffset(C2738R.dimen.mtrl_exposed_dropdown_menu_popup_vertical_padding);
    ...
    private void updateBoxCollapsedPaddingTop() {
        if (this.boxBackgroundMode == 1) {
            if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C2738R.dimen.material_font_2_0_box_collapsed_padding_top);
            } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
                this.boxCollapsedPaddingTopPx = getResources().getDimensionPixelSize(C2738R.dimen.material_font_1_3_box_collapsed_padding_top);
            }
        }
    }
    ...
    private void adjustFilledEditTextPaddingForLargeFont() {
        ...
        if (MaterialResources.isFontScaleAtLeast2_0(getContext())) {
            EditText editText = this.editText;
            ViewCompat.setPaddingRelative(editText, ViewCompat.getPaddingStart(editText), getResources().getDimensionPixelSize(C2738R.dimen.material_filled_edittext_font_2_0_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C2738R.dimen.material_filled_edittext_font_2_0_padding_bottom));
        } else if (MaterialResources.isFontScaleAtLeast1_3(getContext())) {
            EditText editText2 = this.editText;
            ViewCompat.setPaddingRelative(editText2, ViewCompat.getPaddingStart(editText2), getResources().getDimensionPixelSize(C2738R.dimen.material_filled_edittext_font_1_3_padding_top), ViewCompat.getPaddingEnd(this.editText), getResources().getDimensionPixelSize(C2738R.dimen.material_filled_edittext_font_1_3_padding_bottom));
        }
    }
    ...
    public void setCounterEnabled(boolean z) {
        if (this.counterEnabled != z) {
            if (z) {
                ...
                appCompatTextView.setId(C2738R.id.textinput_counter);
                ...
                MarginLayoutParamsCompat.setMarginStart((ViewGroup.MarginLayoutParams) this.counterView.getLayoutParams(), getResources().getDimensionPixelOffset(C2738R.dimen.mtrl_textinput_counter_margin_start));
    ...
    void updateCounter(Editable editable) {
        ...
        if (i == -1) {
            ...
            this.counterView.setText(BidiFormatter.getInstance().unicodeWrap(getContext().getString(C2738R.string.character_counter_pattern, Integer.valueOf(iCountLength), Integer.valueOf(this.counterMaxLength))));
        }
    ...
    private static void updateCounterContentDescription(Context context, TextView textView, int i, int i2, boolean z) {
        int i3;
        if (z) {
            i3 = C2738R.string.character_counter_overflowed_content_description;
        } else {
            i3 = C2738R.string.character_counter_content_description;
        }
    ...
    public void setPlaceholderText(CharSequence charSequence) {
        if (this.placeholderTextView == null) {
            ...
            appCompatTextView.setId(C2738R.id.textinput_placeholder);
    ...
    private Fade createPlaceholderFadeTransition() {
        Fade fade = new Fade();
        fade.setDuration(MotionUtils.resolveThemeDuration(getContext(), C2738R.attr.motionDurationShort2, DEFAULT_PLACEHOLDER_FADE_DURATION));
        fade.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C2738R.attr.motionEasingLinearInterpolator, AnimationUtils.LINEAR_INTERPOLATOR));
        return fade;
    }
    ...
    void setTextAppearanceCompatWithErrorFallback(TextView textView, int i) {
        ...
        TextViewCompat.setTextAppearance(textView, C2738R.style.TextAppearance_AppCompat_Caption);
        textView.setTextColor(ContextCompat.getColor(getContext(), C2738R.color.design_error));
    }
    ...
    private int calculateBoxBackgroundColor() {
        return this.boxBackgroundMode == 1 ? MaterialColors.layer(MaterialColors.getColor(this, C2738R.attr.colorSurface, 0), this.boxBackgroundColor) : this.boxBackgroundColor;
    }
    ...
    private void updateCursorColor() {
        ...
        if (colorStateListOrNull == null) {
            colorStateListOrNull = MaterialColors.getColorStateListOrNull(getContext(), C2738R.attr.colorControlActivated);
        }
        EditText editText = this.editText;
    ...
    void animateToExpansionFraction(float f) {
        ...
        if (this.animator == null) {
            ...
            valueAnimator.setInterpolator(MotionUtils.resolveThemeInterpolator(getContext(), C2738R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR));
            this.animator.setDuration(MotionUtils.resolveThemeDuration(getContext(), C2738R.attr.motionDurationMedium4, 167));
