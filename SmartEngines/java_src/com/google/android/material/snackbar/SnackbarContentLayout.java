...
public class SnackbarContentLayout extends LinearLayout implements ContentViewCallback {
    ...
    public SnackbarContentLayout(Context context, AttributeSet attributeSet) {
        ...
        this.contentInterpolator = MotionUtils.resolveThemeInterpolator(context, C2738R.attr.motionEasingEmphasizedInterpolator, AnimationUtils.FAST_OUT_SLOW_IN_INTERPOLATOR);
    }

    @Override // android.view.View
    protected void onFinishInflate() {
        super.onFinishInflate();
        this.messageView = (TextView) findViewById(C2738R.id.snackbar_text);
        this.actionView = (Button) findViewById(C2738R.id.snackbar_action);
    }
    ...
    void updateActionTextColorAlphaIfNeeded(float f) {
        if (f != 1.0f) {
            this.actionView.setTextColor(MaterialColors.layer(MaterialColors.getColor(this, C2738R.attr.colorSurface), this.actionView.getCurrentTextColor(), f));
        }
    }
    ...
    protected void onMeasure(int i, int i2) throws Resources.NotFoundException {
        ...
        int dimensionPixelSize = getResources().getDimensionPixelSize(C2738R.dimen.design_snackbar_padding_vertical_2lines);
        int dimensionPixelSize2 = getResources().getDimensionPixelSize(C2738R.dimen.design_snackbar_padding_vertical);
