...
public final class BadgeState {
    ...
    BadgeState(Context context, int i, int i2, int i3, State state) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        this.badgeRadius = typedArrayGenerateTypedArray.getDimensionPixelSize(C2738R.styleable.Badge_badgeRadius, -1);
        this.horizontalInset = context.getResources().getDimensionPixelSize(C2738R.dimen.mtrl_badge_horizontal_edge_offset);
        this.horizontalInsetWithText = context.getResources().getDimensionPixelSize(C2738R.dimen.mtrl_badge_text_horizontal_edge_offset);
        this.badgeWithTextRadius = typedArrayGenerateTypedArray.getDimensionPixelSize(C2738R.styleable.Badge_badgeWithTextRadius, -1);
        this.badgeWidth = typedArrayGenerateTypedArray.getDimension(C2738R.styleable.Badge_badgeWidth, resources.getDimension(C2738R.dimen.m3_badge_size));
        this.badgeWithTextWidth = typedArrayGenerateTypedArray.getDimension(C2738R.styleable.Badge_badgeWithTextWidth, resources.getDimension(C2738R.dimen.m3_badge_with_text_size));
        this.badgeHeight = typedArrayGenerateTypedArray.getDimension(C2738R.styleable.Badge_badgeHeight, resources.getDimension(C2738R.dimen.m3_badge_size));
        this.badgeWithTextHeight = typedArrayGenerateTypedArray.getDimension(C2738R.styleable.Badge_badgeWithTextHeight, resources.getDimension(C2738R.dimen.m3_badge_with_text_size));
        boolean z = true;
        this.offsetAlignmentMode = typedArrayGenerateTypedArray.getInt(C2738R.styleable.Badge_offsetAlignmentMode, 1);
        state2.alpha = state.alpha == -2 ? 255 : state.alpha;
        if (state.number == -2) {
            if (typedArrayGenerateTypedArray.hasValue(C2738R.styleable.Badge_number)) {
                state2.number = typedArrayGenerateTypedArray.getInt(C2738R.styleable.Badge_number, 0);
            } else {
                state2.number = -1;
            }
        } else {
        ...
        if (state.text == null) {
            if (typedArrayGenerateTypedArray.hasValue(C2738R.styleable.Badge_badgeText)) {
                state2.text = typedArrayGenerateTypedArray.getString(C2738R.styleable.Badge_badgeText);
            }
        } else {
        ...
        if (state.contentDescriptionNumberless == null) {
            string = context.getString(C2738R.string.mtrl_badge_numberless_content_description);
        } else {
        ...
        if (state.contentDescriptionQuantityStrings == 0) {
            i4 = C2738R.plurals.mtrl_badge_content_description;
        } else {
        ...
        if (state.contentDescriptionExceedsMaxBadgeNumberRes == 0) {
            i5 = C2738R.string.mtrl_exceed_max_badge_number_content_description;
        } else {
        ...
        if (state.maxCharacterCount == -2) {
            i6 = typedArrayGenerateTypedArray.getInt(C2738R.styleable.Badge_maxCharacterCount, -2);
        } else {
            i6 = state.maxCharacterCount;
        }
        state2.maxCharacterCount = i6;
        if (state.maxNumber == -2) {
            i7 = typedArrayGenerateTypedArray.getInt(C2738R.styleable.Badge_maxNumber, -2);
        } else {
            i7 = state.maxNumber;
        }
        state2.maxNumber = i7;
        if (state.badgeShapeAppearanceResId == null) {
            iIntValue = typedArrayGenerateTypedArray.getResourceId(C2738R.styleable.Badge_badgeShapeAppearance, C2738R.style.ShapeAppearance_M3_Sys_Shape_Corner_Full);
        } else {
        ...
        if (state.badgeShapeAppearanceOverlayResId == null) {
            iIntValue2 = typedArrayGenerateTypedArray.getResourceId(C2738R.styleable.Badge_badgeShapeAppearanceOverlay, 0);
        } else {
        ...
        if (state.badgeWithTextShapeAppearanceResId == null) {
            iIntValue3 = typedArrayGenerateTypedArray.getResourceId(C2738R.styleable.Badge_badgeWithTextShapeAppearance, C2738R.style.ShapeAppearance_M3_Sys_Shape_Corner_Full);
        } else {
        ...
        if (state.badgeWithTextShapeAppearanceOverlayResId == null) {
            iIntValue4 = typedArrayGenerateTypedArray.getResourceId(C2738R.styleable.Badge_badgeWithTextShapeAppearanceOverlay, 0);
        } else {
        ...
        if (state.backgroundColor == null) {
            iIntValue5 = readColorFromAttributes(context, typedArrayGenerateTypedArray, C2738R.styleable.Badge_backgroundColor);
        } else {
        ...
        if (state.badgeTextAppearanceResId == null) {
            iIntValue6 = typedArrayGenerateTypedArray.getResourceId(C2738R.styleable.Badge_badgeTextAppearance, C2738R.style.TextAppearance_MaterialComponents_Badge);
        } else {
            iIntValue6 = state.badgeTextAppearanceResId.intValue();
        }
        state2.badgeTextAppearanceResId = Integer.valueOf(iIntValue6);
        if (state.badgeTextColor == null) {
            if (typedArrayGenerateTypedArray.hasValue(C2738R.styleable.Badge_badgeTextColor)) {
                state2.badgeTextColor = Integer.valueOf(readColorFromAttributes(context, typedArrayGenerateTypedArray, C2738R.styleable.Badge_badgeTextColor));
            } else {
        ...
        if (state.badgeGravity == null) {
            iIntValue7 = typedArrayGenerateTypedArray.getInt(C2738R.styleable.Badge_badgeGravity, 8388661);
        } else {
            iIntValue7 = state.badgeGravity.intValue();
        }
        state2.badgeGravity = Integer.valueOf(iIntValue7);
        if (state.badgeHorizontalPadding == null) {
            iIntValue8 = typedArrayGenerateTypedArray.getDimensionPixelSize(C2738R.styleable.Badge_badgeWidePadding, resources.getDimensionPixelSize(C2738R.dimen.mtrl_badge_long_text_horizontal_padding));
        } else {
        ...
        if (state.badgeVerticalPadding == null) {
            iIntValue9 = typedArrayGenerateTypedArray.getDimensionPixelSize(C2738R.styleable.Badge_badgeVerticalPadding, resources.getDimensionPixelSize(C2738R.dimen.m3_badge_with_text_vertical_padding));
        } else {
        ...
        if (state.horizontalOffsetWithoutText == null) {
            iIntValue10 = typedArrayGenerateTypedArray.getDimensionPixelOffset(C2738R.styleable.Badge_horizontalOffset, 0);
        } else {
        ...
        if (state.verticalOffsetWithoutText == null) {
            iIntValue11 = typedArrayGenerateTypedArray.getDimensionPixelOffset(C2738R.styleable.Badge_verticalOffset, 0);
        } else {
        ...
        if (state.horizontalOffsetWithText == null) {
            iIntValue12 = typedArrayGenerateTypedArray.getDimensionPixelOffset(C2738R.styleable.Badge_horizontalOffsetWithText, state2.horizontalOffsetWithoutText.intValue());
        } else {
        ...
        if (state.verticalOffsetWithText == null) {
            iIntValue13 = typedArrayGenerateTypedArray.getDimensionPixelOffset(C2738R.styleable.Badge_verticalOffsetWithText, state2.verticalOffsetWithoutText.intValue());
        } else {
        ...
        if (state.largeFontVerticalOffsetAdjustment == null) {
            iIntValue14 = typedArrayGenerateTypedArray.getDimensionPixelOffset(C2738R.styleable.Badge_largeFontVerticalOffsetAdjustment, 0);
        } else {
        ...
        if (state.autoAdjustToWithinGrandparentBounds == null) {
            zBooleanValue = typedArrayGenerateTypedArray.getBoolean(C2738R.styleable.Badge_autoAdjustToWithinGrandparentBounds, false);
        } else {
    ...
    private TypedArray generateTypedArray(Context context, int i, int i2, int i3) throws XmlPullParserException, Resources.NotFoundException, IOException {
        ...
        return ThemeEnforcement.obtainStyledAttributes(context, drawableXml, C2738R.styleable.Badge, i2, styleAttribute == 0 ? i3 : styleAttribute, new int[0]);
    }
