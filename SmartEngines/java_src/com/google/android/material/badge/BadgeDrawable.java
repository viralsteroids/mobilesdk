...
public class BadgeDrawable extends Drawable implements TextDrawableHelper.TextDrawableDelegate {
    ...
    private static final int DEFAULT_STYLE = C2738R.style.Widget_MaterialComponents_Badge;
    private static final int DEFAULT_THEME_ATTR = C2738R.attr.badgeStyle;
    ...
    private boolean isAnchorViewWrappedInCompatParent() {
        ...
        return customBadgeParent != null && customBadgeParent.getId() == C2738R.id.mtrl_anchor_parent;
    }
    ...
    private void tryWrapAnchorInCompatParent(final View view) {
        ...
        if (viewGroup == null || viewGroup.getId() != C2738R.id.mtrl_anchor_parent) {
            WeakReference<FrameLayout> weakReference = this.customBadgeParentRef;
            if (weakReference == null || weakReference.get() != viewGroup) {
                updateAnchorParentToNotClip(view);
                final FrameLayout frameLayout = new FrameLayout(view.getContext());
                frameLayout.setId(C2738R.id.mtrl_anchor_parent);
    ...
    private String getTextBadgeText() {
        ...
        return String.format(context.getString(C2738R.string.m3_exceed_max_badge_text_suffix), text.substring(0, maxCharacterCount - 1), DEFAULT_EXCEED_MAX_BADGE_TEXT_SUFFIX);
    }
    ...
    private String getNumberBadgeText() {
        ...
        return String.format(this.state.getNumberLocale(), context.getString(C2738R.string.mtrl_exceed_max_badge_number_suffix), Integer.valueOf(this.maxBadgeNumber), DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
    }
