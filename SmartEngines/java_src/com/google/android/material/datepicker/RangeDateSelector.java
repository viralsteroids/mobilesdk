...
public class RangeDateSelector implements DateSelector<Pair<Long, Long>> {
    ...
    public int getDefaultThemeResId(Context context) throws Resources.NotFoundException {
        ...
        if (Math.min(displayMetrics.widthPixels, displayMetrics.heightPixels) > resources.getDimensionPixelSize(C2738R.dimen.mtrl_calendar_maximum_default_fullscreen_minor_axis)) {
            i = C2738R.attr.materialCalendarTheme;
        } else {
            i = C2738R.attr.materialCalendarFullscreenTheme;
        }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        if (l == null && this.selectedEndItem == null) {
            return resources.getString(C2738R.string.mtrl_picker_range_header_unselected);
        }
        Long l2 = this.selectedEndItem;
        if (l2 == null) {
            return resources.getString(C2738R.string.mtrl_picker_range_header_only_start_selected, DateStrings.getDateString(this.selectedStartItem.longValue()));
        }
        if (l == null) {
            return resources.getString(C2738R.string.mtrl_picker_range_header_only_end_selected, DateStrings.getDateString(this.selectedEndItem.longValue()));
        }
        Pair<String, String> dateRangeString = DateStrings.getDateRangeString(l, l2);
        return resources.getString(C2738R.string.mtrl_picker_range_header_selected, dateRangeString.first, dateRangeString.second);
    }
    ...
    public String getSelectionContentDescription(Context context) throws Resources.NotFoundException {
        ...
        if (dateRangeString.first == null) {
            string = resources.getString(C2738R.string.mtrl_picker_announce_current_selection_none);
        } else {
            string = dateRangeString.first;
        }
        if (dateRangeString.second == null) {
            string2 = resources.getString(C2738R.string.mtrl_picker_announce_current_selection_none);
        } else {
            string2 = dateRangeString.second;
        }
        return resources.getString(C2738R.string.mtrl_picker_announce_current_range_selection, string, string2);
    }
    ...
    public int getDefaultTitleResId() {
        return C2738R.string.mtrl_picker_range_header_title;
    }
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, final OnSelectionChangedListener<Pair<Long, Long>> onSelectionChangedListener) throws Resources.NotFoundException {
        ...
        View viewInflate = layoutInflater.inflate(C2738R.layout.mtrl_picker_text_input_date_range, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C2738R.id.mtrl_picker_text_input_range_start);
        final TextInputLayout textInputLayout2 = (TextInputLayout) viewInflate.findViewById(C2738R.id.mtrl_picker_text_input_range_end);
        ...
        this.invalidRangeStartError = viewInflate.getResources().getString(C2738R.string.mtrl_picker_invalid_range);
