...
public class SingleDateSelector implements DateSelector<Long> {
    ...
    public View onCreateTextInputView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle, CalendarConstraints calendarConstraints, final OnSelectionChangedListener<Long> onSelectionChangedListener) throws Resources.NotFoundException {
        ...
        View viewInflate = layoutInflater.inflate(C2738R.layout.mtrl_picker_text_input_date, viewGroup, false);
        final TextInputLayout textInputLayout = (TextInputLayout) viewInflate.findViewById(C2738R.id.mtrl_picker_text_input_date);
    ...
    public int getDefaultThemeResId(Context context) {
        return MaterialAttributes.resolveOrThrow(context, C2738R.attr.materialCalendarTheme, MaterialDatePicker.class.getCanonicalName());
    }
    ...
    public String getSelectionDisplayString(Context context) {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            return resources.getString(C2738R.string.mtrl_picker_date_header_unselected);
        }
        return resources.getString(C2738R.string.mtrl_picker_date_header_selected, DateStrings.getYearMonthDay(l.longValue()));
    }
    ...
    public String getSelectionContentDescription(Context context) throws Resources.NotFoundException {
        ...
        Long l = this.selectedItem;
        if (l == null) {
            yearMonthDay = resources.getString(C2738R.string.mtrl_picker_announce_current_selection_none);
        } else {
            yearMonthDay = DateStrings.getYearMonthDay(l.longValue());
        }
        return resources.getString(C2738R.string.mtrl_picker_announce_current_selection, yearMonthDay);
    }
    ...
    public int getDefaultTitleResId() {
        return C2738R.string.mtrl_picker_date_header_title;
    }
