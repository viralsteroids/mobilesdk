...
class UtcDates {
    ...
    static String getDefaultTextInputHint(Resources resources, SimpleDateFormat simpleDateFormat) throws Resources.NotFoundException {
        ...
        String string = resources.getString(C2738R.string.mtrl_picker_text_input_year_abbr);
        String string2 = resources.getString(C2738R.string.mtrl_picker_text_input_month_abbr);
        String string3 = resources.getString(C2738R.string.mtrl_picker_text_input_day_abbr);
