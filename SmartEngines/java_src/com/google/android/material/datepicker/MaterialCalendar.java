...
public final class MaterialCalendar<S> extends PickerFragment<S> {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) throws Resources.NotFoundException {
        ...
        if (MaterialDatePicker.isFullscreen(contextThemeWrapper)) {
            i = C2738R.layout.mtrl_calendar_vertical;
            i2 = 1;
        } else {
            i = C2738R.layout.mtrl_calendar_horizontal;
            i2 = 0;
        }
        View viewInflate = layoutInflaterCloneInContext.inflate(i, viewGroup, false);
        viewInflate.setMinimumHeight(getDialogPickerHeight(requireContext()));
        GridView gridView = (GridView) viewInflate.findViewById(C2738R.id.mtrl_calendar_days_of_week);
        ...
        this.recyclerView = (RecyclerView) viewInflate.findViewById(C2738R.id.mtrl_calendar_months);
        ...
        int integer = contextThemeWrapper.getResources().getInteger(C2738R.integer.mtrl_calendar_year_selector_span);
        RecyclerView recyclerView = (RecyclerView) viewInflate.findViewById(C2738R.id.mtrl_calendar_year_selector_frame);
        ...
        if (viewInflate.findViewById(C2738R.id.month_navigation_fragment_toggle) != null) {
    ...
    static int getDayHeight(Context context) {
        return context.getResources().getDimensionPixelSize(C2738R.dimen.mtrl_calendar_day_height);
    }
    ...
    private void addActionsToMonthNavigation(View view, final MonthsPagerAdapter monthsPagerAdapter) {
        final MaterialButton materialButton = (MaterialButton) view.findViewById(C2738R.id.month_navigation_fragment_toggle);
        ...
        ViewCompat.setAccessibilityDelegate(materialButton, new AccessibilityDelegateCompat() { // from class: com.google.android.material.datepicker.MaterialCalendar.6
            ...
            public void onInitializeAccessibilityNodeInfo(View view2, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                if (MaterialCalendar.this.dayFrame.getVisibility() == 0) {
                    string = MaterialCalendar.this.getString(C2738R.string.mtrl_picker_toggle_to_year_selection);
                } else {
                    string = MaterialCalendar.this.getString(C2738R.string.mtrl_picker_toggle_to_day_selection);
                }
                accessibilityNodeInfoCompat.setHintText(string);
            }
        });
        View viewFindViewById = view.findViewById(C2738R.id.month_navigation_previous);
        this.monthPrev = viewFindViewById;
        viewFindViewById.setTag(NAVIGATION_PREV_TAG);
        View viewFindViewById2 = view.findViewById(C2738R.id.month_navigation_next);
        this.monthNext = viewFindViewById2;
        viewFindViewById2.setTag(NAVIGATION_NEXT_TAG);
        this.yearFrame = view.findViewById(C2738R.id.mtrl_calendar_year_selector_frame);
        this.dayFrame = view.findViewById(C2738R.id.mtrl_calendar_day_selector_frame);
        setSelector(CalendarSelector.DAY);
    ...
    private static int getDialogPickerHeight(Context context) throws Resources.NotFoundException {
        ...
        return resources.getDimensionPixelSize(C2738R.dimen.mtrl_calendar_navigation_height) + resources.getDimensionPixelOffset(C2738R.dimen.mtrl_calendar_navigation_top_padding) + resources.getDimensionPixelOffset(C2738R.dimen.mtrl_calendar_navigation_bottom_padding) + resources.getDimensionPixelSize(C2738R.dimen.mtrl_calendar_days_of_week_height) + (MonthAdapter.MAXIMUM_WEEKS * resources.getDimensionPixelSize(C2738R.dimen.mtrl_calendar_day_height)) + ((MonthAdapter.MAXIMUM_WEEKS - 1) * resources.getDimensionPixelOffset(C2738R.dimen.mtrl_calendar_month_vertical_padding)) + resources.getDimensionPixelOffset(C2738R.dimen.mtrl_calendar_bottom_padding);
    }
