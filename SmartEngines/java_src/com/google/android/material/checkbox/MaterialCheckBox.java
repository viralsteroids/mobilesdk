...
public class MaterialCheckBox extends AppCompatCheckBox {
    ...
    private static final int DEF_STYLE_RES = C2738R.style.Widget_MaterialComponents_CompoundButton_CheckBox;
    private static final int[] INDETERMINATE_STATE_SET = {C2738R.attr.state_indeterminate};
    private static final int[] ERROR_STATE_SET = {C2738R.attr.state_error};
    private static final int[][] CHECKBOX_STATES = {new int[]{R.attr.state_enabled, C2738R.attr.state_error}, new int[]{R.attr.state_enabled, R.attr.state_checked}, new int[]{R.attr.state_enabled, -16842912}, new int[]{-16842910, R.attr.state_checked}, new int[]{-16842910, -16842912}};
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2738R.attr.checkboxStyle);
    }
    ...
    public MaterialCheckBox(Context context, AttributeSet attributeSet, int i) {
        ...
        this.transitionToUnchecked = AnimatedVectorDrawableCompat.create(getContext(), C2738R.drawable.mtrl_checkbox_button_checked_unchecked);
        ...
        TintTypedArray tintTypedArrayObtainTintedStyledAttributes = ThemeEnforcement.obtainTintedStyledAttributes(context2, attributeSet, C2738R.styleable.MaterialCheckBox, i, i2, new int[0]);
        this.buttonIconDrawable = tintTypedArrayObtainTintedStyledAttributes.getDrawable(C2738R.styleable.MaterialCheckBox_buttonIcon);
        if (this.buttonDrawable != null && ThemeEnforcement.isMaterial3Theme(context2) && isButtonDrawableLegacy(tintTypedArrayObtainTintedStyledAttributes)) {
            ...
            this.buttonDrawable = AppCompatResources.getDrawable(context2, C2738R.drawable.mtrl_checkbox_button);
            this.usingMaterialButtonDrawable = true;
            if (this.buttonIconDrawable == null) {
                this.buttonIconDrawable = AppCompatResources.getDrawable(context2, C2738R.drawable.mtrl_checkbox_button_icon);
            }
        }
        this.buttonIconTintList = MaterialResources.getColorStateList(context2, tintTypedArrayObtainTintedStyledAttributes, C2738R.styleable.MaterialCheckBox_buttonIconTint);
        this.buttonIconTintMode = ViewUtils.parseTintMode(tintTypedArrayObtainTintedStyledAttributes.getInt(C2738R.styleable.MaterialCheckBox_buttonIconTintMode, -1), PorterDuff.Mode.SRC_IN);
        this.useMaterialThemeColors = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.MaterialCheckBox_useMaterialThemeColors, false);
        this.centerIfNoTextEnabled = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.MaterialCheckBox_centerIfNoTextEnabled, true);
        this.errorShown = tintTypedArrayObtainTintedStyledAttributes.getBoolean(C2738R.styleable.MaterialCheckBox_errorShown, false);
        this.errorAccessibilityLabel = tintTypedArrayObtainTintedStyledAttributes.getText(C2738R.styleable.MaterialCheckBox_errorAccessibilityLabel);
        if (tintTypedArrayObtainTintedStyledAttributes.hasValue(C2738R.styleable.MaterialCheckBox_checkedState)) {
            setCheckedState(tintTypedArrayObtainTintedStyledAttributes.getInt(C2738R.styleable.MaterialCheckBox_checkedState, 0));
        }
    ...
    private void setUpDefaultButtonDrawableAnimationIfNeeded() {
        if (this.usingMaterialButtonDrawable) {
            ...
            ((AnimatedStateListDrawable) drawable).addTransition(C2738R.id.checked, C2738R.id.unchecked, this.transitionToUnchecked, false);
            ((AnimatedStateListDrawable) this.buttonDrawable).addTransition(C2738R.id.indeterminate, C2738R.id.unchecked, this.transitionToUnchecked, false);
        }
    }
    ...
    private String getButtonStateDescription() {
        ...
        if (i == 1) {
            return getResources().getString(C2738R.string.mtrl_checkbox_state_description_checked);
        }
        if (i == 0) {
            return getResources().getString(C2738R.string.mtrl_checkbox_state_description_unchecked);
        }
        return getResources().getString(C2738R.string.mtrl_checkbox_state_description_indeterminate);
    }
    ...
    private boolean isButtonDrawableLegacy(TintTypedArray tintTypedArray) {
        return tintTypedArray.getResourceId(C2738R.styleable.MaterialCheckBox_android_button, 0) == FRAMEWORK_BUTTON_DRAWABLE_RES_ID && tintTypedArray.getResourceId(C2738R.styleable.MaterialCheckBox_buttonCompat, 0) == 0;
    }
    ...
    private ColorStateList getMaterialThemeColorsTintList() {
        if (this.materialThemeColorsTintList == null) {
            ...
            int color2 = MaterialColors.getColor(this, C2738R.attr.colorError);
            int color3 = MaterialColors.getColor(this, C2738R.attr.colorSurface);
            int color4 = MaterialColors.getColor(this, C2738R.attr.colorOnSurface);
