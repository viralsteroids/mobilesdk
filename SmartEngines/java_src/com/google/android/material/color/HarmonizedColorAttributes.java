...
public final class HarmonizedColorAttributes {
    private static final int[] HARMONIZED_MATERIAL_ATTRIBUTES = {C2738R.attr.colorError, C2738R.attr.colorOnError, C2738R.attr.colorErrorContainer, C2738R.attr.colorOnErrorContainer};
    ...
    public static HarmonizedColorAttributes createMaterialDefaults() {
        return create(HARMONIZED_MATERIAL_ATTRIBUTES, C2738R.style.ThemeOverlay_Material3_HarmonizedColors);
    }
