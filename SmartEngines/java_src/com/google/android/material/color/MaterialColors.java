...
public class MaterialColors {
    ...
    public static int harmonizeWithPrimary(Context context, int i) {
        return harmonize(i, getColor(context, C2738R.attr.colorPrimary, MaterialColors.class.getCanonicalName()));
    }
    ...
    static boolean isLightTheme(Context context) {
        return MaterialAttributes.resolveBoolean(context, C2738R.attr.isLightTheme, true);
    }
