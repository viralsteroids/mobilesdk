...
abstract class SheetDialog<C extends SheetCallback> extends AppCompatDialog {
    private static final int COORDINATOR_LAYOUT_ID = C2738R.id.coordinator;
    private static final int TOUCH_OUTSIDE_ID = C2738R.id.touch_outside;
    ...
    /* synthetic */ void m457x401f75dd(View view) {
    ...
    private void maybeUpdateWindowAnimationsBasedOnLayoutDirection() {
        ...
        if (GravityCompat.getAbsoluteGravity(((CoordinatorLayout.LayoutParams) this.sheet.getLayoutParams()).gravity, ViewCompat.getLayoutDirection(this.sheet)) == 3) {
            i = C2738R.style.Animation_Material3_SideSheetDialog_Left;
        } else {
            i = C2738R.style.Animation_Material3_SideSheetDialog_Right;
        }
