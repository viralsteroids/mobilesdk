...
class TimePickerView extends ConstraintLayout implements TimePickerControls {
    ...
    public TimePickerView(Context context, AttributeSet attributeSet, int i) {
        ...
        this.selectionListener = new View.OnClickListener() { // from class: com.google.android.material.timepicker.TimePickerView.1
            ...
            public void onClick(View view) {
                if (TimePickerView.this.onSelectionChangeListener != null) {
                    TimePickerView.this.onSelectionChangeListener.onSelectionChanged(((Integer) view.getTag(C2738R.id.selection_type)).intValue());
                }
            }
        };
        LayoutInflater.from(context).inflate(C2738R.layout.material_timepicker, this);
        this.clockFace = (ClockFaceView) findViewById(C2738R.id.material_clock_face);
        MaterialButtonToggleGroup materialButtonToggleGroup = (MaterialButtonToggleGroup) findViewById(C2738R.id.material_clock_period_toggle);
        ...
        materialButtonToggleGroup.addOnButtonCheckedListener(new MaterialButtonToggleGroup.OnButtonCheckedListener() { // from class: com.google.android.material.timepicker.TimePickerView$$ExternalSyntheticLambda0
            ...
            public final void onButtonChecked(MaterialButtonToggleGroup materialButtonToggleGroup2, int i2, boolean z) {
                this.f$0.m479x9f44237d(materialButtonToggleGroup2, i2, z);
            }
        });
        this.minuteView = (Chip) findViewById(C2738R.id.material_minute_tv);
        this.hourView = (Chip) findViewById(C2738R.id.material_hour_tv);
        this.clockHandView = (ClockHandView) findViewById(C2738R.id.material_clock_hand);
        setupDoubleTap();
        setUpDisplay();
    }

    /* renamed from: lambda$new$0$com-google-android-material-timepicker-TimePickerView */
    /* synthetic */ void m479x9f44237d(MaterialButtonToggleGroup materialButtonToggleGroup, int i, boolean z) {
        if (z && this.onPeriodChangeListener != null) {
            this.onPeriodChangeListener.onPeriodChange(i == C2738R.id.material_clock_period_pm_button ? 1 : 0);
        }
    }
    ...
    private void setUpDisplay() {
        this.minuteView.setTag(C2738R.id.selection_type, 12);
        this.hourView.setTag(C2738R.id.selection_type, 10);
    ...
    public void updateTime(int i, int i2, int i3) {
        int i4;
        if (i == 1) {
            i4 = C2738R.id.material_clock_period_pm_button;
        } else {
            i4 = C2738R.id.material_clock_period_am_button;
        }
