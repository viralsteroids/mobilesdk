...
public class MaterialAlertDialogBuilder extends AlertDialog.Builder {
    private static final int DEF_STYLE_ATTR = C2738R.attr.alertDialogStyle;
    private static final int DEF_STYLE_RES = C2738R.style.MaterialAlertDialog_MaterialComponents;
    private static final int MATERIAL_ALERT_DIALOG_THEME_OVERLAY = C2738R.attr.materialAlertDialogTheme;
    ...
    public MaterialAlertDialogBuilder(Context context, int i) {
        ...
        int color = MaterialColors.getColor(context2, C2738R.attr.colorSurface, getClass().getCanonicalName());
        TypedArray typedArrayObtainStyledAttributes = context2.obtainStyledAttributes(null, C2738R.styleable.MaterialAlertDialog, i2, i3);
        int color2 = typedArrayObtainStyledAttributes.getColor(C2738R.styleable.MaterialAlertDialog_backgroundTint, color);
