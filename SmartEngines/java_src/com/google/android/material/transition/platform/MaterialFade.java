...
public final class MaterialFade extends MaterialVisibility<FadeProvider> {
    ...
    private static final int DEFAULT_THEMED_INCOMING_DURATION_ATTR = C2738R.attr.motionDurationMedium4;
    private static final int DEFAULT_THEMED_OUTGOING_DURATION_ATTR = C2738R.attr.motionDurationShort3;
    private static final int DEFAULT_THEMED_INCOMING_EASING_ATTR = C2738R.attr.motionEasingEmphasizedDecelerateInterpolator;
    private static final int DEFAULT_THEMED_OUTGOING_EASING_ATTR = C2738R.attr.motionEasingEmphasizedAccelerateInterpolator;
