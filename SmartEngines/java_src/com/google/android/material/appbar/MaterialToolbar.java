...
public class MaterialToolbar extends Toolbar {
    private static final int DEF_STYLE_RES = C2738R.style.Widget_MaterialComponents_Toolbar;
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C2738R.attr.toolbarStyle);
    }
    ...
    public MaterialToolbar(Context context, AttributeSet attributeSet, int i) {
        ...
        TypedArray typedArrayObtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context2, attributeSet, C2738R.styleable.MaterialToolbar, i, i2, new int[0]);
        if (typedArrayObtainStyledAttributes.hasValue(C2738R.styleable.MaterialToolbar_navigationIconTint)) {
            setNavigationIconTint(typedArrayObtainStyledAttributes.getColor(C2738R.styleable.MaterialToolbar_navigationIconTint, -1));
        }
        this.titleCentered = typedArrayObtainStyledAttributes.getBoolean(C2738R.styleable.MaterialToolbar_titleCentered, false);
        this.subtitleCentered = typedArrayObtainStyledAttributes.getBoolean(C2738R.styleable.MaterialToolbar_subtitleCentered, false);
        int i3 = typedArrayObtainStyledAttributes.getInt(C2738R.styleable.MaterialToolbar_logoScaleType, -1);
        if (i3 >= 0) {
        ...
        if (typedArrayObtainStyledAttributes.hasValue(C2738R.styleable.MaterialToolbar_logoAdjustViewBounds)) {
            this.logoAdjustViewBounds = Boolean.valueOf(typedArrayObtainStyledAttributes.getBoolean(C2738R.styleable.MaterialToolbar_logoAdjustViewBounds, false));
        }
