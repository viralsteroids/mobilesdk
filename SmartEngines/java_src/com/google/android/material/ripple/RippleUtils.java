...
public class RippleUtils {
    ...
    private static class RippleUtilsLollipop {
        ...
        public static Drawable createOvalRipple(Context context, int i) {
            ...
            return new RippleDrawable(MaterialColors.getColorStateList(context, C2738R.attr.colorControlHighlight, ColorStateList.valueOf(0)), null, new InsetDrawable((Drawable) gradientDrawable, i, i, i, i));
        }
    }
}
