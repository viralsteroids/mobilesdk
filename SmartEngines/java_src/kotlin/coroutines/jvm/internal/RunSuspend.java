...
final class RunSuspend implements Continuation<Unit> {
    ...
    public final Result<Unit> m9055getResultxLWZpok() {
        return this.result;
    }
    ...
    public void resumeWith(Object result) {
        synchronized (this) {
            this.result = Result.m7849boximpl(result);
