...
public class MathKt__MathJVMKt extends MathKt__MathHKt {
    ...
    /* renamed from: ln */
    private static final double m543ln(double d) {
        return Math.log(d);
    }
    ...
    /* renamed from: ln */
    private static final float m544ln(float f) {
