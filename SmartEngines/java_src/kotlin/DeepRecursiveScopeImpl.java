    ...
    public final R runCallLoop() {
        while (true) {
            ...
            if (continuation != null) {
                if (!Result.m7852equalsimpl0(DeepRecursiveKt.UNDEFINED_RESULT, r)) {
                    this.result = DeepRecursiveKt.UNDEFINED_RESULT;
                    ...
                    try {
                        ...
                        if (objWrapWithContinuationImpl != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                            ...
                            continuation.resumeWith(Result.m7850constructorimpl(objWrapWithContinuationImpl));
                        }
                    } catch (Throwable th) {
