...
public final /* synthetic */ class JobKt__JobKt {
    ...
    public static final /* synthetic */ Job m9345Job(Job job) {
        return JobKt.Job(job);
    }

    /* renamed from: Job$default, reason: collision with other method in class */
    public static /* synthetic */ Job m9346Job$default(Job job, int i, Object obj) {
        if ((i & 1) != 0) {
            job = null;
        }
        return m9345Job(job);
