...
public class CancellableContinuationImpl<T> extends DispatchedTask<T> implements CancellableContinuation<T>, CoroutineStackFrame, Waiter {
    ...
    public void cancelCompletedResult$kotlinx_coroutines_core(Object takenState, Throwable cause) {
        ...
        while (true) {
            ...
            if (obj instanceof CompletedContinuation) {
                ...
                Throwable th2 = cause;
                th = th2;
                if (C1988xc40028dd.m312m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, null, null, null, th2, 15, null))) {
                    completedContinuation.invokeHandlers(this, th);
                    return;
                }
            } else {
                th = cause;
                if (C1988xc40028dd.m312m(_state$FU, this, obj, new CompletedContinuation(obj, null, null, null, th, 14, null))) {
                    return;
                }
            }
            cause = th;
    ...
    public boolean cancel(Throwable cause) {
        ...
        } while (!C1988xc40028dd.m312m(_state$FU, this, obj, new CancelledContinuation(this, cause, (obj instanceof CancelHandler) || (obj instanceof Segment))));
    ...
    private final DisposableHandle installParentHandle() {
        ...
        C1988xc40028dd.m312m(_parentHandle$FU, this, null, disposableHandleInvokeOnCompletion$default);
    ...
    private final void invokeOnCancellationImpl(Object handler) {
        ...
        while (true) {
            ...
            if (obj instanceof Active) {
                if (C1988xc40028dd.m312m(_state$FU, this, obj, handler)) {
                    return;
                }
            } else {
                if (obj instanceof CancelHandler ? true : obj instanceof Segment) {
                    ...
                    if (obj instanceof CompletedContinuation) {
                        ...
                        if (completedContinuation.getCancelled()) {
                            ...
                            if (C1988xc40028dd.m312m(_state$FU, this, obj, CompletedContinuation.copy$default(completedContinuation, null, cancelHandler, null, null, null, 29, null))) {
                                return;
                            }
                        }
                    } else {
                        ...
                        Intrinsics.checkNotNull(handler, "null cannot be cast to non-null type kotlinx.coroutines.CancelHandler");
                        if (C1988xc40028dd.m312m(_state$FU, this, obj, new CompletedContinuation(obj, (CancelHandler) handler, null, null, null, 28, null))) {
                            return;
                        }
                    }
                }
    ...
    private final void resumeImpl(Object proposedUpdate, int resumeMode, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (obj instanceof NotCompleted) {
                ...
                if (C1988xc40028dd.m312m(_state$FU, this, obj, resumedState((NotCompleted) obj, obj2, i, function1, null))) {
                    detachChildIfNonResuable();
                    dispatchResume(i);
                    return;
                } else {
    ...
    private final Symbol tryResumeImpl(Object proposedUpdate, Object idempotent, Function1<? super Throwable, Unit> onCancellation) {
        ...
        while (true) {
            ...
            if (obj instanceof NotCompleted) {
                ...
                Function1<? super Throwable, Unit> function1 = onCancellation;
                if (C1988xc40028dd.m312m(_state$FU, this, obj, resumedState((NotCompleted) obj, obj2, this.resumeMode, function1, obj3))) {
                    detachChildIfNonResuable();
