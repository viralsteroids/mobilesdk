...
public final class WorkQueue {
    ...
    private final Task pollWithExclusiveMode(boolean onlyBlocking) {
        ...
        do {
            ...
            return null;
        } while (!C1988xc40028dd.m312m(atomicReferenceFieldUpdater, this, task, null));
        return task;
    }
    ...
    private final Task tryExtractFromTheMiddle(int index, boolean onlyBlocking) {
        ...
        if (task != null) {
            if ((task.taskContext.getTaskMode() == 1) == onlyBlocking && ChannelSegment$$ExternalSyntheticBackportWithForwarding0.m547m(this.buffer, i, task, null)) {
                if (onlyBlocking) {
    ...
    private final long tryStealLastScheduled(int stealingMode, Ref.ObjectRef<Task> stolenTaskRef) {
        ...
        } while (!C1988xc40028dd.m312m(atomicReferenceFieldUpdater, this, r1, null));
