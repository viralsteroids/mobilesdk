...
public interface ReceiveChannel<E> {
    ...
    Object mo9356receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);

    @Deprecated(level = DeprecationLevel.ERROR, message = "Deprecated in favor of 'receiveCatching'. Please note that the provided replacement does not rethrow channel's close cause as 'receiveOrNull' did, for the detailed replacement please refer to the 'receiveOrNull' documentation", replaceWith = @ReplaceWith(expression = "receiveCatching().getOrNull()", imports = {}))
    Object receiveOrNull(Continuation<? super E> continuation);

    /* renamed from: tryReceive-PtdJZtk */
    Object mo9357tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo9357tryReceivePtdJZtk = receiveChannel.mo9357tryReceivePtdJZtk();
            if (ChannelResult.m9372isSuccessimpl(objMo9357tryReceivePtdJZtk)) {
                return (E) ChannelResult.m9368getOrThrowimpl(objMo9357tryReceivePtdJZtk);
            }
            Throwable thM9366exceptionOrNullimpl = ChannelResult.m9366exceptionOrNullimpl(objMo9357tryReceivePtdJZtk);
        ...
        */
        public static <E> Object receiveOrNull(ReceiveChannel<? extends E> receiveChannel, Continuation<? super E> continuation) {
            ...
            if (continuation instanceof C35171) {
                c35171 = (C35171) continuation;
                if ((c35171.label & Integer.MIN_VALUE) != 0) {
                    c35171.label -= Integer.MIN_VALUE;
                } else {
                    c35171 = new C35171(continuation);
                }
            }
            Object obj = c35171.result;
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i = c35171.label;
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                c35171.label = 1;
                objMo9356receiveCatchingJP2dKIU = receiveChannel.mo9356receiveCatchingJP2dKIU(c35171);
            ...
            return ChannelResult.m9367getOrNullimpl(objMo9356receiveCatchingJP2dKIU);
        }
