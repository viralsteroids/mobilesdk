...
public final class BroadcastKt {
    ...
    public static final <E> BroadcastChannel<E> broadcast(final ReceiveChannel<? extends E> receiveChannel, int i, CoroutineStart coroutineStart) {
        ...
        }, new C34662(receiveChannel, null), 1, null);
    }
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.channels.BroadcastKt$broadcast$2", m533f = "Broadcast.kt", m534i = {0, 1}, m535l = {56, 57}, m536m = "invokeSuspend", m537n = {"$this$broadcast", "$this$broadcast"}, m538s = {"L$0", "L$0"})
    /* renamed from: kotlinx.coroutines.channels.BroadcastKt$broadcast$2 */
    static final class C34662<E> extends SuspendLambda implements Function2<ProducerScope<? super E>, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C34662(ReceiveChannel<? extends E> receiveChannel, Continuation<? super C34662> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C34662 c34662 = new C34662(this.$channel, continuation);
            c34662.L$0 = obj;
            return c34662;
        }
        ...
        public final Object invoke(ProducerScope<? super E> producerScope, Continuation<? super Unit> continuation) {
            return ((C34662) create(producerScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
