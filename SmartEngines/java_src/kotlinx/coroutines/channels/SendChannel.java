...
public interface SendChannel<E> {
    ...
    Object mo9352trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            Object objMo9352trySendJP2dKIU = sendChannel.mo9352trySendJP2dKIU(e);
            if (ChannelResult.m9372isSuccessimpl(objMo9352trySendJP2dKIU)) {
                return true;
            }
            Throwable thM9366exceptionOrNullimpl = ChannelResult.m9366exceptionOrNullimpl(objMo9352trySendJP2dKIU);
            if (thM9366exceptionOrNullimpl == null) {
                return false;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM9366exceptionOrNullimpl);
        }
    }
}
