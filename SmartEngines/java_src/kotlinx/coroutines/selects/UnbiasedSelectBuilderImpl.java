...
public final class UnbiasedSelectBuilderImpl<R> extends UnbiasedSelectImplementation<R> {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$initSelectResult$1", m533f = "SelectOld.kt", m534i = {}, m535l = {EACTags.MESSAGE_REFERENCE}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: kotlinx.coroutines.selects.UnbiasedSelectBuilderImpl$initSelectResult$1 */
    static final class C36571 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        int label;
        final /* synthetic */ UnbiasedSelectBuilderImpl<R> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C36571(UnbiasedSelectBuilderImpl<R> unbiasedSelectBuilderImpl, Continuation<? super C36571> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C36571(this.this$0, continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C36571) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object initSelectResult() {
        ...
        BuildersKt__Builders_commonKt.launch$default(CoroutineScopeKt.CoroutineScope(getContext()), null, CoroutineStart.UNDISPATCHED, new C36571(this, null), 1, null);
        return this.cont.getResult();
    }
    ...
    public final void handleBuilderException(Throwable e) {
        ...
        cancellableContinuationImpl.resumeWith(Result.m7850constructorimpl(ResultKt.createFailure(e)));
    }
}
