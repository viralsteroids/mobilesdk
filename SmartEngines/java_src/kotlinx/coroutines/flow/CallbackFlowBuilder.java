...
final class CallbackFlowBuilder<T> extends ChannelFlowBuilder<T> {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.flow.CallbackFlowBuilder", m533f = "Builders.kt", m534i = {0}, m535l = {334}, m536m = "collectTo", m537n = {"scope"}, m538s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.CallbackFlowBuilder$collectTo$1 */
    static final class C35291 extends ContinuationImpl {
        Object L$0;
        int label;
        ...
        C35291(CallbackFlowBuilder<T> callbackFlowBuilder, Continuation<? super C35291> continuation) {
            super(continuation);
    ...
    */
    protected Object collectTo(ProducerScope<? super T> producerScope, Continuation<? super Unit> continuation) {
        C35291 c35291;
        if (continuation instanceof C35291) {
            c35291 = (C35291) continuation;
            if ((c35291.label & Integer.MIN_VALUE) != 0) {
                c35291.label -= Integer.MIN_VALUE;
            } else {
                c35291 = new C35291(this, continuation);
            }
        }
        Object obj = c35291.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c35291.label;
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            c35291.L$0 = producerScope;
            c35291.label = 1;
            if (super.collectTo(producerScope, c35291) == coroutine_suspended) {
            ...
            producerScope = (ProducerScope) c35291.L$0;
            ResultKt.throwOnFailure(obj);
        }
