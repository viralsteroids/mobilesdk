...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10 implements Flow<Long> {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10", m533f = "Builders.kt", m534i = {0}, m535l = {116}, m536m = "collect", m537n = {"$this$asFlow_u24lambda_u2419"}, m538s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$10$1 */
    public static final class C35321 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C35321(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super Long> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Iterator<Long> it;
        if (continuation instanceof C35321) {
            c35321 = (C35321) continuation;
            if ((c35321.label & Integer.MIN_VALUE) != 0) {
                c35321.label -= Integer.MIN_VALUE;
            } else {
                c35321 = new C35321(continuation);
            }
        }
        Object obj = c35321.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c35321.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c35321.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Long lBoxLong = Boxing.boxLong(((LongIterator) it).nextLong());
            c35321.L$0 = flowCollector2;
            c35321.L$1 = it;
            c35321.label = 1;
            if (flowCollector2.emit(lBoxLong, c35321) == coroutine_suspended) {
