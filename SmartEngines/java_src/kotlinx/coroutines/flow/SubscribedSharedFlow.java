...
final class SubscribedSharedFlow<T> implements SharedFlow<T> {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.flow.SubscribedSharedFlow", m533f = "Share.kt", m534i = {}, m535l = {409}, m536m = "collect", m537n = {}, m538s = {})
    /* renamed from: kotlinx.coroutines.flow.SubscribedSharedFlow$collect$1 */
    static final class C36371 extends ContinuationImpl {
        int label;
        /* synthetic */ Object result;
        final /* synthetic */ SubscribedSharedFlow<T> this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C36371(SubscribedSharedFlow<T> subscribedSharedFlow, Continuation<? super C36371> continuation) {
            super(continuation);
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<?> continuation) {
        C36371 c36371;
        if (continuation instanceof C36371) {
            c36371 = (C36371) continuation;
            if ((c36371.label & Integer.MIN_VALUE) != 0) {
                c36371.label -= Integer.MIN_VALUE;
            } else {
                c36371 = new C36371(this, continuation);
            }
        }
        Object obj = c36371.result;
        ...
        if (i == 0) {
            ...
            c36371.label = 1;
            if (sharedFlow.collect(subscribedFlowCollector, c36371) == coroutine_suspended) {
