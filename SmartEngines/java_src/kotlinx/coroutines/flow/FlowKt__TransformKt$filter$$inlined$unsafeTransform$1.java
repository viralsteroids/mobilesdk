...
public final class FlowKt__TransformKt$filter$$inlined$unsafeTransform$1<T> implements Flow<T> {
    ...
    public static final class C36032<T> implements FlowCollector {
        final /* synthetic */ Function2 $predicate$inlined;
        final /* synthetic */ FlowCollector $this_unsafeFlow;

        /* compiled from: Emitters.kt */
        @Metadata(m515k = 3, m516mv = {1, 8, 0}, m518xi = CipherSuite.TLS_PSK_WITH_NULL_SHA256)
        @DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__TransformKt$filter$$inlined$unsafeTransform$1$2", m533f = "Transform.kt", m534i = {0, 0}, m535l = {223, 223}, m536m = "emit", m537n = {"value", "$this$filter_u24lambda_u240"}, m538s = {"L$0", "L$1"})
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C36032.this.emit(null, this);
            }
        }

        public C36032(FlowCollector flowCollector, Function2 function2) {
    ...
    public Object collect(FlowCollector flowCollector, Continuation continuation) {
        Object objCollect = this.$this_unsafeTransform$inlined.collect(new C36032(flowCollector, this.$predicate$inlined), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        this.$this_unsafeTransform$inlined.collect(new C36032(flowCollector, this.$predicate$inlined), continuation);
        return Unit.INSTANCE;
    }
}
