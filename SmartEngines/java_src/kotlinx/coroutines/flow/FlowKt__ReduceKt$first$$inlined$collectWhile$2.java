...
public final class FlowKt__ReduceKt$first$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2", m533f = "Reduce.kt", m534i = {0, 0}, m535l = {142}, m536m = "emit", m537n = {"this", "it"}, m538s = {"L$0", "L$1"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__ReduceKt$first$$inlined$collectWhile$2$1 */
    public static final class C35821 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C35821(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object emit(T t, Continuation<? super Unit> continuation) {
        ...
        if (continuation instanceof C35821) {
            c35821 = (C35821) continuation;
            if ((c35821.label & Integer.MIN_VALUE) != 0) {
                c35821.label -= Integer.MIN_VALUE;
            } else {
                c35821 = new C35821(continuation);
            }
        }
        Object objInvoke = c35821.result;
        ...
        if (i == 0) {
            ...
            c35821.L$1 = t;
            c35821.label = 1;
            objInvoke = function2.invoke(t, c35821);
            ...
            t = (T) c35821.L$1;
            flowKt__ReduceKt$first$$inlined$collectWhile$2 = (FlowKt__ReduceKt$first$$inlined$collectWhile$2) c35821.L$0;
            ResultKt.throwOnFailure(objInvoke);
        }
