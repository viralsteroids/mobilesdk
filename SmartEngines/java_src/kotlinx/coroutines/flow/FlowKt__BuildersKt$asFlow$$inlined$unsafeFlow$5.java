...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5<T> implements Flow<T> {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5", m533f = "Builders.kt", m534i = {0}, m535l = {116}, m536m = "collect", m537n = {"$this$asFlow_u24lambda_u247"}, m538s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$5$1 */
    public static final class C35361 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C35361(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Iterator<T> it;
        if (continuation instanceof C35361) {
            c35361 = (C35361) continuation;
            if ((c35361.label & Integer.MIN_VALUE) != 0) {
                c35361.label -= Integer.MIN_VALUE;
            } else {
                c35361 = new C35361(continuation);
            }
        }
        Object obj = c35361.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c35361.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c35361.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            T next = it.next();
            c35361.L$0 = flowCollector2;
            c35361.L$1 = it;
            c35361.label = 1;
            if (flowCollector2.emit(next, c35361) == coroutine_suspended) {
