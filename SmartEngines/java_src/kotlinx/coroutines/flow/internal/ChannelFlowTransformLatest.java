...
public final class ChannelFlowTransformLatest<T, R> extends ChannelFlowOperator<T, R> {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3", m533f = "Merge.kt", m534i = {}, m535l = {27}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3 */
    static final class C36413 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: Multi-variable type inference failed */
        C36413(ChannelFlowTransformLatest<T, R> channelFlowTransformLatest, FlowCollector<? super R> flowCollector, Continuation<? super C36413> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C36413 c36413 = new C36413(this.this$0, this.$collector, continuation);
            c36413.L$0 = obj;
            return c36413;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C36413) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            */
            ...
            /* compiled from: Merge.kt */
            @Metadata(m513d1 = {"\u0000\u000e\n\u0000\n\u0002\u0010\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002\"\u0004\b\u0001\u0010\u0003*\u00020\u0004H\u008a@"}, m514d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "R", "Lkotlinx/coroutines/CoroutineScope;"}, m515k = 3, m516mv = {1, 8, 0}, m518xi = 48)
            @DebugMetadata(m532c = "kotlinx.coroutines.flow.internal.ChannelFlowTransformLatest$flowCollect$3$1$2", m533f = "Merge.kt", m534i = {}, m535l = {34}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    ...
    protected Object flowCollect(FlowCollector<? super R> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Object objCoroutineScope = CoroutineScopeKt.coroutineScope(new C36413(this, flowCollector, null), continuation);
