...
public final class SafeCollector<T> extends ContinuationImpl implements FlowCollector<T>, CoroutineStackFrame {
    ...
    public Object invokeSuspend(Object result) {
        Throwable thM7853exceptionOrNullimpl = Result.m7853exceptionOrNullimpl(result);
        if (thM7853exceptionOrNullimpl != null) {
            this.lastEmissionContext = new DownstreamExceptionContext(thM7853exceptionOrNullimpl, getContext());
        }
        Continuation<? super Unit> continuation = this.completion;
