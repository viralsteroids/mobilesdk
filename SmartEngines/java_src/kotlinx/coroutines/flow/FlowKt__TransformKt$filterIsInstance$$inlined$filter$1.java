...
public final class FlowKt__TransformKt$filterIsInstance$$inlined$filter$1 implements Flow<Object> {
    ...
    public static final class C36052<T> implements FlowCollector {
        ...
        public static final class AnonymousClass1 extends ContinuationImpl {
            ...
            public final Object invokeSuspend(Object obj) {
                ...
                return C36052.this.emit(null, this);
            }
        }

        public C36052(FlowCollector flowCollector) {
    ...
    public Object collect(FlowCollector<? super Object> flowCollector, Continuation continuation) {
        ...
        Object objCollect = flow.collect(new C36052(flowCollector), continuation);
    ...
    public Object collect$$forInline(FlowCollector flowCollector, Continuation continuation) {
        ...
        Flow flow = this.$this_unsafeTransform$inlined;
        Intrinsics.needClassReification();
        flow.collect(new C36052(flowCollector), continuation);
        return Unit.INSTANCE;
    }
}
