...
@DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__DelayKt$debounceInternal$1$values$1", m533f = "Delay.kt", m534i = {}, m535l = {210}, m536m = "invokeSuspend", m537n = {}, m538s = {})
...
final class FlowKt__DelayKt$debounceInternal$1$values$1 extends SuspendLambda implements Function2<ProducerScope<? super Object>, Continuation<? super Unit>, Object> {
    ...
    static final class C35531<T> implements FlowCollector {
        final /* synthetic */ ProducerScope<Object> $$this$produce;

        C35531(ProducerScope<Object> producerScope) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            this.label = 1;
            if (this.$this_debounceInternal.collect(new C35531(producerScope), this) == coroutine_suspended) {
                return coroutine_suspended;
            }
        } else {
            if (i != 1) {
