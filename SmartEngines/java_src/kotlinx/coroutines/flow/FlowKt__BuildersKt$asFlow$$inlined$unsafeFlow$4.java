...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4<T> implements Flow<T> {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4", m533f = "Builders.kt", m534i = {0}, m535l = {116}, m536m = "collect", m537n = {"$this$asFlow_u24lambda_u245"}, m538s = {"L$0"})
    /* renamed from: kotlinx.coroutines.flow.FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$4$1 */
    public static final class C35351 extends ContinuationImpl {
        Object L$0;
        Object L$1;
        int label;
        /* synthetic */ Object result;

        public C35351(Continuation continuation) {
            super(continuation);
        }
    ...
    */
    public Object collect(FlowCollector<? super T> flowCollector, Continuation<? super Unit> continuation) {
        ...
        Iterator it;
        if (continuation instanceof C35351) {
            c35351 = (C35351) continuation;
            if ((c35351.label & Integer.MIN_VALUE) != 0) {
                c35351.label -= Integer.MIN_VALUE;
            } else {
                c35351 = new C35351(continuation);
            }
        }
        Object obj = c35351.result;
        ...
        if (i == 0) {
            ...
            it = (Iterator) c35351.L$1;
            FlowCollector flowCollector3 = (FlowCollector) c35351.L$0;
            ResultKt.throwOnFailure(obj);
            flowCollector2 = flowCollector3;
        }
        while (it.hasNext()) {
            Object next = it.next();
            c35351.L$0 = flowCollector2;
            c35351.L$1 = it;
            c35351.label = 1;
            if (flowCollector2.emit(next, c35351) == coroutine_suspended) {
