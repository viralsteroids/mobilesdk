...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM7850constructorimpl = Result.m7850constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM7850constructorimpl = Result.m7850constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m7853exceptionOrNullimpl(objM7850constructorimpl) == null) {
            obj2 = objM7850constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM7850constructorimpl2 = Result.m7850constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM7850constructorimpl2 = Result.m7850constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m7853exceptionOrNullimpl(objM7850constructorimpl2) == null) {
            obj = objM7850constructorimpl2;
        }
        ...
        if (cause != null && Intrinsics.areEqual(cause.getClass(), e.getClass())) {
            ...
            for (StackTraceElement stackTraceElement : stackTrace) {
                if (isArtificial(stackTraceElement)) {
                    return TuplesKt.m521to(cause, stackTrace);
                }
            }
            return TuplesKt.m521to(e, new StackTraceElement[0]);
        }
        return TuplesKt.m521to(e, new StackTraceElement[0]);
    }
