...
public final class DispatchedContinuation<T> extends DispatchedTask<T> implements CoroutineStackFrame, Continuation<T> {
    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation$kotlinx_coroutines_core() {
        ...
        while (true) {
            ...
            if (obj instanceof CancellableContinuationImpl) {
                if (C1988xc40028dd.m312m(_reusableCancellableContinuation$FU, this, obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    return (CancellableContinuationImpl) obj;
                }
    ...
    public final Throwable tryReleaseClaimedContinuation$kotlinx_coroutines_core(CancellableContinuation<?> continuation) {
        ...
        do {
            ...
            if (obj != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (obj instanceof Throwable) {
                    if (!C1988xc40028dd.m312m(_reusableCancellableContinuation$FU, this, obj, null)) {
        ...
        } while (!C1988xc40028dd.m312m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, continuation));
        return null;
    }
    ...
    public final boolean postponeCancellation$kotlinx_coroutines_core(Throwable cause) {
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(obj, DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (C1988xc40028dd.m312m(_reusableCancellableContinuation$FU, this, DispatchedContinuationKt.REUSABLE_CLAIMED, cause)) {
                    return true;
                }
            } else {
                if (obj instanceof Throwable) {
    ...
    public void resumeWith(Object result) {
        ...
        if (this.dispatcher.isDispatchNeeded(context2)) {
            ...
            this.resumeMode = 0;
            this.dispatcher.mo9408dispatch(context2, this);
            return;
        }
    ...
    */
    public final void resumeCancellableWith$kotlinx_coroutines_core(Object result, Function1<? super Throwable, Unit> onCancellation) {
        ...
        if (this.dispatcher.isDispatchNeeded(getContext())) {
            this._state = state;
            this.resumeMode = 1;
            this.dispatcher.mo9408dispatch(getContext(), this);
            return;
        }
        DebugKt.getASSERTIONS_ENABLED();
        EventLoop eventLoop$kotlinx_coroutines_core = ThreadLocalEventLoop.INSTANCE.getEventLoop$kotlinx_coroutines_core();
        ...
        if (job != null && !job.isActive()) {
            ...
            resumeWith(Result.m7850constructorimpl(ResultKt.createFailure(cancellationException)));
        } else {
            Continuation<T> continuation = this.continuation;
