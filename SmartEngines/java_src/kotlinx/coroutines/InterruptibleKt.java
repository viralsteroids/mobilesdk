...
public final class InterruptibleKt {
    ...
    @DebugMetadata(m532c = "kotlinx.coroutines.InterruptibleKt$runInterruptible$2", m533f = "Interruptible.kt", m534i = {}, m535l = {}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: kotlinx.coroutines.InterruptibleKt$runInterruptible$2 */
    static final class C34572<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C34572(Function0<? extends T> function0, Continuation<? super C34572> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C34572 c34572 = new C34572(this.$block, continuation);
            c34572.L$0 = obj;
            return c34572;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C34572) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object runInterruptible(CoroutineContext coroutineContext, Function0<? extends T> function0, Continuation<? super T> continuation) {
        return BuildersKt.withContext(coroutineContext, new C34572(function0, null), continuation);
    }
