...
public class SecP192K1Field {
    ...
    /* renamed from: P5 */
    private static final int f1680P5 = -1;
    private static final int PExt11 = -1;
    private static final int PInv33 = 4553;

    /* renamed from: P */
    static final int[] f1679P = {-4553, -2, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat192.add(iArr, iArr2, iArr3) != 0 || (iArr3[5] == -1 && Nat192.gte(iArr3, f1679P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(6, iArr, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f1679P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(6, iArr2, Nat192.add(iArr, f1679P, iArr2));
        }
    }
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat192.isZero(iArr)) {
            ...
            Nat192.sub(f1679P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat192.mul33DWordAdd(PInv33, Nat192.mul33Add(PInv33, iArr, 6, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f1679P))) {
            Nat.add33To(6, PInv33, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat192.mul33WordAdd(PInv33, i, iArr, 0) == 0) && !(iArr[5] == -1 && Nat192.gte(iArr, f1679P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(6, iArr, 0, iArr2) != 0 || (iArr2[5] == -1 && Nat192.gte(iArr2, f1679P))) {
            Nat.add33To(6, PInv33, iArr2);
        }
    }
}
