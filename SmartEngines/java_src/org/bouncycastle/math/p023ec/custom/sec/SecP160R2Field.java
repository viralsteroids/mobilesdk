...
public class SecP160R2Field {
    ...
    /* renamed from: P4 */
    private static final int f1675P4 = -1;
    private static final int PExt9 = -1;
    private static final int PInv33 = 21389;

    /* renamed from: P */
    static final int[] f1674P = {-21389, -2, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat160.add(iArr, iArr2, iArr3) != 0 || (iArr3[4] == -1 && Nat160.gte(iArr3, f1674P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(5, iArr, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1674P))) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(5, iArr2, Nat160.add(iArr, f1674P, iArr2));
        }
    }
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat160.isZero(iArr)) {
            ...
            Nat160.sub(f1674P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat160.mul33DWordAdd(PInv33, Nat160.mul33Add(PInv33, iArr, 5, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1674P))) {
            Nat.add33To(5, PInv33, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat160.mul33WordAdd(PInv33, i, iArr, 0) == 0) && !(iArr[4] == -1 && Nat160.gte(iArr, f1674P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(5, iArr, 0, iArr2) != 0 || (iArr2[4] == -1 && Nat160.gte(iArr2, f1674P))) {
            Nat.add33To(5, PInv33, iArr2);
        }
    }
}
