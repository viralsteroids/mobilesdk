...
public class SecP224K1Field {
    ...
    /* renamed from: P6 */
    private static final int f1691P6 = -1;
    private static final int PExt13 = -1;
    private static final int PInv33 = 6803;

    /* renamed from: P */
    static final int[] f1690P = {-6803, -2, -1, -1, -1, -1, -1};
    ...
    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat224.add(iArr, iArr2, iArr3) != 0 || (iArr3[6] == -1 && Nat224.gte(iArr3, f1690P))) {
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(7, iArr, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f1690P))) {
    ...
    public static int[] fromBigInteger(BigInteger bigInteger) {
        ...
        if (iArrFromBigInteger[6] == -1 && Nat224.gte(iArrFromBigInteger, f1690P)) {
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(7, iArr2, Nat224.add(iArr, f1690P, iArr2));
        }
    }
    ...
    public static void negate(int[] iArr, int[] iArr2) {
        if (Nat224.isZero(iArr)) {
            ...
            Nat224.sub(f1690P, iArr, iArr2);
        }
    }

    public static void reduce(int[] iArr, int[] iArr2) {
        if (Nat224.mul33DWordAdd(PInv33, Nat224.mul33Add(PInv33, iArr, 7, iArr, 0, iArr2, 0), iArr2, 0) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f1690P))) {
            Nat.add33To(7, PInv33, iArr2);
        }
    }

    public static void reduce32(int i, int[] iArr) {
        if ((i == 0 || Nat224.mul33WordAdd(PInv33, i, iArr, 0) == 0) && !(iArr[6] == -1 && Nat224.gte(iArr, f1690P))) {
            return;
        }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(7, iArr, 0, iArr2) != 0 || (iArr2[6] == -1 && Nat224.gte(iArr2, f1690P))) {
            Nat.add33To(7, PInv33, iArr2);
        }
    }
}
