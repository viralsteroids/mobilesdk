...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1683q = SecP192R1FieldElement.f1687Q;
    ...
    public SecP192R1Curve() {
        ...
        this.f1630a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.f1631b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawXCoord()).f1688x, 0, iArr, i3);
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawYCoord()).f1688x, 0, iArr, i3 + 6);
            i3 += 12;
        }
