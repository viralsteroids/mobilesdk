...
public class SecP256R1Field {
    ...
    /* renamed from: M */
    private static final long f1706M = 4294967295L;

    /* renamed from: P7 */
    private static final int f1708P7 = -1;
    private static final int PExt15s1 = Integer.MAX_VALUE;

    /* renamed from: P */
    static final int[] f1707P = {-1, -1, -1, 0, 0, 0, 1, -1};
    static final int[] PExt = {1, 0, 0, -2, -1, -1, -2, 1, -2, 1, -2, 1, 1, -2, 2, -2};

    public static void add(int[] iArr, int[] iArr2, int[] iArr3) {
        if (Nat256.add(iArr, iArr2, iArr3) != 0 || (iArr3[7] == -1 && Nat256.gte(iArr3, f1707P))) {
            addPInvTo(iArr3);
        }
    }
    ...
    public static void addOne(int[] iArr, int[] iArr2) {
        if (Nat.inc(8, iArr, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1707P))) {
            addPInvTo(iArr2);
        }
    }
    ...
    public static void half(int[] iArr, int[] iArr2) {
        if ((iArr[0] & 1) == 0) {
            ...
            Nat.shiftDownBit(8, iArr2, Nat256.add(iArr, f1707P, iArr2));
        }
    }
    ...
    public static void reduce32(int i, int[] iArr) {
        ...
        if (j != 0 || (iArr[7] == -1 && Nat256.gte(iArr, f1707P))) {
            addPInvTo(iArr);
        }
    }
    ...
    public static void twice(int[] iArr, int[] iArr2) {
        if (Nat.shiftUpBit(8, iArr, 0, iArr2) != 0 || (iArr2[7] == -1 && Nat256.gte(iArr2, f1707P))) {
            addPInvTo(iArr2);
        }
    }
}
