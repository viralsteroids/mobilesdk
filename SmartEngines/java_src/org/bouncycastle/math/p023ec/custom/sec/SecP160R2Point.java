...
public class SecP160R2Point extends ECPoint.AbstractFp {
    ...
    public ECPoint negate() {
        return isInfinity() ? this : new SecP160R2Point(this.curve, this.f1645x, this.f1646y.negate(), this.f1647zs);
    }
    ...
    public ECPoint twice() {
        ...
        int[] iArrCreate2 = Nat160.create();
        int[] iArrCreate3 = Nat160.create();
        SecP160R2Field.square(secP160R2FieldElement.f1677x, iArrCreate3);
        int[] iArrCreate4 = Nat160.create();
        SecP160R2Field.square(iArrCreate3, iArrCreate4);
        boolean zIsOne = secP160R2FieldElement3.isOne();
        int[] iArr = secP160R2FieldElement3.f1677x;
        if (!zIsOne) {
            SecP160R2Field.square(secP160R2FieldElement3.f1677x, iArrCreate2);
            iArr = iArrCreate2;
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.f1677x, iArr, iArrCreate);
        SecP160R2Field.add(secP160R2FieldElement2.f1677x, iArr, iArrCreate2);
        ...
        SecP160R2Field.square(iArrCreate2, secP160R2FieldElement4.f1677x);
        SecP160R2Field.subtract(secP160R2FieldElement4.f1677x, iArrCreate3, secP160R2FieldElement4.f1677x);
        SecP160R2Field.subtract(secP160R2FieldElement4.f1677x, iArrCreate3, secP160R2FieldElement4.f1677x);
        SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(iArrCreate3);
        SecP160R2Field.subtract(iArrCreate3, secP160R2FieldElement4.f1677x, secP160R2FieldElement5.f1677x);
        SecP160R2Field.multiply(secP160R2FieldElement5.f1677x, iArrCreate2, secP160R2FieldElement5.f1677x);
        SecP160R2Field.subtract(secP160R2FieldElement5.f1677x, iArrCreate, secP160R2FieldElement5.f1677x);
