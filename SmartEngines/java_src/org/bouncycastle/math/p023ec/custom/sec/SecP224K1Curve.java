...
public class SecP224K1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1689q = SecP224K1FieldElement.f1692Q;
    ...
    public SecP224K1Curve() {
        ...
        this.f1631b = fromBigInteger(BigInteger.valueOf(5L));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawXCoord()).f1693x, 0, iArr, i3);
            Nat224.copy(((SecP224K1FieldElement) eCPoint.getRawYCoord()).f1693x, 0, iArr, i3 + 7);
            i3 += 14;
        }
