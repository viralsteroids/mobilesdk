...
public class SecP160R1Curve extends ECCurve.AbstractFp {
    ...
    /* renamed from: q */
    public static final BigInteger f1667q = SecP160R1FieldElement.f1671Q;
    ...
    public SecP160R1Curve() {
        ...
        this.f1630a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF7FFFFFFC")));
        this.f1631b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("1C97BEFC54BD7A8B65ACF89F81D4D4ADC565FA45")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i, final int i2) {
        ...
        for (int i4 = 0; i4 < i2; i4++) {
            ...
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawXCoord()).f1672x, 0, iArr, i3);
            Nat160.copy(((SecP160R1FieldElement) eCPoint.getRawYCoord()).f1672x, 0, iArr, i3 + 5);
            i3 += 10;
        }
