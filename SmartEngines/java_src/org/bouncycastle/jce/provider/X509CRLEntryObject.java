...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    private Extension getExtension(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        Extensions extensions = this.f1607c.getExtensions();
        if (extensions != null) {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f1607c.equals(((X509CRLEntryObject) obj).f1607c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f1607c.getEncoded(ASN1Encoding.DER);
        } catch (IOException e) {
    ...
    public Date getRevocationDate() {
        return this.f1607c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f1607c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f1607c.getExtensions() != null;
    }
