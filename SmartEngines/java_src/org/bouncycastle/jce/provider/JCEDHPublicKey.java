...
import org.bouncycastle.asn1.p016x9.DHDomainParameters;
...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    /* renamed from: y */
    private BigInteger f1598y;

    JCEDHPublicKey(BigInteger bigInteger, DHParameterSpec dHParameterSpec) {
        this.f1598y = bigInteger;
        this.dhSpec = dHParameterSpec;
    }

    JCEDHPublicKey(DHPublicKey dHPublicKey) {
        this.f1598y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
    }

    JCEDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f1598y = dHPublicKeySpec.getY();
    ...
    JCEDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f1598y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
    ...
    JCEDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f1598y = dHPublicKeyParameters.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        this.f1598y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        ...
        return subjectPublicKeyInfo != null ? KeyUtil.getEncodedSubjectPublicKeyInfo(subjectPublicKeyInfo) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(this.f1598y));
    }
