...
public final class ByteUtils {
    ...
    public static String toHexString(byte[] bArr) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            char[] cArr = HEX_CHARS;
            str = sbAppend.append(cArr[(bArr[i] >>> 4) & 15]).toString() + cArr[bArr[i] & PassportService.SFI_DG15];
        }
        return str;
    }
    ...
    public static String toHexString(byte[] bArr, String str, String str2) {
        ...
        for (int i = 0; i < bArr.length; i++) {
            ...
            char[] cArr = HEX_CHARS;
            str3 = sbAppend.append(cArr[(bArr[i] >>> 4) & 15]).toString() + cArr[bArr[i] & PassportService.SFI_DG15];
            if (i < bArr.length - 1) {
                str3 = str3 + str2;
            }
        }
