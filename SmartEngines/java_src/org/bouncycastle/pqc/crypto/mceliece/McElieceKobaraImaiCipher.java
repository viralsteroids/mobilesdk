...
public class McElieceKobaraImaiCipher implements MessageEncryptor {
    ...
    private void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f1817n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f1816k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f1819t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    private void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f1817n = mcElieceCCA2PublicKeyParameters.getN();
        this.f1816k = mcElieceCCA2PublicKeyParameters.getK();
        this.f1819t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public void init(boolean z, CipherParameters cipherParameters) {
        ...
        if (!z) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f1818sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f1818sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException, ArrayIndexOutOfBoundsException {
        ...
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f1817n, bArr));
        ...
        byte[] bArrConcatenate = ByteUtils.concatenate(ByteUtils.concatenate(bArr2, Conversions.decode(this.f1817n, this.f1819t, gF2Vector)), encoded);
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        int digestSize = this.messDigest.getDigestSize();
        int i = this.f1816k >> 3;
        int iBitLength = (IntegerFunctions.binomial(this.f1817n, this.f1819t).bitLength() - 1) >> 3;
        ...
        byte[] encoded = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, GF2Vector.OS2VP(this.f1816k, bArr9), Conversions.encode(this.f1817n, this.f1819t, bArr8)).getEncoded();
