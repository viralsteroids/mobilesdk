...
public class McElieceCCA2KeyPairGenerator implements AsymmetricCipherKeyPairGenerator {
    ...
    public AsymmetricCipherKeyPair generateKeyPair() {
        ...
        GF2mField gF2mField = new GF2mField(this.f1796m, this.fieldPoly);
        PolynomialGF2mSmallM polynomialGF2mSmallM = new PolynomialGF2mSmallM(gF2mField, this.f1798t, 'I', this.random);
        ...
        return new AsymmetricCipherKeyPair((AsymmetricKeyParameter) new McElieceCCA2PublicKeyParameters(this.f1797n, this.f1798t, gF2Matrix, this.mcElieceCCA2Params.getParameters().getDigest()), (AsymmetricKeyParameter) new McElieceCCA2PrivateKeyParameters(this.f1797n, gF2Matrix.getNumRows(), gF2mField, polynomialGF2mSmallM, permutation, this.mcElieceCCA2Params.getParameters().getDigest()));
    }
    ...
    public void init(KeyGenerationParameters keyGenerationParameters) {
        ...
        this.f1796m = this.mcElieceCCA2Params.getParameters().getM();
        this.f1797n = this.mcElieceCCA2Params.getParameters().getN();
        this.f1798t = this.mcElieceCCA2Params.getParameters().getT();
