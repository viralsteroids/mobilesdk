...
public class BCRainbowPrivateKey implements PrivateKey {
    ...
    /* renamed from: b1 */
    private short[] f1856b1;

    /* renamed from: b2 */
    private short[] f1857b2;
    ...
    public boolean equals(Object obj) {
        ...
        boolean zEquals = RainbowUtil.equals(this.A1inv, bCRainbowPrivateKey.getInvA1()) && RainbowUtil.equals(this.A2inv, bCRainbowPrivateKey.getInvA2()) && RainbowUtil.equals(this.f1856b1, bCRainbowPrivateKey.getB1()) && RainbowUtil.equals(this.f1857b2, bCRainbowPrivateKey.getB2()) && Arrays.equals(this.f1858vi, bCRainbowPrivateKey.getVi());
    ...
    public byte[] getEncoded() {
        try {
            return new PrivateKeyInfo(new AlgorithmIdentifier(PQCObjectIdentifiers.rainbow, DERNull.INSTANCE), new RainbowPrivateKey(this.A1inv, this.f1856b1, this.A2inv, this.f1857b2, this.f1858vi, this.layers)).getEncoded();
    ...
    public int hashCode() {
        int length = (((((((((this.layers.length * 37) + org.bouncycastle.util.Arrays.hashCode(this.A1inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f1856b1)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.A2inv)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f1857b2)) * 37) + org.bouncycastle.util.Arrays.hashCode(this.f1858vi);
