...
public class ECGOST3410NamedCurves {
    ...
    static {
        ...
        ECCurve eCCurveConfigureCurve = configureCurve(new ECCurve.C3891Fp(bigInteger, new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639316"), new BigInteger("166"), bigInteger2, ECConstants.ONE));
        ...
        ECCurve eCCurveConfigureCurve2 = configureCurve(new ECCurve.C3891Fp(bigInteger3, new BigInteger("115792089237316195423570985008687907853269984665640564039457584007913129639316"), new BigInteger("166"), bigInteger4, ECConstants.ONE));
        ...
        ECCurve eCCurveConfigureCurve3 = configureCurve(new ECCurve.C3891Fp(bigInteger5, new BigInteger("57896044618658097711785492504343953926634992332820282019728792003956564823190"), new BigInteger("28091019353058090096996979000309560759124368558014865957655842872397301267595"), bigInteger6, ECConstants.ONE));
        ...
        ECCurve eCCurveConfigureCurve4 = configureCurve(new ECCurve.C3891Fp(bigInteger7, new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502616"), new BigInteger("32858"), bigInteger8, ECConstants.ONE));
        ...
        ECCurve eCCurveConfigureCurve5 = configureCurve(new ECCurve.C3891Fp(bigInteger9, new BigInteger("70390085352083305199547718019018437841079516630045180471284346843705633502616"), new BigInteger("32858"), bigInteger10, ECConstants.ONE));
        ...
        ECCurve eCCurveConfigureCurve6 = configureCurve(new ECCurve.C3891Fp(bigInteger11, new BigInteger("C2173F1513981673AF4892C23035A27CE25E2013BF95AA33B22C656F277E7335", 16), new BigInteger("295F9BAE7428ED9CCC20E7C359A9D41A22FCCD9108E17BF7BA9337A6F8AE9513", 16), bigInteger12, ECConstants.FOUR));
