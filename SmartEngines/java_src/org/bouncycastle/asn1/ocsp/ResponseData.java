...
public class ResponseData extends ASN1Object {
    ...
    /* renamed from: V1 */
    private static final ASN1Integer f980V1 = new ASN1Integer(0);
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, Extensions extensions) {
        this(f980V1, responderID, aSN1GeneralizedTime, aSN1Sequence, extensions);
    }
    ...
    public ResponseData(ResponderID responderID, ASN1GeneralizedTime aSN1GeneralizedTime, ASN1Sequence aSN1Sequence, X509Extensions x509Extensions) {
        this(f980V1, responderID, ASN1GeneralizedTime.getInstance(aSN1GeneralizedTime), aSN1Sequence, Extensions.getInstance(x509Extensions));
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        if (this.versionPresent || !this.version.equals((ASN1Primitive) f980V1)) {
