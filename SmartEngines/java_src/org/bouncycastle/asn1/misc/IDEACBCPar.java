...
public class IDEACBCPar extends ASN1Object {
    ...
    /* renamed from: iv */
    ASN1OctetString f979iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f979iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }

    public IDEACBCPar(byte[] bArr) {
        this.f979iv = new DEROctetString(bArr);
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f979iv;
