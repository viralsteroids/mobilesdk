...
public class CAST5CBCParameters extends ASN1Object {
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f978iv.getOctets());
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f978iv);
