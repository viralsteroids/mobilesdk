...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    /* renamed from: g */
    private X9ECPoint f1042g;

    /* renamed from: h */
    private BigInteger f1043h;

    /* renamed from: n */
    private BigInteger f1044n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        this.f1044n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        if (aSN1Sequence.size() == 6) {
            this.f1043h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
        X9Curve x9Curve = new X9Curve(X9FieldID.getInstance(aSN1Sequence.getObjectAt(1)), this.f1044n, this.f1043h, ASN1Sequence.getInstance(aSN1Sequence.getObjectAt(2)));
        this.curve = x9Curve.getCurve();
        ASN1Encodable objectAt = aSN1Sequence.getObjectAt(3);
        if (objectAt instanceof X9ECPoint) {
            this.f1042g = (X9ECPoint) objectAt;
        } else {
            this.f1042g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        X9FieldID x9FieldID;
        this.curve = eCCurve;
        this.f1042g = x9ECPoint;
        this.f1044n = bigInteger;
        this.f1043h = bigInteger2;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f1042g);
        aSN1EncodableVector.add(new ASN1Integer(this.f1044n));
        if (this.f1043h != null) {
            aSN1EncodableVector.add(new ASN1Integer(this.f1043h));
        }
