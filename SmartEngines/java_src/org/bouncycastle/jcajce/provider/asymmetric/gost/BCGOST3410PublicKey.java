...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f1577y = new BigInteger(1, bArr);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BCGOST3410PublicKey) {
            ...
            if (this.f1577y.equals(bCGOST3410PublicKey.f1577y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return this.f1577y.hashCode() ^ this.gost3410Spec.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString("GOST3410", this.f1577y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
