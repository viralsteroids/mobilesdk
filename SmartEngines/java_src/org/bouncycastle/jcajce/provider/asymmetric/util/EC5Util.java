...
public class EC5Util {
    ...
    static {
        ...
        customCurves.put(new ECCurve.C3891Fp(curve.getField().getCharacteristic(), curve.getA().toBigInteger(), curve.getB().toBigInteger(), curve.getOrder(), curve.getCofactor()), curve);
    }
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        if (field instanceof ECFieldFp) {
            ECCurve.C3891Fp c3891Fp = new ECCurve.C3891Fp(((ECFieldFp) field).getP(), a, b);
            return customCurves.containsKey(c3891Fp) ? (ECCurve) customCurves.get(c3891Fp) : c3891Fp;
        }
    ...
    public static ECPoint convertPoint(org.bouncycastle.math.p023ec.ECPoint eCPoint) {
    ...
    public static org.bouncycastle.math.p023ec.ECPoint convertPoint(ECParameterSpec eCParameterSpec, ECPoint eCPoint) {
        return convertPoint(convertCurve(eCParameterSpec.getCurve()), eCPoint);
    }

    public static org.bouncycastle.math.p023ec.ECPoint convertPoint(ECCurve eCCurve, ECPoint eCPoint) {
    ...
    public static org.bouncycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec) {
        ...
        org.bouncycastle.math.p023ec.ECPoint eCPointConvertPoint = convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator());
