...
public class BCECPrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    /* renamed from: d */
    private transient BigInteger f1570d;
    ...
    public BCECPrivateKey(String str, ECPrivateKeySpec eCPrivateKeySpec, ProviderConfiguration providerConfiguration) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f1570d = eCPrivateKeySpec.getS();
    ...
    public BCECPrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters, BCECPublicKey bCECPublicKey, ECParameterSpec eCParameterSpec, ProviderConfiguration providerConfiguration) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f1570d = eCPrivateKeyParameters.getD();
        this.configuration = providerConfiguration;
    ...
    public BCECPrivateKey(String str, BCECPrivateKey bCECPrivateKey) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f1570d = bCECPrivateKey.f1570d;
    ...
    public BCECPrivateKey(String str, org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec, ProviderConfiguration providerConfiguration) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f1570d = eCPrivateKeySpec.getD();
    ...
    public String toString() {
        return ECUtil.privateKeyToString("EC", this.f1570d, engineGetSpec());
    }
}
