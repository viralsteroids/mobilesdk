...
public class AlgorithmParameterGeneratorSpi extends BaseAlgorithmParameterGeneratorSpi {
    ...
    protected AlgorithmParameters engineGenerateParameters() throws InvalidParameterSpecException, IllegalArgumentException {
        ...
        try {
            ...
            algorithmParametersCreateParametersInstance.init(new DHParameterSpec(elGamalParametersGenerateParameters.getP(), elGamalParametersGenerateParameters.getG(), this.f1573l));
    ...
    protected void engineInit(AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidAlgorithmParameterException {
        ...
        this.f1573l = dHGenParameterSpec.getExponentSize();
        this.random = secureRandom;
    }
}
