...
public class PGPCFBBlockCipher implements BlockCipher {
    ...
    public PGPCFBBlockCipher(BlockCipher blockCipher, boolean z) {
        ...
        this.f1450IV = new byte[blockSize];
        this.f1449FR = new byte[blockSize];
    ...
    private int decryptBlock(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        int i4 = 0;
        this.cipher.processBlock(this.f1449FR, 0, this.FRE, 0);
    ...
    private int decryptBlockWithIV(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        if (i5 != i4) {
            if (i5 >= i4 + 2) {
                ...
                System.arraycopy(this.tmp, 0, this.f1449FR, this.blockSize - 2, 2);
                this.cipher.processBlock(this.f1449FR, 0, this.FRE, 0);
                int i7 = 0;
                while (true) {
                    i3 = this.blockSize;
                ...
                System.arraycopy(this.tmp, 2, this.f1449FR, 0, i3 - 2);
            }
            return this.blockSize;
        }
        System.arraycopy(bArr, i, this.tmp, 0, i4);
        byte[] bArr3 = this.f1449FR;
        System.arraycopy(bArr3, 2, bArr3, 0, this.blockSize - 2);
        byte[] bArr4 = this.f1449FR;
        ...
        while (true) {
            ...
            if (i9 >= i10 - 2) {
                System.arraycopy(this.tmp, 2, this.f1449FR, 0, i10 - 2);
                this.count += 2;
    ...
    private int encryptBlockWithIV(byte[] bArr, int i, byte[] bArr2, int i2) throws IllegalStateException, DataLengthException {
        ...
        if (i6 != 0) {
            if (i6 >= i5 + 2) {
                ...
                System.arraycopy(bArr2, i2, this.f1449FR, 0, i3);
            }
            return this.blockSize;
        }
        ...
        while (true) {
            ...
            bArr2[i2 + i8] = encryptByte(this.f1450IV[i8], i8);
            i8++;
        }
        System.arraycopy(bArr2, i2, this.f1449FR, 0, i4);
        this.cipher.processBlock(this.f1449FR, 0, this.FRE, 0);
        int i9 = this.blockSize;
        bArr2[i2 + i9] = encryptByte(this.f1450IV[i9 - 2], 0);
        int i10 = this.blockSize;
        bArr2[i2 + i10 + 1] = encryptByte(this.f1450IV[i10 - 1], 1);
        System.arraycopy(bArr2, i2 + 2, this.f1449FR, 0, this.blockSize);
        this.cipher.processBlock(this.f1449FR, 0, this.FRE, 0);
        int i11 = 0;
        while (true) {
            int i12 = this.blockSize;
            if (i11 >= i12) {
                System.arraycopy(bArr2, i2 + i12 + 2, this.f1449FR, 0, i12);
                int i13 = this.count;
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            byte[] bArr = this.f1450IV;
            if (length < bArr.length) {
                System.arraycopy(iv, 0, bArr, bArr.length - iv.length, iv.length);
                int i = 0;
                while (true) {
                    byte[] bArr2 = this.f1450IV;
