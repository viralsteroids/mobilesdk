...
public class X931RNG {
    ...
    /* renamed from: DT */
    private final byte[] f1535DT;

    /* renamed from: I */
    private final byte[] f1536I;

    /* renamed from: R */
    private final byte[] f1537R;
    ...
    public X931RNG(BlockCipher blockCipher, byte[] bArr, EntropySource entropySource) {
        ...
        this.f1536I = new byte[blockCipher.getBlockSize()];
        this.f1537R = new byte[blockCipher.getBlockSize()];
    }
    ...
    int generate(byte[] bArr, boolean z) throws IllegalStateException, DataLengthException {
        ...
        int length = bArr.length / this.f1537R.length;
        for (int i = 0; i < length; i++) {
            this.engine.processBlock(this.f1535DT, 0, this.f1536I, 0);
            process(this.f1537R, this.f1536I, this.f1538V);
            process(this.f1538V, this.f1537R, this.f1536I);
            byte[] bArr2 = this.f1537R;
            System.arraycopy(bArr2, 0, bArr, bArr2.length * i, bArr2.length);
            increment(this.f1535DT);
        }
        int length2 = bArr.length - (this.f1537R.length * length);
        if (length2 > 0) {
            this.engine.processBlock(this.f1535DT, 0, this.f1536I, 0);
            process(this.f1537R, this.f1536I, this.f1538V);
            process(this.f1538V, this.f1537R, this.f1536I);
            byte[] bArr3 = this.f1537R;
