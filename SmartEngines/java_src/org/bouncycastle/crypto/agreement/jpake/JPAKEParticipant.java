...
public class JPAKEParticipant {
    ...
    /* renamed from: b */
    private BigInteger f1050b;
    private final Digest digest;

    /* renamed from: g */
    private final BigInteger f1051g;
    ...
    /* renamed from: p */
    private final BigInteger f1052p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* renamed from: q */
    private final BigInteger f1053q;
    private final SecureRandom random;
    private int state;

    /* renamed from: x1 */
    private BigInteger f1054x1;

    /* renamed from: x2 */
    private BigInteger f1055x2;
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f1052p = jPAKEPrimeOrderGroup.getP();
        this.f1053q = jPAKEPrimeOrderGroup.getQ();
        this.f1051g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        this.password = null;
        BigInteger bigIntegerCalculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f1052p, this.f1053q, this.gx4, this.f1055x2, bigIntegerCalculateS, this.f1050b);
        this.f1054x1 = null;
        this.f1055x2 = null;
        this.f1050b = null;
        this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f1054x1 = JPAKEUtil.generateX1(this.f1053q, this.random);
        this.f1055x2 = JPAKEUtil.generateX2(this.f1053q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f1052p, this.f1051g, this.f1054x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f1052p, this.f1051g, this.f1055x2);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f1052p, this.f1053q, this.f1051g, this.gx1, this.f1054x1, this.participantId, this.digest, this.random);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f1052p, this.f1053q, this.f1051g, this.gx2, this.f1055x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f1052p, this.gx1, this.gx3, this.gx4);
        BigInteger bigIntegerCalculateX2s = JPAKEUtil.calculateX2s(this.f1053q, this.f1055x2, JPAKEUtil.calculateS(this.password));
        BigInteger bigIntegerCalculateA = JPAKEUtil.calculateA(this.f1052p, this.f1053q, bigIntegerCalculateGA, bigIntegerCalculateX2s);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f1052p, this.f1053q, bigIntegerCalculateGA, bigIntegerCalculateA, bigIntegerCalculateX2s, this.participantId, this.digest, this.random);
        this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f1052p, this.f1053q, this.f1051g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f1052p, this.f1053q, this.f1051g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f1052p, this.gx3, this.gx1, this.gx2);
        this.f1050b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f1052p, this.f1053q, bigIntegerCalculateGA, this.f1050b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
