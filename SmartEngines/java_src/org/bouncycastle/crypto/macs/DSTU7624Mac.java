...
public class DSTU7624Mac implements Mac {
    ...
    private void processBlock(byte[] bArr, int i) throws IllegalStateException, DataLengthException {
        xor(this.f1380c, 0, bArr, i, this.cTemp);
        this.engine.processBlock(this.cTemp, 0, this.f1380c, 0);
    }
    ...
    public int doFinal(byte[] bArr, int i) throws IllegalStateException, DataLengthException {
        ...
        xor(this.f1380c, 0, bArr2, 0, this.cTemp);
        xor(this.cTemp, 0, this.kDelta, 0, this.f1380c);
        DSTU7624Engine dSTU7624Engine = this.engine;
        byte[] bArr3 = this.f1380c;
        dSTU7624Engine.processBlock(bArr3, 0, bArr3, 0);
        int i3 = this.macSize;
        if (i3 + i > bArr.length) {
            throw new OutputLengthException("output buffer too short");
        }
        System.arraycopy(this.f1380c, 0, bArr, i, i3);
        reset();
        return this.macSize;
    }
    ...
    public void reset() throws IllegalStateException, DataLengthException {
        Arrays.fill(this.f1380c, (byte) 0);
