...
public class PKCS5S2ParametersGenerator extends PBEParametersGenerator {
    ...
    /* renamed from: F */
    private void m656F(byte[] bArr, int i, byte[] bArr2, byte[] bArr3, int i2) throws IllegalStateException, DataLengthException {
        if (i == 0) {
    ...
    private byte[] generateDerivedKey(int i) throws IllegalStateException, DataLengthException, IllegalArgumentException {
        ...
        for (int i5 = 1; i5 <= i3; i5++) {
            ...
            m656F(this.salt, this.iterationCount, bArr, bArr2, i4);
            i4 += macSize;
        }
        return bArr2;
    }
