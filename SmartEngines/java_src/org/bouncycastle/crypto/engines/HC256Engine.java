...
public class HC256Engine implements StreamCipher {
    ...
    /* renamed from: p */
    private int[] f1310p = new int[1024];

    /* renamed from: q */
    private int[] f1311q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        byte[] bArr4 = this.f1309iv;
        if (bArr4.length < 32) {
            byte[] bArr5 = new byte[32];
            System.arraycopy(bArr4, 0, bArr5, 0, bArr4.length);
            byte[] bArr6 = this.f1309iv;
        ...
        for (int i3 = 0; i3 < 32; i3++) {
            int i4 = (i3 >> 2) + 8;
            iArr[i4] = iArr[i4] | ((this.f1309iv[i3] & UByte.MAX_VALUE) << ((i3 & 3) * 8));
        }
        ...
        System.arraycopy(iArr, 512, this.f1310p, 0, 1024);
        System.arraycopy(iArr, 1536, this.f1311q, 0, 1024);
    ...
    public void init(boolean z, CipherParameters cipherParameters) throws IllegalArgumentException {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f1309iv = parametersWithIV.getIV();
            parameters = parametersWithIV.getParameters();
        } else {
            this.f1309iv = new byte[0];
