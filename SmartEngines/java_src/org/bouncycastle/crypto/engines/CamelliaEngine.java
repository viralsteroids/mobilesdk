...
public class CamelliaEngine implements BlockCipher {
    ...
    /* renamed from: kw */
    private int[] f1284kw = new int[8];

    /* renamed from: ke */
    private int[] f1283ke = new int[12];
    ...
    private int processBlock192or256(byte[] bArr, int i, byte[] bArr2, int i2) {
        ...
        camelliaF2(this.state, this.subkey, 28);
        camelliaF2(this.state, this.subkey, 32);
        camelliaFLs(this.state, this.f1283ke, 8);
    ...
    private void setKey(boolean z, byte[] bArr) {
        ...
        if (this._keyIs128) {
            if (z) {
                ...
                iArr6[18] = iArr4[2];
                iArr6[19] = iArr4[3];
                roldq(17, iArr, 0, this.f1283ke, 4);
                ...
                roldq(15, iArr2, 0, this.f1283ke, 0);
                ...
                roldq(17, iArr2, 0, this.f1284kw, 4);
                return;
            }
            int[] iArr9 = this.f1284kw;
            iArr9[4] = iArr[0];
            iArr9[5] = iArr[1];
            iArr9[6] = iArr[2];
            iArr9[7] = iArr[3];
            ...
            iArr10[16] = iArr4[0];
            iArr10[17] = iArr4[1];
            decroldq(17, iArr, 0, this.f1283ke, 0);
            ...
            decroldq(15, iArr2, 0, this.f1283ke, 4);
            ...
            roldq(17, iArr2, 0, this.f1284kw, 0);
            return;
        }
        for (int i3 = 0; i3 < 4; i3++) {
        ...
        if (z) {
            ...
            roldqo32(51, iArr3, 0, this.f1284kw, 4);
            return;
        }
        iArr13[4] = iArr[0];
        iArr13[5] = iArr[1];
        ...
        roldqo32(51, iArr3, 0, this.f1284kw, 0);
    }
