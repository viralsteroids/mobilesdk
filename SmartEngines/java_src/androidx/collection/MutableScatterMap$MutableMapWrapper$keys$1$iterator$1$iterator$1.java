...
@DebugMetadata(m532c = "androidx.collection.MutableScatterMap$MutableMapWrapper$keys$1$iterator$1$iterator$1", m533f = "ScatterMap.kt", m534i = {0, 0, 0, 0, 0, 0, 0}, m535l = {1515}, m536m = "invokeSuspend", m537n = {"$this$iterator", "m$iv", "lastIndex$iv", "i$iv", "slot$iv", "bitCount$iv", "j$iv"}, m538s = {"L$0", "L$1", "I$0", "I$1", "J$0", "I$2", "I$3"})
