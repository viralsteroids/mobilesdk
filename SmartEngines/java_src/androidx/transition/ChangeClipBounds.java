...
public class ChangeClipBounds extends Transition {
    ...
    private void captureValues(TransitionValues transitionValues, boolean z) {
        ...
        Rect clipBounds = z ? (Rect) view.getTag(C2617R.id.transition_clip) : null;
        if (clipBounds == null) {
    ...
    private static class Listener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        public void onTransitionPause(Transition transition) {
            ...
            this.mView.setTag(C2617R.id.transition_clip, clipBounds);
            this.mView.setClipBounds(this.mEnd);
        }

        @Override // androidx.transition.Transition.TransitionListener
        public void onTransitionResume(Transition transition) {
            this.mView.setClipBounds((Rect) this.mView.getTag(C2617R.id.transition_clip));
