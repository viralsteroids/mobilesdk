...
class TranslationAnimationCreator {
    static Animator createAnimation(View view, TransitionValues transitionValues, int i, int i2, float f, float f2, float f3, float f4, TimeInterpolator timeInterpolator, Transition transition) {
        ...
        if (((int[]) transitionValues.view.getTag(C2617R.id.transition_position)) != null) {
    ...
    private static class TransitionPositionListener extends AnimatorListenerAdapter implements Transition.TransitionListener {
        ...
        TransitionPositionListener(View view, View view2, float f, float f2) {
            ...
            this.mTerminalX = f;
            this.mTerminalY = f2;
            int[] iArr = (int[]) view2.getTag(C2617R.id.transition_position);
            this.mTransitionPosition = iArr;
            if (iArr != null) {
                view2.setTag(C2617R.id.transition_position, null);
            }
        }
        ...
        public void onTransitionEnd(Transition transition, boolean z) {
            ...
            this.mViewInHierarchy.setTag(C2617R.id.transition_position, null);
        }
        ...
        private void setInterruptedPosition() {
            ...
            this.mViewInHierarchy.setTag(C2617R.id.transition_position, this.mTransitionPosition);
        }
    }
