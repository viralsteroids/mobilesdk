...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo7351clone = transition.mo7351clone();
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo7351clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo7351clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo7351clone);
    }
    ...
    /* renamed from: go */
    public static void m366go(Scene scene) {
    ...
    public static TransitionSeekController createSeekController(Scene scene, Transition transition) {
        ...
        transitionSet.addTransition(transitionMo7351clone);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
    ...
    /* renamed from: go */
    public static void m367go(Scene scene, Transition transition) {
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo7351clone = transition.mo7351clone();
        sceneChangeSetup(viewGroup, transitionMo7351clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo7351clone);
    }
