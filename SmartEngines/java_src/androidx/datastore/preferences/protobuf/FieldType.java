...
public enum FieldType {
    ...
    static {
        ...
        for (FieldType fieldType : fieldTypeArrValues) {
            VALUES[fieldType.f249id] = fieldType;
        }
    }
    ...
    FieldType(int id, Collection collection, JavaType javaType) {
        ...
        int i2 = C22511.$SwitchMap$com$google$protobuf$FieldType$Collection[collection.ordinal()];
        if (i2 == 1 || i2 == 2) {
            this.elementType = javaType.getBoxedType();
        } else {
            this.elementType = null;
        }
        this.primitiveScalar = (collection != Collection.SCALAR || (i = C22511.$SwitchMap$com$google$protobuf$JavaType[javaType.ordinal()]) == 1 || i == 2 || i == 3) ? false : true;
    }

    /* renamed from: androidx.datastore.preferences.protobuf.FieldType$1 */
    static /* synthetic */ class C22511 {
