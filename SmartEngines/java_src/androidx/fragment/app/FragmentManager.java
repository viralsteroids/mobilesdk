...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    private final Consumer<Configuration> mOnConfigurationChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda0
        ...
        public final void accept(Object obj) {
            this.f$0.m7334lambda$new$0$androidxfragmentappFragmentManager((Configuration) obj);
        }
    };
    private final Consumer<Integer> mOnTrimMemoryListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda1
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f$0.m7335lambda$new$1$androidxfragmentappFragmentManager((Integer) obj);
        }
    };
    private final Consumer<MultiWindowModeChangedInfo> mOnMultiWindowModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda2
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f$0.m7336lambda$new$2$androidxfragmentappFragmentManager((MultiWindowModeChangedInfo) obj);
        }
    };
    private final Consumer<PictureInPictureModeChangedInfo> mOnPictureInPictureModeChangedListener = new Consumer() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda3
        @Override // androidx.core.util.Consumer
        public final void accept(Object obj) {
            this.f$0.m7337lambda$new$3$androidxfragmentappFragmentManager((PictureInPictureModeChangedInfo) obj);
        }
    };
    ...
    /* synthetic */ void m7334lambda$new$0$androidxfragmentappFragmentManager(Configuration configuration) {
        if (isParentAdded()) {
    ...
    /* synthetic */ void m7335lambda$new$1$androidxfragmentappFragmentManager(Integer num) {
    ...
    /* synthetic */ void m7336lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
    ...
    /* synthetic */ void m7337lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
    ...
    static Fragment getViewFragment(View view) {
        Object tag = view.getTag(C2332R.id.fragment_container_view_tag);
    ...
    private void executeOpsTogether(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, int i, int i2) {
        ...
        if (!z && this.mCurState >= 1) {
            for (int i4 = i; i4 < i2; i4++) {
                Iterator<FragmentTransaction.C2379Op> it = arrayList.get(i4).mOps.iterator();
                while (it.hasNext()) {
        ...
        for (int i5 = i; i5 < i2; i5++) {
            ...
            if (zBooleanValue) {
                ...
                Iterator<FragmentTransaction.C2379Op> it2 = backStackRecord2.mOps.iterator();
                while (it2.hasNext()) {
    ...
    private Set<SpecialEffectsController> collectChangedControllers(ArrayList<BackStackRecord> arrayList, int i, int i2) {
        ...
        while (i < i2) {
            Iterator<FragmentTransaction.C2379Op> it = arrayList.get(i).mOps.iterator();
            while (it.hasNext()) {
                Fragment fragment = it.next().mFragment;
    ...
    private void setVisibleRemovingFragment(Fragment fragment) {
        ...
        if (fragmentContainer.getTag(C2332R.id.visible_removing_fragment_view_tag) == null) {
            fragmentContainer.setTag(C2332R.id.visible_removing_fragment_view_tag, fragment);
        }
        ((Fragment) fragmentContainer.getTag(C2332R.id.visible_removing_fragment_view_tag)).setPopDirection(fragment.getPopDirection());
    }
    ...
    boolean restoreBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        while (it.hasNext()) {
            ...
            if (next.mBeingSaved) {
                Iterator<FragmentTransaction.C2379Op> it2 = next.mOps.iterator();
                while (it2.hasNext()) {
                    FragmentTransaction.C2379Op next2 = it2.next();
    ...
    boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int i2 = iFindBackStackIndex; i2 < this.mBackStack.size(); i2++) {
            ...
            Iterator<FragmentTransaction.C2379Op> it = backStackRecord2.mOps.iterator();
            while (it.hasNext()) {
                FragmentTransaction.C2379Op next = it.next();
    ...
    Parcelable saveAllState() {
        ...
        Bundle bundleM7333lambda$attachController$4$androidxfragmentappFragmentManager = m7333lambda$attachController$4$androidxfragmentappFragmentManager();
        if (bundleM7333lambda$attachController$4$androidxfragmentappFragmentManager.isEmpty()) {
            return null;
        }
        return bundleM7333lambda$attachController$4$androidxfragmentappFragmentManager;
    }

    /* JADX INFO: Access modifiers changed from: package-private */
    /* renamed from: saveAllStateInternal, reason: merged with bridge method [inline-methods] */
    public Bundle m7333lambda$attachController$4$androidxfragmentappFragmentManager() {
        ...
        if ((obj instanceof SavedStateRegistryOwner) && fragment == null) {
            ...
            savedStateRegistry.registerSavedStateProvider(SAVED_STATE_TAG, new SavedStateRegistry.SavedStateProvider() { // from class: androidx.fragment.app.FragmentManager$$ExternalSyntheticLambda4
                ...
                public final Bundle saveState() {
                    return this.f$0.m7333lambda$attachController$4$androidxfragmentappFragmentManager();
                }
            });
