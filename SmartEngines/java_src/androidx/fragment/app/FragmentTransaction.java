...
public abstract class FragmentTransaction {
    ...
    static final class C2379Op {
        ...
        C2379Op(int i, Fragment fragment) {
            this.mCmd = i;
        ...
        C2379Op(int i, Fragment fragment, boolean z) {
            this.mCmd = i;
            this.mFragment = fragment;
        ...
        C2379Op(int i, Fragment fragment, Lifecycle.State state) {
            this.mCmd = i;
            this.mFragment = fragment;
            this.mFromExpandedOp = false;
        ...
        C2379Op(C2379Op c2379Op) {
            this.mCmd = c2379Op.mCmd;
            this.mFragment = c2379Op.mFragment;
            this.mFromExpandedOp = c2379Op.mFromExpandedOp;
            this.mEnterAnim = c2379Op.mEnterAnim;
            this.mExitAnim = c2379Op.mExitAnim;
            this.mPopEnterAnim = c2379Op.mPopEnterAnim;
            this.mPopExitAnim = c2379Op.mPopExitAnim;
            this.mOldMaxState = c2379Op.mOldMaxState;
            this.mCurrentMaxState = c2379Op.mCurrentMaxState;
        }
    }
    ...
    FragmentTransaction(FragmentFactory fragmentFactory, ClassLoader classLoader, FragmentTransaction fragmentTransaction) {
        ...
        Iterator<C2379Op> it = fragmentTransaction.mOps.iterator();
        while (it.hasNext()) {
            this.mOps.add(new C2379Op(it.next()));
        }
    ...
    void addOp(C2379Op c2379Op) {
        this.mOps.add(c2379Op);
        c2379Op.mEnterAnim = this.mEnterAnim;
        c2379Op.mExitAnim = this.mExitAnim;
        c2379Op.mPopEnterAnim = this.mPopEnterAnim;
        c2379Op.mPopExitAnim = this.mPopExitAnim;
    }
    ...
    public FragmentTransaction remove(Fragment fragment) {
        addOp(new C2379Op(3, fragment));
        return this;
    }

    public FragmentTransaction hide(Fragment fragment) {
        addOp(new C2379Op(4, fragment));
        return this;
    }

    public FragmentTransaction show(Fragment fragment) {
        addOp(new C2379Op(5, fragment));
        return this;
    }

    public FragmentTransaction detach(Fragment fragment) {
        addOp(new C2379Op(6, fragment));
        return this;
    }

    public FragmentTransaction attach(Fragment fragment) {
        addOp(new C2379Op(7, fragment));
        return this;
    }

    public FragmentTransaction setPrimaryNavigationFragment(Fragment fragment) {
        addOp(new C2379Op(8, fragment));
        return this;
    }

    public FragmentTransaction setMaxLifecycle(Fragment fragment, Lifecycle.State state) {
        addOp(new C2379Op(10, fragment, state));
        return this;
    }
