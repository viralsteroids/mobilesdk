...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver resolver, Density density) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m6798resolveTextDirectionHeuristicsHklW4sA(textStyle.m6583getTextDirections_7Xco(), textStyle.getLocaleList());
        Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface> function4 = new Function4<FontFamily, FontWeight, FontStyle, FontSynthesis, Typeface>() { // from class: androidx.compose.ui.text.platform.AndroidParagraphIntrinsics$resolveTypeface$1
            ...
            public /* bridge */ /* synthetic */ Typeface invoke(FontFamily fontFamily, FontWeight fontWeight, FontStyle fontStyle, FontSynthesis fontSynthesis) {
                return m6797invokeDPcqOEQ(fontFamily, fontWeight, fontStyle.m6653unboximpl(), fontSynthesis.getValue());
            }

            /* renamed from: invoke-DPcqOEQ, reason: not valid java name */
            public final Typeface m6797invokeDPcqOEQ(FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
                State<Object> stateMo6625resolveDPcqOEQ = this.this$0.getFontFamilyResolver().mo6625resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
                if (!(stateMo6625resolveDPcqOEQ instanceof TypefaceResult.Immutable)) {
                    TypefaceDirtyTrackerLinkedList typefaceDirtyTrackerLinkedList = new TypefaceDirtyTrackerLinkedList(stateMo6625resolveDPcqOEQ, this.this$0.resolvedTypefaces);
                    this.this$0.resolvedTypefaces = typefaceDirtyTrackerLinkedList;
                    return typefaceDirtyTrackerLinkedList.getTypeface();
                }
                Object value = stateMo6625resolveDPcqOEQ.getValue();
