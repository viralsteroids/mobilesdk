...
public class TextInputService {
    ...
    public void stopInput(TextInputSession session) {
        if (PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m280m(this._currentInputSession, session, null)) {
