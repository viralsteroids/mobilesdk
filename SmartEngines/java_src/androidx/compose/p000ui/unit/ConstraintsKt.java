...
public final class ConstraintsKt {
    ...
    public static final long createConstraints(int i, int i2, int i3, int i4) {
        ...
        return Constraints.m6997constructorimpl((i8 << 33) | i11 | (i << 2) | (i3 << (i12 + 15)) | (i10 << (i12 + 46)));
    }
    ...
    public static final long m7023constrainN9IONVI(long j, long j2) {
        return Constraints(RangesKt.coerceIn(Constraints.m7010getMinWidthimpl(j2), Constraints.m7010getMinWidthimpl(j), Constraints.m7008getMaxWidthimpl(j)), RangesKt.coerceIn(Constraints.m7008getMaxWidthimpl(j2), Constraints.m7010getMinWidthimpl(j), Constraints.m7008getMaxWidthimpl(j)), RangesKt.coerceIn(Constraints.m7009getMinHeightimpl(j2), Constraints.m7009getMinHeightimpl(j), Constraints.m7007getMaxHeightimpl(j)), RangesKt.coerceIn(Constraints.m7007getMaxHeightimpl(j2), Constraints.m7009getMinHeightimpl(j), Constraints.m7007getMaxHeightimpl(j)));
    }

    /* renamed from: constrain-4WqzIAM, reason: not valid java name */
    public static final long m7022constrain4WqzIAM(long j, long j2) {
        return IntSizeKt.IntSize(RangesKt.coerceIn(IntSize.m7225getWidthimpl(j2), Constraints.m7010getMinWidthimpl(j), Constraints.m7008getMaxWidthimpl(j)), RangesKt.coerceIn(IntSize.m7224getHeightimpl(j2), Constraints.m7009getMinHeightimpl(j), Constraints.m7007getMaxHeightimpl(j)));
    }

    /* renamed from: constrainWidth-K40F9xA, reason: not valid java name */
    public static final int m7025constrainWidthK40F9xA(long j, int i) {
        return RangesKt.coerceIn(i, Constraints.m7010getMinWidthimpl(j), Constraints.m7008getMaxWidthimpl(j));
    }

    /* renamed from: constrainHeight-K40F9xA, reason: not valid java name */
    public static final int m7024constrainHeightK40F9xA(long j, int i) {
        return RangesKt.coerceIn(i, Constraints.m7009getMinHeightimpl(j), Constraints.m7007getMaxHeightimpl(j));
    }

    /* renamed from: isSatisfiedBy-4WqzIAM, reason: not valid java name */
    public static final boolean m7026isSatisfiedBy4WqzIAM(long j, long j2) {
        int iM7010getMinWidthimpl = Constraints.m7010getMinWidthimpl(j);
        int iM7008getMaxWidthimpl = Constraints.m7008getMaxWidthimpl(j);
        int iM7225getWidthimpl = IntSize.m7225getWidthimpl(j2);
        if (iM7010getMinWidthimpl > iM7225getWidthimpl || iM7225getWidthimpl > iM7008getMaxWidthimpl) {
            return false;
        }
        ...
        int iM7224getHeightimpl = IntSize.m7224getHeightimpl(j2);
        return iM7009getMinHeightimpl <= iM7224getHeightimpl && iM7224getHeightimpl <= iM7007getMaxHeightimpl;
    }

    /* renamed from: offset-NN6Ew-U$default, reason: not valid java name */
    public static /* synthetic */ long m7028offsetNN6EwU$default(long j, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
        ...
        return m7027offsetNN6EwU(j, i, i2);
    }

    /* renamed from: offset-NN6Ew-U, reason: not valid java name */
    public static final long m7027offsetNN6EwU(long j, int i, int i2) {
        return Constraints(RangesKt.coerceAtLeast(Constraints.m7010getMinWidthimpl(j) + i, 0), addMaxWithMinimum(Constraints.m7008getMaxWidthimpl(j), i), RangesKt.coerceAtLeast(Constraints.m7009getMinHeightimpl(j) + i2, 0), addMaxWithMinimum(Constraints.m7007getMaxHeightimpl(j), i2));
    }
