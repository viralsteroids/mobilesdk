...
public final class VelocityTrackerKt {
    ...
    private static final void addPointerInputChangeLegacy(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
            velocityTracker.m5904setCurrentPointerPositionAccumulatork4lQ0M$ui_release(pointerInputChange.getPosition());
        ...
        while (i < size) {
            ...
            long jM4358minusMKHz9U = Offset.m4358minusMKHz9U(historicalChange.getPosition(), previousPosition);
            long position = historicalChange.getPosition();
            velocityTracker.m5904setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m4359plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), jM4358minusMKHz9U));
            velocityTracker.m5900addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
            i++;
            previousPosition = position;
        }
        velocityTracker.m5904setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m4359plusMKHz9U(velocityTracker.getCurrentPointerPositionAccumulator(), Offset.m4358minusMKHz9U(pointerInputChange.getPosition(), previousPosition)));
        velocityTracker.m5900addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), velocityTracker.getCurrentPointerPositionAccumulator());
    }
    ...
    private static final void addPointerInputChangeWithFix(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        ...
        if (!PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
            ...
            for (int i = 0; i < size; i++) {
                HistoricalChange historicalChange = historical.get(i);
                velocityTracker.m5900addPositionUv8p0NA(historicalChange.getUptimeMillis(), historicalChange.getOriginalEventPosition());
            }
            velocityTracker.m5900addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), pointerInputChange.getOriginalEventPosition());
        }
