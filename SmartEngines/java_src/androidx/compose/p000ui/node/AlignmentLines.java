...
public abstract class AlignmentLines {
    ...
    protected abstract long mo6038calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo6038calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            fM4354getXimpl = Offset.m4355getYimpl(jOffset);
        } else {
            fM4354getXimpl = Offset.m4354getXimpl(jOffset);
        }
        int iRound = Math.round(fM4354getXimpl);
