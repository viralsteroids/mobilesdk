...
final class LayerPositionalProperties {
    ...
    public final void copyFrom(GraphicsLayerScope scope) {
        ...
        this.transformOrigin = scope.mo4784getTransformOriginSzJe1aQ();
    }

    public final boolean hasSameValuesAs(LayerPositionalProperties other) {
        return this.scaleX == other.scaleX && this.scaleY == other.scaleY && this.translationX == other.translationX && this.translationY == other.translationY && this.rotationX == other.rotationX && this.rotationY == other.rotationY && this.rotationZ == other.rotationZ && this.cameraDistance == other.cameraDistance && TransformOrigin.m4980equalsimpl0(this.transformOrigin, other.transformOrigin);
    }
}
