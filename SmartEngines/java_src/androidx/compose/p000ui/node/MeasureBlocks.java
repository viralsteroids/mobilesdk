...
public interface MeasureBlocks {
    ...
    MeasureResult m6122measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> measurables, long constraints);
