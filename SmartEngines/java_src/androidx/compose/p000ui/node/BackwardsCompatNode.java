...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m6166constructorimpl(32) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet() & NodeKind.m6166constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        if ((NodeKind.m6166constructorimpl(4) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m6166constructorimpl(2) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m6166constructorimpl(128) & backwardsCompatNode.getKindSet()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode.initializeModifier.3
                        ...
                        public void onLayoutComplete() {
                            if (BackwardsCompatNode.this.lastOnPlacedCoordinates == null) {
                                ...
                                backwardsCompatNode2.onPlaced(DelegatableNodeKt.m6053requireCoordinator64DMado(backwardsCompatNode2, NodeKind.m6166constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if ((NodeKind.m6166constructorimpl(256) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.isChainUpdate(this)) {
            DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui_release();
        }
        if (element instanceof FocusRequesterModifier) {
            ((FocusRequesterModifier) element).getFocusRequester().getFocusRequesterNodes$ui_release().add(this);
        }
        if ((NodeKind.m6166constructorimpl(16) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator());
        }
        if ((NodeKind.m6166constructorimpl(8) & backwardsCompatNode.getKindSet()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public MeasureResult mo845measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return ((LayoutModifier) element).mo818measure3p2s80s(measureScope, measurable, j);
    }
    ...
    public void mo963onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo5826onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo1117onRemeasuredozmzZPI(long size) {
        ...
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).m5985onRemeasuredozmzZPI(size);
        }
    }
