...
public final /* data */ class DeviceRenderNodeData {
    ...
    public static /* synthetic */ DeviceRenderNodeData m6283copyfuCbV5c$default(DeviceRenderNodeData deviceRenderNodeData, long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect, int i9, int i10, Object obj) {
        int i11;
        ...
        return deviceRenderNodeData.m6285copyfuCbV5c(j3, i12, i13, i14, i15, i16, i17, f13, f14, f15, f16, f17, i18, i19, f18, f19, f20, f21, f22, f23, z3, z4, f24, renderEffect2, i11);
    }
    ...
    public int hashCode() {
        ...
        return ((iHashCode + (renderEffect == null ? 0 : renderEffect.hashCode())) * 31) + CompositingStrategy.m4681hashCodeimpl(this.compositingStrategy);
    }
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", compositingStrategy=").append((Object) CompositingStrategy.m4682toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final int m6286getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE, reason: not valid java name */
    public final void m6287setCompositingStrategyaDBOjCE(int i) {
