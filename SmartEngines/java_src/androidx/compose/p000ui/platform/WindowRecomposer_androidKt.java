...
public final class WindowRecomposer_androidKt {
    ...
    public static final CompositionContext getCompositionContext(View view) {
        Object tag = view.getTag(C1750R.id.androidx_compose_ui_view_composition_context);
    ...
    public static final void setCompositionContext(View view, CompositionContext compositionContext) {
        view.setTag(C1750R.id.androidx_compose_ui_view_composition_context, compositionContext);
    }
        ...
        if (lifecycle != null) {
            ...
            lifecycle.addObserver(new LifecycleEventObserver() { // from class: androidx.compose.ui.platform.WindowRecomposer_androidKt.createLifecycleAwareWindowRecomposer.2
                ...
                public void onStateChanged(LifecycleOwner source, Lifecycle.Event event) {
                    ...
                    if (i == 1) {
                        BuildersKt__Builders_commonKt.launch$default(CoroutineScope, null, CoroutineStart.UNDISPATCHED, new C1914x149b840a(objectRef, recomposer, source, this, view, null), 1, null);
                        return;
                    }
                    if (i == 2) {
