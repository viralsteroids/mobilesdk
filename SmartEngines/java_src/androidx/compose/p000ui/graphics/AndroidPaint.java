...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m4537getSrcOver0nO6VwU();
    }
    ...
    public long mo4468getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.p000ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo4474setColor8_81llA(long j) {
        AndroidPaint_androidKt.m4480setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo4473setBlendModes9anfk8(int i) {
        if (BlendMode.m4506equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m4479setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.p000ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo4472getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.p000ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo4478setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m4484setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo4470getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.p000ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo4476setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m4482setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.p000ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo4471getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.p000ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo4477setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m4483setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo4469getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.p000ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo4475setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m4481setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
