...
public final class AndroidPaint_androidKt {
    ...
    public static final void m4479setNativeBlendModeGB0RdKg(Paint paint, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m4998setBlendModeGB0RdKg(paint, i);
        } else {
            paint.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m4447toPorterDuffModes9anfk8(i)));
        }
    }
    ...
    public static final void m4480setNativeColor4WTKRHQ(Paint paint, long j) {
        paint.setColor(ColorKt.m4649toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m4484setNativeStyle5YerkU(Paint paint, int i) {
        paint.setStyle(PaintingStyle.m4858equalsimpl0(i, PaintingStyle.INSTANCE.m4863getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }

    public static final int getNativeStyle(Paint paint) {
        Paint.Style style = paint.getStyle();
        if ((style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1) {
            return PaintingStyle.INSTANCE.m4863getStrokeTiuSbCo();
        }
        return PaintingStyle.INSTANCE.m4862getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(Paint paint) {
        ...
        if (i == 3) {
            return StrokeCap.INSTANCE.m4950getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m4948getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m4482setNativeStrokeCapCSYIeUk(Paint paint, int i) {
        Paint.Cap cap;
        if (StrokeCap.m4944equalsimpl0(i, StrokeCap.INSTANCE.m4950getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m4944equalsimpl0(i, StrokeCap.INSTANCE.m4949getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m4944equalsimpl0(i, StrokeCap.INSTANCE.m4948getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(Paint paint) {
        ...
        if (i == 2) {
            return StrokeJoin.INSTANCE.m4958getBevelLxFBmk8();
        }
        if (i == 3) {
    ...
    public static final void m4483setNativeStrokeJoinkLtJ_vA(Paint paint, int i) {
        Paint.Join join;
        if (StrokeJoin.m4954equalsimpl0(i, StrokeJoin.INSTANCE.m4959getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m4954equalsimpl0(i, StrokeJoin.INSTANCE.m4958getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m4954equalsimpl0(i, StrokeJoin.INSTANCE.m4960getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(Paint paint) {
        if (!paint.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m4697getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m4695getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m4481setNativeFilterQuality50PEsBU(Paint paint, int i) {
        paint.setFilterBitmap(!FilterQuality.m4690equalsimpl0(i, FilterQuality.INSTANCE.m4697getNonefv9h1I()));
    }
