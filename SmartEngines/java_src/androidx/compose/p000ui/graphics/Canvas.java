...
public interface Canvas {
    ...
    void mo4451drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo4452drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo4453drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo4454drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo4455drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo4456drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo4457drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m4573clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Canvas.super.m4570clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m4568clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m4570clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m4570clipRectmtrdDE(Rect rect, int clipOp) {
        mo4449clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m4567clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo4449clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m4566clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo4448clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m4569drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM7193getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m7193getZeronOccac() : j;
        long jIntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo4453drawImageRectHPBpro0(imageBitmap, jM7193getZeronOccac, jIntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m7193getZeronOccac() : j3, (i & 16) != 0 ? jIntSize : j4, paint);
    }
}
