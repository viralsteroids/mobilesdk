...
public final class Float16Kt {
    ...
    private static final short One = Float16.m4703constructorimpl(1.0f);
    private static final short NegativeOne = Float16.m4703constructorimpl(-1.0f);
    ...
    public static final short m4742minAoSsdG0(short s, short s2) {
        if (Float16.m4714isNaNimpl(s) || Float16.m4714isNaNimpl(s2)) {
            return Float16.Companion.m4736getNaNslo4al4();
        }
        return Float16.m4701compareTo41bOqos(s, s2) <= 0 ? s : s2;
    }

    /* renamed from: max-AoSsdG0, reason: not valid java name */
    public static final short m4741maxAoSsdG0(short s, short s2) {
        if (Float16.m4714isNaNimpl(s) || Float16.m4714isNaNimpl(s2)) {
            return Float16.Companion.m4736getNaNslo4al4();
        }
        return Float16.m4701compareTo41bOqos(s, s2) >= 0 ? s : s2;
