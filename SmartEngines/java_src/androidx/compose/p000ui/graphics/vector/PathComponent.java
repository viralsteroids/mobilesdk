...
public final class PathComponent extends VNode {
    ...
    public final void m5293setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo4488setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m5294setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m5295setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo4486getFillTypeRgk1Os = this.renderPath.mo4486getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo4488setFillTypeoQ8Xj4U(iMo4486getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m5140drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m5140drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
