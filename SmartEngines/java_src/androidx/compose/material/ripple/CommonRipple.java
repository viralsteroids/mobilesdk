...
public final class CommonRipple extends Ripple {
    ...
    public RippleIndicationInstance mo2169rememberUpdatedRippleInstance942rkJo(InteractionSource interactionSource, boolean z, float f, State<Color> state, State<RippleAlpha> state2, Composer composer, int i) {
        ...
        boolean z2 = ((((i & 14) ^ 6) > 4 && composer.changed(interactionSource)) || (i & 6) == 4) | ((((458752 & i) ^ ProfileVerifier.CompilationStatus.f285xf2722a21) > 131072 && composer.changed(this)) || (i & ProfileVerifier.CompilationStatus.f285xf2722a21) == 131072);
