...
public final class AndroidRippleIndicationInstance extends RippleIndicationInstance implements RememberObserver, RippleHostKey {
    ...
    public void drawIndication(ContentDrawScope contentDrawScope) {
        int iRoundToInt;
        this.rippleSize = contentDrawScope.mo5151getSizeNHjbRc();
        if (Float.isNaN(this.radius)) {
            iRoundToInt = MathKt.roundToInt(RippleAnimationKt.m2173getRippleEndRadiuscSwnlzA(contentDrawScope, this.bounded, contentDrawScope.mo5151getSizeNHjbRc()));
        } else {
            iRoundToInt = contentDrawScope.mo1121roundToPx0680j_4(this.radius);
        }
        ...
        if (rippleHostView != null) {
            rippleHostView.m2177setRippleProperties07v42R4(contentDrawScope.mo5151getSizeNHjbRc(), jM4605unboximpl, pressedAlpha);
    ...
    public void addRipple(PressInteraction.Press interaction, CoroutineScope scope) {
        ...
        rippleHostView.m2176addRippleKOepWvA(interaction, this.bounded, this.rippleSize, this.rippleRadius, this.color.getValue().m4605unboximpl(), this.rippleAlpha.getValue().getPressedAlpha(), this.onInvalidateRipple);
