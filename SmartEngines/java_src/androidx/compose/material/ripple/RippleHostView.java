...
public final class RippleHostView extends View {
    ...
    public final void m2176addRippleKOepWvA(PressInteraction.Press interaction, boolean bounded, long size, int radius, long color, float alpha, Function0<Unit> onInvalidateRipple) {
        ...
        m2177setRippleProperties07v42R4(size, color, alpha);
        if (bounded) {
            unprojectedRipple.setHotspot(Offset.m4354getXimpl(interaction.getPressPosition()), Offset.m4355getYimpl(interaction.getPressPosition()));
        } else {
    ...
    public final void m2177setRippleProperties07v42R4(long size, long color, float alpha) {
        UnprojectedRipple unprojectedRipple = this.ripple;
        if (unprojectedRipple == null) {
            return;
        }
        unprojectedRipple.m2188setColorDxMtmZc(color, alpha);
        Rect rect = new Rect(0, 0, MathKt.roundToInt(Size.m4423getWidthimpl(size)), MathKt.roundToInt(Size.m4420getHeightimpl(size)));
        setLeft(rect.left);
        setTop(rect.top);
        setRight(rect.right);
