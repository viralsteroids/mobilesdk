...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m2188setColorDxMtmZc(long color, float alpha) {
        long jM2187calculateRippleColor5vOe2sY = m2187calculateRippleColor5vOe2sY(color, alpha);
        Color color2 = this.rippleColor;
        if (color2 == null ? false : Color.m4596equalsimpl0(color2.m4605unboximpl(), jM2187calculateRippleColor5vOe2sY)) {
            return;
        }
        this.rippleColor = Color.m4585boximpl(jM2187calculateRippleColor5vOe2sY);
        setColor(ColorStateList.valueOf(ColorKt.m4649toArgb8_81llA(jM2187calculateRippleColor5vOe2sY)));
    }
    ...
    private final long m2187calculateRippleColor5vOe2sY(long color, float alpha) {
        if (Build.VERSION.SDK_INT < 28) {
            alpha *= 2;
        }
        return Color.m4594copywmQWz5c$default(color, RangesKt.coerceAtMost(alpha, 1.0f), 0.0f, 0.0f, 0.0f, 14, null);
    }

    /* compiled from: RippleHostView.android.kt */
    @Metadata(m513d1 = {"\u0000\u001e\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\b\n\u0000\bÃ\u0002\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002J\u0018\u0010\u0003\u001a\u00020\u00042\u0006\u0010\u0005\u001a\u00020\u00062\u0006\u0010\u0007\u001a\u00020\bH\u0007¨\u0006\t"}, m514d2 = {"Landroidx/compose/material/ripple/UnprojectedRipple$MRadiusHelper;", "", "()V", "setRadius", "", "ripple", "Landroid/graphics/drawable/RippleDrawable;", "radius", "", "material-ripple_release"}, m515k = 1, m516mv = {1, 8, 0}, m518xi = 48)
