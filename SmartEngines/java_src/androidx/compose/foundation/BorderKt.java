...
public final class BorderKt {
    ...
    public static final Modifier border(Modifier modifier, BorderStroke borderStroke, Shape shape) {
        return m1003borderziNgDLE(modifier, borderStroke.getWidth(), borderStroke.getBrush(), shape);
    }

    /* renamed from: border-xT4_qwU$default, reason: not valid java name */
    public static /* synthetic */ Modifier m1002borderxT4_qwU$default(Modifier modifier, float f, long j, Shape shape, int i, Object obj) {
        if ((i & 4) != 0) {
            shape = RectangleShapeKt.getRectangleShape();
        }
        return m1001borderxT4_qwU(modifier, f, j, shape);
    }

    /* renamed from: border-xT4_qwU, reason: not valid java name */
    public static final Modifier m1001borderxT4_qwU(Modifier modifier, float f, long j, Shape shape) {
        return m1003borderziNgDLE(modifier, f, new SolidColor(j, null), shape);
    }

    /* renamed from: border-ziNgDLE, reason: not valid java name */
    public static final Modifier m1003borderziNgDLE(Modifier modifier, float f, Brush brush, Shape shape) {
    ...
    public static final DrawResult m1004drawRectBorderNsqcLGU(CacheDrawScope cacheDrawScope, final Brush brush, long j, long j2, boolean z, float f) {
        final long jM4370getZeroF1C5BW0 = z ? Offset.INSTANCE.m4370getZeroF1C5BW0() : j;
        final long jM4244getSizeNHjbRc = z ? cacheDrawScope.m4244getSizeNHjbRc() : j2;
        ...
        return cacheDrawScope.onDrawWithContent(new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.foundation.BorderKt$drawRectBorder$1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                contentDrawScope.drawContent();
                DrawScope.m5144drawRectAsUm42w$default(contentDrawScope, brush, jM4370getZeroF1C5BW0, jM4244getSizeNHjbRc, 0.0f, stroke, null, 0, 104, null);
            }
        });
    }
    ...
    public static final Path createRoundRectPath(Path path, RoundRect roundRect, float f, boolean z) {
        ...
        if (!z) {
            ...
            path.mo4487opN5in7k0(path, Path, PathOperation.INSTANCE.m4887getDifferenceb3I0S0c());
        }
        return path;
    }

    private static final RoundRect createInsetRoundedRect(float f, RoundRect roundRect) {
        return new RoundRect(f, f, roundRect.getWidth() - f, roundRect.getHeight() - f, m1005shrinkKibmq7A(roundRect.m4404getTopLeftCornerRadiuskKHJgLs(), f), m1005shrinkKibmq7A(roundRect.m4405getTopRightCornerRadiuskKHJgLs(), f), m1005shrinkKibmq7A(roundRect.m4403getBottomRightCornerRadiuskKHJgLs(), f), m1005shrinkKibmq7A(roundRect.m4402getBottomLeftCornerRadiuskKHJgLs(), f), null);
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: shrink-Kibmq7A, reason: not valid java name */
    public static final long m1005shrinkKibmq7A(long j, float f) {
        return CornerRadiusKt.CornerRadius(Math.max(0.0f, CornerRadius.m4329getXimpl(j) - f), Math.max(0.0f, CornerRadius.m4330getYimpl(j) - f));
    }
}
