...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo818measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        long j2;
        if (measurable.maxIntrinsicWidth(Constraints.m7007getMaxHeightimpl(j)) < Constraints.m7008getMaxWidthimpl(j)) {
            j2 = j;
        } else {
            j2 = j;
            j = Constraints.m6999copyZbe2FdA$default(j2, 0, Integer.MAX_VALUE, 0, 0, 13, null);
        }
        final Placeable placeableMo5931measureBRTryo0 = measurable.mo5931measureBRTryo0(j);
        final int iMin = Math.min(placeableMo5931measureBRTryo0.getWidth(), Constraints.m7008getMaxWidthimpl(j2));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo5931measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measureScope.getLayoutDirection() == LayoutDirection.Rtl, placeableMo5931measureBRTryo0.getWidth()), iMin, placeableMo5931measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo5931measureBRTryo0, Math.round(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
