...
@DebugMetadata(m532c = "androidx.compose.foundation.text.ClickableTextKt$ClickableText$pointerInputModifier$1$1", m533f = "ClickableText.kt", m534i = {}, m535l = {CipherSuite.TLS_RSA_PSK_WITH_NULL_SHA256}, m536m = "invokeSuspend", m537n = {}, m538s = {})
...
final class ClickableTextKt$ClickableText$pointerInputModifier$1$1 extends SuspendLambda implements Function2<PointerInputScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m532c = "androidx.compose.foundation.text.ClickableTextKt$ClickableText$pointerInputModifier$1$1$1", m533f = "ClickableText.kt", m534i = {}, m535l = {CipherSuite.TLS_PSK_WITH_AES_256_CBC_SHA384}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    ...
    static final class C09451 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C09451(PointerInputScope pointerInputScope, Function1<? super Integer, Unit> function1, MutableState<TextLayoutResult> mutableState, Continuation<? super C09451> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C09451(this.$$this$pointerInput, this.$onHover, this.$layoutResult, continuation);
        }
            ...
            if (i == 0) {
                ...
                if (PointerMoveDetectorKt.detectMoves(pointerInputScope, pointerEventPass, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt.ClickableText.pointerInputModifier.1.1.1.1
                    ...
                    public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                        m1738invokek4lQ0M(offset.getPackedValue());
                    ...
                    public final void m1738invokek4lQ0M(long j) {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            BuildersKt__Builders_commonKt.launch$default(this.$coroutineScope, null, null, new C09451(pointerInputScope, this.$onHover, this.$layoutResult, null), 3, null);
            ...
            if (TapGestureDetectorKt.detectTapGestures$default(pointerInputScope, null, null, null, new Function1<Offset, Unit>() { // from class: androidx.compose.foundation.text.ClickableTextKt$ClickableText$pointerInputModifier$1$1.2
                ...
                @Override // kotlin.jvm.functions.Function1
                public /* bridge */ /* synthetic */ Unit invoke(Offset offset) {
                    m1739invokek4lQ0M(offset.getPackedValue());
                    return Unit.INSTANCE;
                }

                /* renamed from: invoke-k-4lQ0M, reason: not valid java name */
                public final void m1739invokek4lQ0M(long j) {
