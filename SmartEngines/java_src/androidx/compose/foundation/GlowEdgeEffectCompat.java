...
final class GlowEdgeEffectCompat extends EdgeEffect {
    ...
    public GlowEdgeEffectCompat(Context context) {
        super(context);
        this.oppositeReleaseDeltaThreshold = AndroidDensity_androidKt.Density(context).mo1127toPx0680j_4(C1959Dp.m7055constructorimpl(1));
    }
