...
final /* data */ class DpCornerSize implements CornerSize, InspectableValue {
    ...
    public static /* synthetic */ DpCornerSize m1715copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m1716copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4, reason: not valid java name */
    public final DpCornerSize m1716copy0680j_4(float size) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof DpCornerSize) && C1959Dp.m7060equalsimpl0(this.size, ((DpCornerSize) other).size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return C1959Dp.m7053boximpl(m1717getValueOverrideD9Ej5fM());
    }

    @Override // androidx.compose.foundation.shape.CornerSize
    /* renamed from: toPx-TmRCtEA */
    public float mo1709toPxTmRCtEA(long shapeSize, Density density) {
        return density.mo1127toPx0680j_4(this.size);
    }
    ...
    public float m1717getValueOverrideD9Ej5fM() {
        return this.size;
    }
}
