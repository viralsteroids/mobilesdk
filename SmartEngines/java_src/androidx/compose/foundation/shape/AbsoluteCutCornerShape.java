...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline mo1701createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m4423getWidthimpl(size) - topEnd, 0.0f);
        Path.lineTo(Size.m4423getWidthimpl(size), topEnd);
        Path.lineTo(Size.m4423getWidthimpl(size), Size.m4420getHeightimpl(size) - bottomEnd);
        Path.lineTo(Size.m4423getWidthimpl(size) - bottomEnd, Size.m4420getHeightimpl(size));
        Path.lineTo(bottomStart, Size.m4420getHeightimpl(size));
        Path.lineTo(0.0f, Size.m4420getHeightimpl(size) - bottomStart);
        Path.close();
