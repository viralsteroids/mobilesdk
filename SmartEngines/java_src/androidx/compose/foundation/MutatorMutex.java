...
public final class MutatorMutex {
    ...
    /* compiled from: MutatorMutex.kt */
    @Metadata(m513d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u000e\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u0000J\u0006\u0010\u000e\u001a\u00020\u000fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0010"}, m514d2 = {"Landroidx/compose/foundation/MutatorMutex$Mutator;", "", "priority", "Landroidx/compose/foundation/MutatePriority;", "job", "Lkotlinx/coroutines/Job;", "(Landroidx/compose/foundation/MutatePriority;Lkotlinx/coroutines/Job;)V", "getJob", "()Lkotlinx/coroutines/Job;", "getPriority", "()Landroidx/compose/foundation/MutatePriority;", "canInterrupt", "", "other", "cancel", "", "foundation_release"}, m515k = 1, m516mv = {1, 8, 0}, m518xi = 48)
    ...
    @DebugMetadata(m532c = "androidx.compose.foundation.MutatorMutex$mutate$2", m533f = "MutatorMutex.kt", m534i = {0, 0, 1, 1}, m535l = {214, 126}, m536m = "invokeSuspend", m537n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m538s = {"L$0", "L$1", "L$0", "L$1"})
    /* renamed from: androidx.compose.foundation.MutatorMutex$mutate$2 */
    static final class C05442<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        C05442(MutatePriority mutatePriority, MutatorMutex mutatorMutex, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super C05442> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05442 c05442 = new C05442(this.$priority, this.this$0, this.$block, continuation);
            c05442.L$0 = obj;
            return c05442;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super R> continuation) {
            return ((C05442) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final <R> Object mutate(MutatePriority mutatePriority, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C05442(mutatePriority, this, function1, null), continuation);
    }
    ...
    @DebugMetadata(m532c = "androidx.compose.foundation.MutatorMutex$mutateWith$2", m533f = "MutatorMutex.kt", m534i = {0, 0, 1, 1}, m535l = {214, CipherSuite.TLS_DH_anon_WITH_AES_256_GCM_SHA384}, m536m = "invokeSuspend", m537n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m538s = {"L$0", "L$1", "L$0", "L$1"})
    /* renamed from: androidx.compose.foundation.MutatorMutex$mutateWith$2 */
    static final class C05452<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C05452(MutatePriority mutatePriority, MutatorMutex mutatorMutex, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, T t, Continuation<? super C05452> continuation) {
            super(2, continuation);
            this.$priority = mutatePriority;
            this.this$0 = mutatorMutex;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C05452 c05452 = new C05452(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
            c05452.L$0 = obj;
            return c05452;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super R> continuation) {
            return ((C05452) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final <T, R> Object mutateWith(T t, MutatePriority mutatePriority, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C05452(mutatePriority, this, function2, t, null), continuation);
    }
