...
@DebugMetadata(m532c = "androidx.compose.foundation.gestures.ScrollableNode$onKeyEvent$1", m533f = "Scrollable.kt", m534i = {}, m535l = {477}, m536m = "invokeSuspend", m537n = {}, m538s = {})
...
final class ScrollableNode$onKeyEvent$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    @DebugMetadata(m532c = "androidx.compose.foundation.gestures.ScrollableNode$onKeyEvent$1$1", m533f = "Scrollable.kt", m534i = {}, m535l = {}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: androidx.compose.foundation.gestures.ScrollableNode$onKeyEvent$1$1 */
    static final class C06361 extends SuspendLambda implements Function2<NestedScrollScope, Continuation<? super Unit>, Object> {
        final /* synthetic */ long $scrollAmount;
        private /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C06361(long j, Continuation<? super C06361> continuation) {
            super(2, continuation);
            this.$scrollAmount = j;
        }
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C06361 c06361 = new C06361(this.$scrollAmount, continuation);
            c06361.L$0 = obj;
            return c06361;
        }
        ...
        public final Object invoke(NestedScrollScope nestedScrollScope, Continuation<? super Unit> continuation) {
            return ((C06361) create(nestedScrollScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            this.label = 1;
            if (this.this$0.scrollingLogic.scroll(MutatePriority.UserInput, new C06361(this.$scrollAmount, null), this) == coroutine_suspended) {
