...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public void update(UnspecifiedConstraintsNode node) {
        node.m1502setMinWidth0680j_4(this.minWidth);
        node.m1501setMinHeight0680j_4(this.minHeight);
    }

    @Override // androidx.compose.p000ui.node.ModifierNodeElement
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", C1959Dp.m7053boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", C1959Dp.m7053boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object other) {
        ...
        return C1959Dp.m7060equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) && C1959Dp.m7060equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight);
    }

    @Override // androidx.compose.p000ui.node.ModifierNodeElement
    public int hashCode() {
        return (C1959Dp.m7061hashCodeimpl(this.minWidth) * 31) + C1959Dp.m7061hashCodeimpl(this.minHeight);
    }
}
