...
final class AlignmentLineOffsetDpNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final void m1298setBefore0680j_4(float f) {
        this.before = f;
    }
    ...
    public final void m1297setAfter0680j_4(float f) {
        this.after = f;
    }
    ...
    public MeasureResult mo845measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m1284alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, this.before, this.after, measurable, j);
    }
}
