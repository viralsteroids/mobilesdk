...
final class WrapContentNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo845measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo5931measureBRTryo0 = measurable.mo5931measureBRTryo0(ConstraintsKt.Constraints(this.direction != Direction.Vertical ? 0 : Constraints.m7010getMinWidthimpl(j), (this.direction == Direction.Vertical || !this.unbounded) ? Constraints.m7008getMaxWidthimpl(j) : Integer.MAX_VALUE, this.direction == Direction.Horizontal ? Constraints.m7009getMinHeightimpl(j) : 0, (this.direction == Direction.Horizontal || !this.unbounded) ? Constraints.m7007getMaxHeightimpl(j) : Integer.MAX_VALUE));
        final int iCoerceIn = RangesKt.coerceIn(placeableMo5931measureBRTryo0.getWidth(), Constraints.m7010getMinWidthimpl(j), Constraints.m7008getMaxWidthimpl(j));
        final int iCoerceIn2 = RangesKt.coerceIn(placeableMo5931measureBRTryo0.getHeight(), Constraints.m7009getMinHeightimpl(j), Constraints.m7007getMaxHeightimpl(j));
        return MeasureScope.layout$default(measureScope, iCoerceIn, iCoerceIn2, null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.WrapContentNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                Placeable.PlacementScope.m5995place70tqf50$default(placementScope, placeableMo5931measureBRTryo0, this.this$0.getAlignmentCallback().invoke(IntSize.m7217boximpl(IntSizeKt.IntSize(iCoerceIn - placeableMo5931measureBRTryo0.getWidth(), iCoerceIn2 - placeableMo5931measureBRTryo0.getHeight())), measureScope.getLayoutDirection()).getPackedValue(), 0.0f, 2, null);
            }
        }, 4, null);
    }
}
