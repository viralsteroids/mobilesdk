...
final class AnimatedEnterExitMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo792measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        if (measureScope.isLookingAhead()) {
            ...
            this.scope.getTargetSize$animation_release().setValue(IntSize.m7217boximpl(IntSizeKt.IntSize(width3, height3)));
