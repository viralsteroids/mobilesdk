...
public final class InfiniteRepeatableSpec<T> implements AnimationSpec<T> {
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(durationBasedAnimationSpec, (i & 2) != 0 ? RepeatMode.Restart : repeatMode, (i & 4) != 0 ? StartOffset.m928constructorimpl$default(0, 0, 2, null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ InfiniteRepeatableSpec(DurationBasedAnimationSpec durationBasedAnimationSpec, RepeatMode repeatMode) {
        this(durationBasedAnimationSpec, repeatMode, StartOffset.m928constructorimpl$default(0, 0, 2, null), (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof InfiniteRepeatableSpec) {
            ...
            if (Intrinsics.areEqual(infiniteRepeatableSpec.animation, this.animation) && infiniteRepeatableSpec.repeatMode == this.repeatMode && StartOffset.m930equalsimpl0(infiniteRepeatableSpec.initialStartOffset, this.initialStartOffset)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return (((this.animation.hashCode() * 31) + this.repeatMode.hashCode()) * 31) + StartOffset.m933hashCodeimpl(this.initialStartOffset);
    }
}
