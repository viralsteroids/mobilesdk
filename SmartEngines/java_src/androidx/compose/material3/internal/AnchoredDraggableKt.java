...
public final class AnchoredDraggableKt {
    ...
    public static final <T> Modifier anchoredDraggable(Modifier modifier, AnchoredDraggableState<T> anchoredDraggableState, Orientation orientation, boolean z, boolean z2, MutableInteractionSource mutableInteractionSource) {
        return DraggableKt.draggable$default(modifier, anchoredDraggableState.getDraggableState(), orientation, z, mutableInteractionSource, anchoredDraggableState.isAnimationRunning(), null, new C16161(anchoredDraggableState, null), z2, 32, null);
    }

    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m513d1 = {"\u0000\u0012\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0007\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u008a@"}, m514d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Lkotlinx/coroutines/CoroutineScope;", "velocity", ""}, m515k = 3, m516mv = {1, 8, 0}, m518xi = 48)
    @DebugMetadata(m532c = "androidx.compose.material3.internal.AnchoredDraggableKt$anchoredDraggable$1", m533f = "AnchoredDraggable.kt", m534i = {}, m535l = {}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: androidx.compose.material3.internal.AnchoredDraggableKt$anchoredDraggable$1 */
    static final class C16161 extends SuspendLambda implements Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> {
        ...
        C16161(AnchoredDraggableState<T> anchoredDraggableState, Continuation<? super C16161> continuation) {
        ...
        public final Object invoke(CoroutineScope coroutineScope, float f, Continuation<? super Unit> continuation) {
            C16161 c16161 = new C16161(this.$state, continuation);
            c16161.L$0 = coroutineScope;
            c16161.F$0 = f;
            return c16161.invokeSuspend(Unit.INSTANCE);
        }
        ...
        @DebugMetadata(m532c = "androidx.compose.material3.internal.AnchoredDraggableKt$anchoredDraggable$1$1", m533f = "AnchoredDraggable.kt", m534i = {}, m535l = {CipherSuite.TLS_PSK_WITH_NULL_SHA384}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m513d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00020\u00052\u0006\u0010\u0006\u001a\u0002H\u0002H\u008a@"}, m514d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Landroidx/compose/material3/internal/AnchoredDragScope;", "anchors", "Landroidx/compose/material3/internal/DraggableAnchors;", "latestTarget"}, m515k = 3, m516mv = {1, 8, 0}, m518xi = 48)
    @DebugMetadata(m532c = "androidx.compose.material3.internal.AnchoredDraggableKt$snapTo$2", m533f = "AnchoredDraggable.kt", m534i = {}, m535l = {}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: androidx.compose.material3.internal.AnchoredDraggableKt$snapTo$2 */
    static final class C16202<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        private /* synthetic */ Object L$0;
        /* synthetic */ Object L$1;
        /* synthetic */ Object L$2;
        int label;

        C16202(Continuation<? super C16202> continuation) {
        ...
        public final Object invoke(AnchoredDragScope anchoredDragScope, DraggableAnchors<T> draggableAnchors, T t, Continuation<? super Unit> continuation) {
            C16202 c16202 = new C16202(continuation);
            c16202.L$0 = anchoredDragScope;
            c16202.L$1 = draggableAnchors;
            c16202.L$2 = t;
    ...
    public static final <T> Object snapTo(AnchoredDraggableState<T> anchoredDraggableState, T t, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C16202(null), continuation, 2, null);
    ...
    /* compiled from: AnchoredDraggable.kt */
    @Metadata(m513d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u00032\f\u0010\u0004\u001a\b\u0012\u0004\u0012\u0002H\u00020\u00052\u0006\u0010\u0006\u001a\u0002H\u0002H\u008a@"}, m514d2 = {"<anonymous>", "", ExifInterface.GPS_DIRECTION_TRUE, "Landroidx/compose/material3/internal/AnchoredDragScope;", "anchors", "Landroidx/compose/material3/internal/DraggableAnchors;", "latestTarget"}, m515k = 3, m516mv = {1, 8, 0}, m518xi = 48)
    @DebugMetadata(m532c = "androidx.compose.material3.internal.AnchoredDraggableKt$animateTo$2", m533f = "AnchoredDraggable.kt", m534i = {}, m535l = {685}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: androidx.compose.material3.internal.AnchoredDraggableKt$animateTo$2 */
    static final class C16172<T> extends SuspendLambda implements Function4<AnchoredDragScope, DraggableAnchors<T>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C16172(AnchoredDraggableState<T> anchoredDraggableState, float f, Continuation<? super C16172> continuation) {
            super(4, continuation);
        ...
        public final Object invoke(AnchoredDragScope anchoredDragScope, DraggableAnchors<T> draggableAnchors, T t, Continuation<? super Unit> continuation) {
            C16172 c16172 = new C16172(this.$this_animateTo, this.$velocity, continuation);
            c16172.L$0 = anchoredDragScope;
            c16172.L$1 = draggableAnchors;
            c16172.L$2 = t;
            return c16172.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object animateTo(AnchoredDraggableState<T> anchoredDraggableState, T t, float f, Continuation<? super Unit> continuation) {
        Object objAnchoredDrag$default = AnchoredDraggableState.anchoredDrag$default(anchoredDraggableState, t, null, new C16172(anchoredDraggableState, f, null), continuation, 2, null);
        return objAnchoredDrag$default == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objAnchoredDrag$default : Unit.INSTANCE;
    }
    ...
    */
    public static final <I> Object restartable(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        ...
        Object obj = c16181.result;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i = c16181.label;
        try {
            if (i == 0) {
                ResultKt.throwOnFailure(obj);
                C16192 c16192 = new C16192(function0, function2, null);
                c16181.label = 1;
                if (CoroutineScopeKt.coroutineScope(c16192, c16181) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else {
                if (i != 1) {
    ...
    @DebugMetadata(m532c = "androidx.compose.material3.internal.AnchoredDraggableKt$restartable$2", m533f = "AnchoredDraggable.kt", m534i = {}, m535l = {715}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: androidx.compose.material3.internal.AnchoredDraggableKt$restartable$2 */
    static final class C16192 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C16192(Function0<? extends I> function0, Function2<? super I, ? super Continuation<? super Unit>, ? extends Object> function2, Continuation<? super C16192> continuation) {
            super(2, continuation);
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C16192 c16192 = new C16192(this.$inputs, this.$block, continuation);
            c16192.L$0 = obj;
            return c16192;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
            return ((C16192) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
        ...
        static final class AnonymousClass1<T> implements FlowCollector {
            ...
            */
            ...
            /* compiled from: AnchoredDraggable.kt */
            @Metadata(m513d1 = {"\u0000\f\n\u0000\n\u0002\u0010\u0002\n\u0000\n\u0002\u0018\u0002\u0010\u0000\u001a\u00020\u0001\"\u0004\b\u0000\u0010\u0002*\u00020\u0003H\u008a@"}, m514d2 = {"<anonymous>", "", "I", "Lkotlinx/coroutines/CoroutineScope;"}, m515k = 3, m516mv = {1, 8, 0}, m518xi = 48)
            @DebugMetadata(m532c = "androidx.compose.material3.internal.AnchoredDraggableKt$restartable$2$1$2", m533f = "AnchoredDraggable.kt", m534i = {}, m535l = {722}, m536m = "invokeSuspend", m537n = {}, m538s = {})
