...
public final class InternalMutatorMutex {
    ...
    /* compiled from: InternalMutatorMutex.kt */
    @Metadata(m513d1 = {"\u0000&\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0006\n\u0002\u0010\u000b\n\u0002\b\u0002\n\u0002\u0010\u0002\n\u0000\b\u0002\u0018\u00002\u00020\u0001B\u0015\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\u000e\u0010\u000b\u001a\u00020\f2\u0006\u0010\r\u001a\u00020\u0000J\u0006\u0010\u000e\u001a\u00020\u000fR\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u0011\u0010\u0002\u001a\u00020\u0003¢\u0006\b\n\u0000\u001a\u0004\b\t\u0010\n¨\u0006\u0010"}, m514d2 = {"Landroidx/compose/material3/internal/InternalMutatorMutex$Mutator;", "", "priority", "Landroidx/compose/foundation/MutatePriority;", "job", "Lkotlinx/coroutines/Job;", "(Landroidx/compose/foundation/MutatePriority;Lkotlinx/coroutines/Job;)V", "getJob", "()Lkotlinx/coroutines/Job;", "getPriority", "()Landroidx/compose/foundation/MutatePriority;", "canInterrupt", "", "other", "cancel", "", "material3_release"}, m515k = 1, m516mv = {1, 8, 0}, m518xi = 48)
    ...
    @DebugMetadata(m532c = "androidx.compose.material3.internal.InternalMutatorMutex$mutate$2", m533f = "InternalMutatorMutex.kt", m534i = {0, 0, 1, 1}, m535l = {180, 103}, m536m = "invokeSuspend", m537n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m538s = {"L$0", "L$1", "L$0", "L$1"})
    /* renamed from: androidx.compose.material3.internal.InternalMutatorMutex$mutate$2 */
    static final class C16412<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        C16412(MutatePriority mutatePriority, InternalMutatorMutex internalMutatorMutex, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super C16412> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C16412 c16412 = new C16412(this.$priority, this.this$0, this.$block, continuation);
            c16412.L$0 = obj;
            return c16412;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super R> continuation) {
            return ((C16412) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
            ...
            try {
                try {
                    ...
                    if (r1 != 1) {
                        ...
                        try {
                            ResultKt.throwOnFailure(obj);
                            PreviewView$1$$ExternalSyntheticBackportWithForwarding0.m280m(internalMutatorMutex2.currentMutator, mutator2, null);
                            mutex2.unlock(null);
                            return obj;
                        } catch (Throwable th2) {
                            th = th2;
    ...
    public final <R> Object mutate(MutatePriority mutatePriority, Function1<? super Continuation<? super R>, ? extends Object> function1, Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C16412(mutatePriority, this, function1, null), continuation);
    }
    ...
    @DebugMetadata(m532c = "androidx.compose.material3.internal.InternalMutatorMutex$mutateWith$2", m533f = "InternalMutatorMutex.kt", m534i = {0, 0, 1, 1}, m535l = {180, 142}, m536m = "invokeSuspend", m537n = {"mutator", "$this$withLock_u24default$iv", "mutator", "$this$withLock_u24default$iv"}, m538s = {"L$0", "L$1", "L$0", "L$1"})
    /* renamed from: androidx.compose.material3.internal.InternalMutatorMutex$mutateWith$2 */
    static final class C16422<R> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super R>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C16422(MutatePriority mutatePriority, InternalMutatorMutex internalMutatorMutex, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, T t, Continuation<? super C16422> continuation) {
            super(2, continuation);
            this.$priority = mutatePriority;
            this.this$0 = internalMutatorMutex;
        ...
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C16422 c16422 = new C16422(this.$priority, this.this$0, this.$block, this.$receiver, continuation);
            c16422.L$0 = obj;
            return c16422;
        }
        ...
        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super R> continuation) {
            return ((C16422) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public final <T, R> Object mutateWith(T t, MutatePriority mutatePriority, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super R> continuation) {
        return CoroutineScopeKt.coroutineScope(new C16422(mutatePriority, this, function2, t, null), continuation);
    }
