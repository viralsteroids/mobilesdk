...
final class BasicTooltipStateImpl implements TooltipState {
    ...
    public Object show(MutatePriority mutatePriority, Continuation<? super Unit> continuation) {
        Object objMutate = this.mutatorMutex.mutate(mutatePriority, new C16282(new BasicTooltipStateImpl$show$cancellableShow$1(this, null), null), continuation);
    ...
    @DebugMetadata(m532c = "androidx.compose.material3.internal.BasicTooltipStateImpl$show$2", m533f = "BasicTooltip.kt", m534i = {}, m535l = {CipherSuite.TLS_DH_RSA_WITH_SEED_CBC_SHA, CipherSuite.TLS_DHE_RSA_WITH_SEED_CBC_SHA}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: androidx.compose.material3.internal.BasicTooltipStateImpl$show$2 */
    static final class C16282 extends SuspendLambda implements Function1<Continuation<? super Unit>, Object> {
        final /* synthetic */ Function1<Continuation<? super Unit>, Object> $cancellableShow;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C16282(Function1<? super Continuation<? super Unit>, ? extends Object> function1, Continuation<? super C16282> continuation) {
        ...
        public final Continuation<Unit> create(Continuation<?> continuation) {
            return BasicTooltipStateImpl.this.new C16282(this.$cancellableShow, continuation);
        }

        @Override // kotlin.jvm.functions.Function1
        public final Object invoke(Continuation<? super Unit> continuation) {
            return ((C16282) create(continuation)).invokeSuspend(Unit.INSTANCE);
        }

        /* JADX WARN: Code restructure failed: missing block: B:20:0x0049, code lost:
        
            if (kotlinx.coroutines.TimeoutKt.withTimeout(1500, new androidx.compose.material3.internal.BasicTooltipStateImpl.C16282.AnonymousClass1(r5.$cancellableShow, null), r5) == r0) goto L21;
         */
        @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
        /*
        ...
        */
        ...
        @DebugMetadata(m532c = "androidx.compose.material3.internal.BasicTooltipStateImpl$show$2$1", m533f = "BasicTooltip.kt", m534i = {}, m535l = {CipherSuite.TLS_DHE_RSA_WITH_SEED_CBC_SHA}, m536m = "invokeSuspend", m537n = {}, m538s = {})
