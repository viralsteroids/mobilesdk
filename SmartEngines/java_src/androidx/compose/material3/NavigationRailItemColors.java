...
public final class NavigationRailItemColors {
    ...
    public final long m2762getSelectedIndicatorColor0d7_KjU() {
    ...
    public final NavigationRailItemColors m2757copy4JmcsL4(long selectedIconColor, long selectedTextColor, long selectedIndicatorColor, long unselectedIconColor, long unselectedTextColor, long disabledIconColor, long disabledTextColor) {
    ...
    public final long m2766iconColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledIconColor;
        }
        if (selected) {
    ...
    public final long m2767textColorWaAFU9c$material3_release(boolean selected, boolean enabled) {
        if (!enabled) {
            return this.disabledTextColor;
        }
        if (selected) {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m4596equalsimpl0(this.selectedIconColor, navigationRailItemColors.selectedIconColor) && Color.m4596equalsimpl0(this.unselectedIconColor, navigationRailItemColors.unselectedIconColor) && Color.m4596equalsimpl0(this.selectedTextColor, navigationRailItemColors.selectedTextColor) && Color.m4596equalsimpl0(this.unselectedTextColor, navigationRailItemColors.unselectedTextColor) && Color.m4596equalsimpl0(this.selectedIndicatorColor, navigationRailItemColors.selectedIndicatorColor) && Color.m4596equalsimpl0(this.disabledIconColor, navigationRailItemColors.disabledIconColor) && Color.m4596equalsimpl0(this.disabledTextColor, navigationRailItemColors.disabledTextColor);
    }
