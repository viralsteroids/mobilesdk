...
public final class NavigationBarDefaults {
    ...
    private static final float Elevation = ElevationTokens.INSTANCE.m3608getLevel0D9Ej5fM();

    private NavigationBarDefaults() {
    }

    /* renamed from: getElevation-D9Ej5fM, reason: not valid java name */
    public final float m2693getElevationD9Ej5fM() {
        return Elevation;
    }
