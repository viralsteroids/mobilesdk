                    ...
                    if (i12 == 0) {
                        ...
                        if (i14 != 0) {
                            ...
                            if (i26 != 0) {
                                ...
                                int i47 = i33;
                                if ((i21 & 306783379) != 306783378 || (i27 & 306783379) != 306783378 || (i47 & CipherSuite.TLS_RSA_PSK_WITH_3DES_EDE_CBC_SHA) != 146 || !composerStartRestartGroup.getSkipping()) {
                                    ...
                                    if (jM6570getColor0d7_KjU == 16) {
                                        jM6570getColor0d7_KjU = textFieldColorsColors.m3097textColorXeAY9LY$material3_release(z5, z8, FocusInteractionKt.collectIsFocusedAsState(mutableInteractionSource3, composerStartRestartGroup, i40).getValue().booleanValue());
                                    }
                                    composerStartRestartGroup.endReplaceGroup();
                                    ...
                                    CompositionLocalKt.CompositionLocalProvider(TextSelectionColorsKt.getLocalTextSelectionColors().provides(textFieldColorsColors.getTextSelectionColors()), ComposableLambdaKt.rememberComposableLambda(-1886965181, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.1
                                        ...
                                        public final void invoke(Composer composer3, int i49) {
                                            Modifier.Companion companionM1439paddingqDBjuR0$default;
                                            ...
                                            if ((i49 & 3) != 2 || !composer3.getSkipping()) {
                                                ...
                                                if (function28 != null) {
                                                    companionM1439paddingqDBjuR0$default = PaddingKt.m1439paddingqDBjuR0$default(SemanticsModifierKt.semantics(Modifier.INSTANCE, true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.1.1
                                                    ...
                                                    }), 0.0f, density.mo1122toDpGaN1DYA(OutlinedTextFieldKt.getOutlinedTextFieldTopPadding()), 0.0f, 0.0f, 13, null);
                                                } else {
                                                    companionM1439paddingqDBjuR0$default = Modifier.INSTANCE;
                                                }
                                                Modifier modifierThen = modifier5.then(companionM1439paddingqDBjuR0$default);
                                                boolean z17 = z8;
                                                Strings.Companion companion = Strings.INSTANCE;
                                                Modifier modifierM1464defaultMinSizeVpY3zN4 = SizeKt.m1464defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(modifierThen, z17, Strings_androidKt.m3410getString2EP1pXo(Strings.m3340constructorimpl(C1750R.string.default_error_message), composer3, 0)), OutlinedTextFieldDefaults.INSTANCE.m2782getMinWidthD9Ej5fM(), OutlinedTextFieldDefaults.INSTANCE.m2781getMinHeightD9Ej5fM());
                                                SolidColor solidColor = new SolidColor(textFieldColorsColors.m3047cursorColorvNxB06k$material3_release(z8), null);
                                                String str3 = str2;
                                                ...
                                                BasicTextFieldKt.BasicTextField(str3, function13, modifierM1464defaultMinSizeVpY3zN4, z18, z19, textStyle5, keyboardOptions5, keyboardActions5, z20, i50, i51, visualTransformation4, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource7, solidColor2, ComposableLambdaKt.rememberComposableLambda(1474611661, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.1.3
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    /* JADX WARN: Multi-variable type inference failed */
                                                    {
                                                        super(3);
                                                    ...
                                                    public final void invoke(Function2<? super Composer, ? super Integer, Unit> function234, Composer composer4, int i52) {
                                                        ...
                                                        if ((i53 & 19) != 18 || !composer4.getSkipping()) {
                                                            ...
                                                            outlinedTextFieldDefaults.DecorationBox(str5, function234, z24, z25, visualTransformation6, mutableInteractionSource9, z26, function235, function236, function237, function238, function239, function240, function241, textFieldColors4, null, ComposableLambdaKt.rememberComposableLambda(2108828640, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.1.3.1
                                                                ...
                                                                public final void invoke(Composer composer5, int i55) {
                                                                    ...
                                                                    if ((i55 & 3) != 2 || !composer5.getSkipping()) {
                                                                        ...
                                                                        OutlinedTextFieldDefaults.INSTANCE.m2776Container4EFweAY(z27, z28, mutableInteractionSource10, null, textFieldColors5, shape6, 0.0f, 0.0f, composer5, 100663296, 200);
                                                                        if (ComposerKt.isTraceInProgress()) {
                                                            ...
                                                            }, composer4, 54), composer4, (i54 << 3) & LDSFile.EF_DG16_TAG, 14155776, 32768);
                                                            if (ComposerKt.isTraceInProgress()) {
                                                                ComposerKt.traceEventEnd();
                                                                return;
                                                            }
                            ...
                            if ((i21 & 306783379) != 306783378) {
                                ...
                                if ((i3 & 1) != 0) {
                                    ...
                                    ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
                                    final Density density2 = (Density) objConsume22;
                                        ...
                                        public final void invoke(Composer composer3, int i49) {
                                            ...
                                            if ((i49 & 3) != 2 || !composer3.getSkipping()) {
                                                ...
                                                if (function28 != null) {
                                                    ...
                                                    }), 0.0f, density2.mo1122toDpGaN1DYA(OutlinedTextFieldKt.getOutlinedTextFieldTopPadding()), 0.0f, 0.0f, 13, null);
                                                } else {
                                                    companionM1439paddingqDBjuR0$default = Modifier.INSTANCE;
                                                }
                                                Modifier modifierThen = modifier52.then(companionM1439paddingqDBjuR0$default);
                                                boolean z17 = z8;
                                                Strings.Companion companion = Strings.INSTANCE;
                                                Modifier modifierM1464defaultMinSizeVpY3zN4 = SizeKt.m1464defaultMinSizeVpY3zN4(TextFieldImplKt.defaultErrorSemantics(modifierThen, z17, Strings_androidKt.m3410getString2EP1pXo(Strings.m3340constructorimpl(C1750R.string.default_error_message), composer3, 0)), OutlinedTextFieldDefaults.INSTANCE.m2782getMinWidthD9Ej5fM(), OutlinedTextFieldDefaults.INSTANCE.m2781getMinHeightD9Ej5fM());
                                                SolidColor solidColor = new SolidColor(textFieldColorsColors.m3047cursorColorvNxB06k$material3_release(z8), null);
    ...
    */
                            ...
                            if (i26 != 0) {
                                    ...
                                    CompositionLocalKt.CompositionLocalProvider(TextSelectionColorsKt.getLocalTextSelectionColors().provides(textFieldColorsColors.getTextSelectionColors()), ComposableLambdaKt.rememberComposableLambda(1830921872, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.3
                                        ...
                                        public final void invoke(Composer composer3, int i49) {
                                            ...
                                            if ((i49 & 3) != 2 || !composer3.getSkipping()) {
                                                ...
                                                Modifier modifier5 = modifier3;
                                                if (function28 != null) {
                                                    companionM1439paddingqDBjuR0$default = PaddingKt.m1439paddingqDBjuR0$default(SemanticsModifierKt.semantics(Modifier.INSTANCE, true, new Function1<SemanticsPropertyReceiver, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.3.1
                                                        /* renamed from: invoke, reason: avoid collision after fix types in other method */
                                                        public final void invoke2(SemanticsPropertyReceiver semanticsPropertyReceiver) {
                                                        }
                                                ...
                                                final TextFieldColors textFieldColors3 = textFieldColorsColors;
                                                final Shape shape5 = shape2;
                                                BasicTextFieldKt.BasicTextField(textFieldValue3, function13, modifierM1464defaultMinSizeVpY3zN4, z18, z19, textStyle5, keyboardOptions5, keyboardActions5, z20, i50, i51, visualTransformation4, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource7, solidColor2, ComposableLambdaKt.rememberComposableLambda(-757328870, true, new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.3.3
                                                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                                                    /* JADX WARN: Multi-variable type inference failed */
                                                    {
                                                        super(3);
                                                        ...
                                                        if ((i53 & 19) != 18 || !composer4.getSkipping()) {
                                                            ...
                                                            outlinedTextFieldDefaults.DecorationBox(text, function234, z24, z25, visualTransformation6, mutableInteractionSource9, z26, function235, function236, function237, function238, function239, function240, function241, textFieldColors4, null, ComposableLambdaKt.rememberComposableLambda(255570733, true, new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.3.3.1
                                                                ...
                                                                public final void invoke(Composer composer5, int i55) {
                                                                    ...
                                                                    if ((i55 & 3) != 2 || !composer5.getSkipping()) {
                                                                        if (ComposerKt.isTraceInProgress()) {
                                                                            ComposerKt.traceEventStart(255570733, i55, -1, "androidx.compose.material3.OutlinedTextField.<anonymous>.<anonymous>.<anonymous> (OutlinedTextField.kt:433)");
                                                                        }
                                                                        OutlinedTextFieldDefaults.INSTANCE.m2776Container4EFweAY(z27, z28, mutableInteractionSource10, null, textFieldColors5, shape6, 0.0f, 0.0f, composer5, 100663296, 200);
                                                                        if (ComposerKt.isTraceInProgress()) {
                                                                            ComposerKt.traceEventEnd();
                                ...
                                if (scopeUpdateScopeEndRestartGroup != null) {
                                    ...
                                    scopeUpdateScopeEndRestartGroup.updateScope(new Function2<Composer, Integer, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.OutlinedTextField.4
                                        ...
                                        public final void invoke(Composer composer3, int i49) {
                                            OutlinedTextFieldKt.OutlinedTextField(textFieldValue, function1, modifier5, z11, z12, textStyle4, function216, function217, function227, function218, function219, function220, function221, z10, visualTransformation3, keyboardOptions3, keyboardActions3, z13, i41, i42, mutableInteractionSource4, shape3, textFieldColors2, composer3, RecomposeScopeImplKt.updateChangedFlags(i3 | 1), RecomposeScopeImplKt.updateChangedFlags(i4), RecomposeScopeImplKt.updateChangedFlags(i5), i6);
                                        }
                                    });
                                    return;
                                }
    ...
    public static final void OutlinedTextFieldLayout(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Function3<? super Modifier, ? super Composer, ? super Integer, Unit> function3, final Function2<? super Composer, ? super Integer, Unit> function22, final Function2<? super Composer, ? super Integer, Unit> function23, final Function2<? super Composer, ? super Integer, Unit> function24, final Function2<? super Composer, ? super Integer, Unit> function25, final Function2<? super Composer, ? super Integer, Unit> function26, final boolean z, float f, final Function1<? super Size, Unit> function1, final Function2<? super Composer, ? super Integer, Unit> function27, Function2<? super Composer, ? super Integer, Unit> function28, PaddingValues paddingValues, Composer composer, final int i, final int i2) {
        ...
        if ((i6 & 306783379) != 306783378 || (i7 & 1171) != 1170 || !composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m4095setimpl(composerM4088constructorimpl, outlinedTextFieldMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
            ...
            Modifier modifierM1439paddingqDBjuR0$default3 = PaddingKt.m1439paddingqDBjuR0$default(modifierWrapContentHeight$default, fM7055constructorimpl, 0.0f, function26 == null ? f2 : C1959Dp.m7055constructorimpl(0), 0.0f, 10, null);
            ...
            if (function3 != null) {
                ...
                function32.invoke(LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.PlaceholderId).then(modifierM1439paddingqDBjuR0$default3), composerStartRestartGroup, Integer.valueOf((i6 >> 3) & LDSFile.EF_DG16_TAG));
            } else {
                function32 = function3;
            }
            composerStartRestartGroup.endReplaceGroup();
            Modifier modifierThen3 = LayoutIdKt.layoutId(Modifier.INSTANCE, TextFieldImplKt.TextFieldId).then(modifierM1439paddingqDBjuR0$default3);
            ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
            ...
            if (function22 != null) {
                f3 = f;
                Modifier modifierLayoutId = LayoutIdKt.layoutId(SizeKt.wrapContentHeight$default(SizeKt.m1468heightInVpY3zN4$default(Modifier.INSTANCE, DpKt.m7098lerpMdfbLM(TextFieldImplKt.getMinTextLineHeight(), TextFieldImplKt.getMinFocusedLabelLineHeight(), f3), 0.0f, 2, null), null, false, 3, null), TextFieldImplKt.LabelId);
                ComposerKt.sourceInformationMarkerStart(composerStartRestartGroup, 733328855, "CC(Box)P(2,1,3)72@3384L130:Box.kt#2w3rfo");
    ...
    public static final int m2787calculateWidthDHJA7U0(int i, int i2, int i3, int i4, int i5, int i6, int i7, float f, long j, float f2, PaddingValues paddingValues) {
        int i8 = i3 + i4;
        return Math.max(i + Math.max(i5 + i8, Math.max(i7 + i8, MathHelpersKt.lerp(i6, 0, f))) + i2, Math.max(MathKt.roundToInt((i6 + (C1959Dp.m7055constructorimpl(paddingValues.mo1386calculateLeftPaddingu2uoSUM(LayoutDirection.Ltr) + paddingValues.mo1387calculateRightPaddingu2uoSUM(LayoutDirection.Ltr)) * f2)) * f), Constraints.m7010getMinWidthimpl(j)));
    }

    /* JADX INFO: Access modifiers changed from: private */
    /* renamed from: calculateHeight-mKXJcVc, reason: not valid java name */
    public static final int m2786calculateHeightmKXJcVc(int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, float f, long j, float f2, PaddingValues paddingValues) {
        int iMaxOf = ComparisonsKt.maxOf(i5, i7, i3, i4, MathHelpersKt.lerp(i6, 0, f));
        float top = paddingValues.getTop() * f2;
        return Math.max(Constraints.m7009getMinHeightimpl(j), Math.max(i, Math.max(i2, MathKt.roundToInt(MathHelpersKt.lerp(top, Math.max(top, i6 / 2.0f), f) + iMaxOf + (paddingValues.getBottom() * f2)))) + i8);
    }
    ...
    public static final Modifier outlineCutout(Modifier modifier, final Function0<Size> function0, final PaddingValues paddingValues) {
        return DrawModifierKt.drawWithContent(modifier, new Function1<ContentDrawScope, Unit>() { // from class: androidx.compose.material3.OutlinedTextFieldKt.outlineCutout.1
            ...
            public final void invoke2(ContentDrawScope contentDrawScope) {
                ...
                float fM4423getWidthimpl = Size.m4423getWidthimpl(packedValue);
                if (fM4423getWidthimpl > 0.0f) {
                    float f = contentDrawScope.mo1127toPx0680j_4(OutlinedTextFieldKt.OutlinedTextFieldInnerPadding);
                    float f2 = contentDrawScope.mo1127toPx0680j_4(paddingValues.mo1386calculateLeftPaddingu2uoSUM(contentDrawScope.getLayoutDirection())) - f;
                    float f3 = 2;
                    float fM4423getWidthimpl2 = fM4423getWidthimpl + f2 + (f * f3);
                    if (WhenMappings.$EnumSwitchMapping$0[contentDrawScope.getLayoutDirection().ordinal()] == 1) {
                        fCoerceAtLeast = Size.m4423getWidthimpl(contentDrawScope.mo5151getSizeNHjbRc()) - fM4423getWidthimpl2;
                    } else {
                        fCoerceAtLeast = RangesKt.coerceAtLeast(f2, 0.0f);
                    }
                    float f4 = fCoerceAtLeast;
                    if (WhenMappings.$EnumSwitchMapping$0[contentDrawScope.getLayoutDirection().ordinal()] == 1) {
                        fM4423getWidthimpl2 = Size.m4423getWidthimpl(contentDrawScope.mo5151getSizeNHjbRc()) - RangesKt.coerceAtLeast(f2, 0.0f);
                    }
                    float f5 = fM4423getWidthimpl2;
                    float fM4420getHeightimpl = Size.m4420getHeightimpl(packedValue);
                    float f6 = (-fM4420getHeightimpl) / f3;
                    float f7 = fM4420getHeightimpl / f3;
                    ...
                    try {
                        drawContext.getTransform().mo5075clipRectN_I0leg(f4, f6, f5, f7, iM4583getDifferencertfAjoo);
    ...
    static {
        long jM4012getBodySmallLineHeightXSAIIZE = TypeScaleTokens.INSTANCE.m4012getBodySmallLineHeightXSAIIZE();
        TextUnitKt.m7261checkArithmeticR2X_6o(jM4012getBodySmallLineHeightXSAIIZE);
        OutlinedTextFieldTopPadding = TextUnitKt.pack(TextUnit.m7246getRawTypeimpl(jM4012getBodySmallLineHeightXSAIIZE), TextUnit.m7248getValueimpl(jM4012getBodySmallLineHeightXSAIIZE) / 2);
    }
}
