...
public final class TopAppBarLargeTokens {
    ...
    private static final float ContainerHeight = C1959Dp.m7055constructorimpl((float) 152.0d);
    ...
    public final float m3987getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3988getContainerHeightD9Ej5fM() {
    ...
    public final float m3989getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3990getTrailingIconSizeD9Ej5fM() {
