...
public final class BadgeTokens {
    ...
    private static final float LargeSize = C1959Dp.m7055constructorimpl((float) 16.0d);
    private static final ShapeKeyTokens Shape = ShapeKeyTokens.CornerFull;
    private static final float Size = C1959Dp.m7055constructorimpl((float) 6.0d);
    ...
    public final float m3449getLargeSizeD9Ej5fM() {
        return LargeSize;
    }
    ...
    public final float m3450getSizeD9Ej5fM() {
        return Size;
    }
}
