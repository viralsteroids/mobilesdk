...
public final class SearchBarTokens {
    ...
    private static final float AvatarSize = C1959Dp.m7055constructorimpl((float) 30.0d);
    ...
    public final float m3907getAvatarSizeD9Ej5fM() {
        return AvatarSize;
    }
    ...
    public final float m3908getContainerElevationD9Ej5fM() {
        return ContainerElevation;
    }

    /* renamed from: getContainerHeight-D9Ej5fM, reason: not valid java name */
    public final float m3909getContainerHeightD9Ej5fM() {
