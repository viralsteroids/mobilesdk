...
public final class RadioButtonTokens {
    ...
    private static final float IconSize = C1959Dp.m7055constructorimpl((float) 20.0d);
    ...
    private static final float StateLayerSize = C1959Dp.m7055constructorimpl((float) 40.0d);
    ...
    public final float m3904getIconSizeD9Ej5fM() {
        return IconSize;
    }
    ...
    public final float m3905getStateLayerSizeD9Ej5fM() {
