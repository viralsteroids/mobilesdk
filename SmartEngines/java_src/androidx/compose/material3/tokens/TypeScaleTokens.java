...
public final class TypeScaleTokens {
    ...
    static {
        ...
        TextUnitKt.m7261checkArithmeticR2X_6o(sp);
        DisplayLargeTracking = TextUnitKt.pack(TextUnit.m7246getRawTypeimpl(sp), -TextUnit.m7248getValueimpl(sp));
