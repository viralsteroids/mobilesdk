...
public final class TopAppBarMediumTokens {
    ...
    private static final float ContainerHeight = C1959Dp.m7055constructorimpl((float) 112.0d);
    ...
    public final float m3993getLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3994getTrailingIconSizeD9Ej5fM() {
