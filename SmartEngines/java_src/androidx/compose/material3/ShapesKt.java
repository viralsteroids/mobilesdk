...
public final class ShapesKt {
    ...
    public static final CornerBasedShape top(CornerBasedShape cornerBasedShape) {
        ...
        return CornerBasedShape.copy$default(cornerBasedShape, null, null, CornerSizeKt.m1710CornerSize0680j_4(C1959Dp.m7055constructorimpl(f)), CornerSizeKt.m1710CornerSize0680j_4(C1959Dp.m7055constructorimpl(f)), 3, null);
    }

    public static final CornerBasedShape bottom(CornerBasedShape cornerBasedShape) {
        float f = (float) AudioStats.AUDIO_AMPLITUDE_NONE;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m1710CornerSize0680j_4(C1959Dp.m7055constructorimpl(f)), CornerSizeKt.m1710CornerSize0680j_4(C1959Dp.m7055constructorimpl(f)), null, null, 12, null);
    }

    public static final CornerBasedShape start(CornerBasedShape cornerBasedShape) {
        float f = (float) AudioStats.AUDIO_AMPLITUDE_NONE;
        return CornerBasedShape.copy$default(cornerBasedShape, null, CornerSizeKt.m1710CornerSize0680j_4(C1959Dp.m7055constructorimpl(f)), CornerSizeKt.m1710CornerSize0680j_4(C1959Dp.m7055constructorimpl(f)), null, 9, null);
    }

    public static final CornerBasedShape end(CornerBasedShape cornerBasedShape) {
        float f = (float) AudioStats.AUDIO_AMPLITUDE_NONE;
        return CornerBasedShape.copy$default(cornerBasedShape, CornerSizeKt.m1710CornerSize0680j_4(C1959Dp.m7055constructorimpl(f)), null, null, CornerSizeKt.m1710CornerSize0680j_4(C1959Dp.m7055constructorimpl(f)), 6, null);
    }
}
