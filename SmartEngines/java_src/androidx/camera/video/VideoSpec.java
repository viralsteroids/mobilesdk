...
public abstract class VideoSpec {
    ...
    public static final QualitySelector QUALITY_SELECTOR_AUTO = QualitySelector.fromOrderedList(Arrays.asList(Quality.FHD, Quality.f28HD, Quality.f29SD), FallbackStrategy.higherQualityOrLowerThan(Quality.FHD));
