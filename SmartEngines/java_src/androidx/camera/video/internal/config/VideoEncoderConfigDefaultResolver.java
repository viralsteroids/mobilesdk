...
public class VideoEncoderConfigDefaultResolver implements Supplier<VideoEncoderConfig> {
    ...
    public VideoEncoderConfig get() {
        ...
        Logger.m122d(TAG, "Using fallback VIDEO bitrate");
    ...
    private int resolveFrameRate() {
        ...
        Logger.m122d(TAG, String.format("Default resolved frame rate: %dfps. [Expected operating range: %s]", Integer.valueOf(iIntValue), Objects.equals(this.mExpectedFrameRateRange, SurfaceRequest.FRAME_RATE_RANGE_UNSPECIFIED) ? this.mExpectedFrameRateRange : "<UNSPECIFIED>"));
        return iIntValue;
    }
}
