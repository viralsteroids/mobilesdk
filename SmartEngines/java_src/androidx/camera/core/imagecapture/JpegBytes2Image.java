...
public class JpegBytes2Image implements Operation<Packet<byte[]>, Packet<ImageProxy>> {
    ...
    public Packet<ImageProxy> apply(Packet<byte[]> packet) throws ImageCaptureException {
        ...
        return Packet.m188of((ImageProxy) Objects.requireNonNull(imageProxyConvertJpegBytesToImage), (Exif) Objects.requireNonNull(packet.getExif()), packet.getCropRect(), packet.getRotationDegrees(), packet.getSensorToBufferTransform(), packet.getCameraCaptureResult());
    }
}
