...
public final class CameraOrientationUtil {
    ...
    public static int getRelativeImageRotation(int i, int i2, boolean z) {
        ...
        if (Logger.isVerboseEnabled(TAG)) {
            Logger.m122d(TAG, String.format("getRelativeImageRotation: destRotationDegrees=%s, sourceRotationDegrees=%s, isOppositeFacing=%s, result=%s", Integer.valueOf(i), Integer.valueOf(i2), Boolean.valueOf(z), Integer.valueOf(i3)));
        }
        return i3;
    }
