...
public abstract class DeferrableSurface {
    ...
    public DeferrableSurface(Size size, int i) {
        ...
        ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda0
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m716lambda$new$0$androidxcameracoreimplDeferrableSurface(completer);
            }
        });
        ...
        this.mCloseFuture = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda1
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m717lambda$new$1$androidxcameracoreimplDeferrableSurface(completer);
            }
        });
        if (Logger.isDebugEnabled(TAG)) {
            ...
            future.addListener(new Runnable() { // from class: androidx.camera.core.impl.DeferrableSurface$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m718lambda$new$2$androidxcameracoreimplDeferrableSurface(stackTraceString);
                }
    ...
    /* synthetic */ Object m716lambda$new$0$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    /* synthetic */ Object m717lambda$new$1$androidxcameracoreimplDeferrableSurface(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
    ...
    /* synthetic */ void m718lambda$new$2$androidxcameracoreimplDeferrableSurface(String str) {
        try {
            this.mTerminationFuture.get();
            printGlobalDebugCounts("Surface terminated", TOTAL_COUNT.decrementAndGet(), USED_COUNT.get());
        } catch (Exception e) {
            Logger.m124e(TAG, "Unexpected surface termination for " + this + "\nStack Trace:\n" + str);
            synchronized (this.mLock) {
    ...
    private void printGlobalDebugCounts(String str, int i, int i2) {
        if (!DEBUG && Logger.isDebugEnabled(TAG)) {
            Logger.m122d(TAG, "DeferrableSurface usage statistics may be inaccurate since debug logging was not enabled at static initialization time. App restart may be required to enable accurate usage statistics.");
        }
        Logger.m122d(TAG, str + "[total_surfaces=" + i + ", used_surfaces=" + i2 + "](" + this + "}");
    }
    ...
    public void incrementUseCount() throws SurfaceClosedException {
        synchronized (this.mLock) {
            ...
            if (Logger.isDebugEnabled(TAG)) {
                ...
                Logger.m122d(TAG, "use count+1, useCount=" + this.mUseCount + " " + this);
            }
        }
    }
    ...
    public void close() {
        ...
        synchronized (this.mLock) {
            if (this.mClosed) {
                ...
                if (Logger.isDebugEnabled(TAG)) {
                    Logger.m122d(TAG, "surface closed,  useCount=" + this.mUseCount + " closed=true " + this);
                }
            }
        }
        if (completer != null) {
    ...
    public void decrementUseCount() {
        ...
        synchronized (this.mLock) {
            ...
            if (Logger.isDebugEnabled(TAG)) {
                Logger.m122d(TAG, "use count-1,  useCount=" + this.mUseCount + " closed=" + this.mClosed + " " + this);
                if (this.mUseCount == 0) {
