...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSession.Opener {
        ...
        synchronized (this.mLock) {
            ...
            ListenableFuture<Void> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda3
                ...
                public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                    return this.f$0.m75x73bfea20(list, cameraDeviceCompat, sessionConfigurationCompat, completer);
                }
            });
    ...
    /* renamed from: lambda$openCaptureSession$0$androidx-camera-camera2-internal-SynchronizedCaptureSessionBaseImpl */
    /* synthetic */ Object m75x73bfea20(List list, CameraDeviceCompat cameraDeviceCompat, SessionConfigurationCompat sessionConfigurationCompat, CallbackToFutureAdapter.Completer completer) throws Exception {
        String str;
        synchronized (this.mLock) {
        ...
        synchronized (this.mLock) {
            ...
            FutureChain futureChainTransformAsync = FutureChain.from(DeferrableSurfaces.surfaceListWithTimeout(list, false, j, getExecutor(), this.mScheduledExecutorService)).transformAsync(new AsyncFunction() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda4
                ...
                public final ListenableFuture apply(Object obj) {
                    return this.f$0.m76x2071bdd2(list, (List) obj);
                }
            }, getExecutor());
    ...
    /* renamed from: lambda$startWithDeferrableSurface$1$androidx-camera-camera2-internal-SynchronizedCaptureSessionBaseImpl */
    /* synthetic */ ListenableFuture m76x2071bdd2(List list, List list2) throws Exception {
        Logger.m122d(TAG, "[" + this + "] getSurface done with results: " + list2);
        if (list2.isEmpty()) {
    ...
    public void close() {
        ...
        getExecutor().execute(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m72x23111ba6();
            }
        });
    }

    /* renamed from: lambda$close$2$androidx-camera-camera2-internal-SynchronizedCaptureSessionBaseImpl */
    /* synthetic */ void m72x23111ba6() {
    ...
    public void onClosed(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda2
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m73x46877ef4(synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }

    /* renamed from: lambda$onClosed$3$androidx-camera-camera2-internal-SynchronizedCaptureSessionBaseImpl */
    /* synthetic */ void m73x46877ef4(SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (this.mCameraCaptureSessionCompat != null) {
            ...
            Logger.m128w(TAG, "[" + this + "] Cannot call onClosed() when the CameraCaptureSession is not correctly configured.");
        }
    }
    ...
    void onSessionFinished(final SynchronizedCaptureSession synchronizedCaptureSession) {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new Runnable() { // from class: androidx.camera.camera2.internal.SynchronizedCaptureSessionBaseImpl$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m74x5333f8b9(synchronizedCaptureSession);
                }
            }, CameraXExecutors.directExecutor());
        }
    }

    /* renamed from: lambda$onSessionFinished$4$androidx-camera-camera2-internal-SynchronizedCaptureSessionBaseImpl */
    /* synthetic */ void m74x5333f8b9(SynchronizedCaptureSession synchronizedCaptureSession) {
        Objects.requireNonNull(this.mCaptureSessionStateCallback);
