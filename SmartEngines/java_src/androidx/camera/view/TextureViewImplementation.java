...
final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    void onSurfaceRequested(final SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        surfaceRequest.addRequestCancellationListener(ContextCompat.getMainExecutor(this.mTextureView.getContext()), new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m284xce057d29(surfaceRequest);
            }
        });
        tryToProvidePreviewSurface();
    }

    /* renamed from: lambda$onSurfaceRequested$0$androidx-camera-view-TextureViewImplementation */
    /* synthetic */ void m284xce057d29(SurfaceRequest surfaceRequest) {
        SurfaceRequest surfaceRequest2 = this.mSurfaceRequest;
    ...
    public void initializePreview() {
        ...
        this.mTextureView.setSurfaceTextureListener(new TextureViewSurfaceTextureListenerC03351());
        this.mParent.removeAllViews();
        this.mParent.addView(this.mTextureView);
    }

    /* renamed from: androidx.camera.view.TextureViewImplementation$1 */
    class TextureViewSurfaceTextureListenerC03351 implements TextureView.SurfaceTextureListener {
        TextureViewSurfaceTextureListenerC03351() {
        }

        @Override // android.view.TextureView.SurfaceTextureListener
        public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
            Logger.m122d(TextureViewImplementation.TAG, "SurfaceTexture available. Size: " + i + "x" + i2);
            ...
            if (TextureViewImplementation.this.mSurfaceReleaseFuture != null) {
                ...
                Logger.m122d(TextureViewImplementation.TAG, "Surface invalidated " + TextureViewImplementation.this.mSurfaceRequest);
        ...
        public void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
            Logger.m122d(TextureViewImplementation.TAG, "SurfaceTexture size changed: " + i + "x" + i2);
        }
        ...
        public boolean onSurfaceTextureDestroyed(final SurfaceTexture surfaceTexture) {
            ...
            if (TextureViewImplementation.this.mSurfaceReleaseFuture != null) {
                Futures.addCallback(TextureViewImplementation.this.mSurfaceReleaseFuture, new FutureCallback<SurfaceRequest.Result>() { // from class: androidx.camera.view.TextureViewImplementation.1.1
                    ...
                    public void onSuccess(SurfaceRequest.Result result) {
                        ...
                        Logger.m122d(TextureViewImplementation.TAG, "SurfaceTexture about to manually be destroyed");
            ...
            Logger.m122d(TextureViewImplementation.TAG, "SurfaceTexture about to be destroyed");
            return true;
        }
    ...
    void tryToProvidePreviewSurface() {
        ...
        final ListenableFuture<SurfaceRequest.Result> future = CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda3
            ...
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m285xdd0bd278(surface, completer);
            }
        });
        ...
        future.addListener(new Runnable() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m286x16d67457(surface, future, surfaceRequest);
            }
        }, ContextCompat.getMainExecutor(this.mTextureView.getContext()));
        onSurfaceProvided();
    }

    /* renamed from: lambda$tryToProvidePreviewSurface$1$androidx-camera-view-TextureViewImplementation */
    /* synthetic */ Object m285xdd0bd278(Surface surface, final CallbackToFutureAdapter.Completer completer) throws Exception {
        Logger.m122d(TAG, "Surface set on Preview.");
    ...
    /* renamed from: lambda$tryToProvidePreviewSurface$2$androidx-camera-view-TextureViewImplementation */
    /* synthetic */ void m286x16d67457(Surface surface, ListenableFuture listenableFuture, SurfaceRequest surfaceRequest) {
        Logger.m122d(TAG, "Safe to release surface.");
        notifySurfaceNotInUse();
        surface.release();
    ...
    ListenableFuture<Void> waitForNextFrame() {
        return CallbackToFutureAdapter.getFuture(new CallbackToFutureAdapter.Resolver() { // from class: androidx.camera.view.TextureViewImplementation$$ExternalSyntheticLambda0
            @Override // androidx.concurrent.futures.CallbackToFutureAdapter.Resolver
            public final Object attachCompleter(CallbackToFutureAdapter.Completer completer) {
                return this.f$0.m287x86b0fc00(completer);
            }
        });
    }

    /* renamed from: lambda$waitForNextFrame$3$androidx-camera-view-TextureViewImplementation */
    /* synthetic */ Object m287x86b0fc00(CallbackToFutureAdapter.Completer completer) throws Exception {
