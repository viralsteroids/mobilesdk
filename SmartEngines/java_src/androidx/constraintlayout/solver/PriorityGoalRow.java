...
public class PriorityGoalRow extends ArrayRow {
    ...
    class GoalVariableAccessor implements Comparable {
        ...
        public int compareTo(Object obj) {
            return this.variable.f201id - ((SolverVariable) obj).f201id;
        }
    ...
    */
    ...
    private final void addToGoal(SolverVariable solverVariable) {
        ...
        int i4 = i3 + 1;
        this.numGoals = i4;
        if (i4 > 1 && solverVariableArr3[i3].f201id > solverVariable.f201id) {
            int i5 = 0;
            while (true) {
                i = this.numGoals;
                if (i5 >= i) {
            ...
            Arrays.sort(this.sortArray, 0, i, new Comparator<SolverVariable>() { // from class: androidx.constraintlayout.solver.PriorityGoalRow.1
                ...
                public int compare(SolverVariable solverVariable2, SolverVariable solverVariable3) {
                    return solverVariable2.f201id - solverVariable3.f201id;
                }
            });
