...
public class MonotonicCurveFit extends CurveFit {
    ...
    public void getPos(double d, float[] fArr) {
        ...
        if (d <= dArr[0]) {
            for (int i2 = 0; i2 < length2; i2++) {
                fArr[i2] = (float) this.f194mY[0][i2];
            }
            return;
        }
        int i3 = length - 1;
        ...
        while (i4 < i3) {
            if (d == this.f193mT[i4]) {
                for (int i5 = 0; i5 < length2; i5++) {
                    fArr[i5] = (float) this.f194mY[i4][i5];
                }
            }
            double[] dArr2 = this.f193mT;
            int i6 = i4 + 1;
