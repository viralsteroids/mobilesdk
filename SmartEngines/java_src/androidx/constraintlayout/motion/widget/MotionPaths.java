...
class MotionPaths implements Comparable<MotionPaths> {
    ...
    void initCartesian(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f199x;
        float f9 = motionPaths.f200y;
        float f10 = f;
        float f11 = (motionPaths2.f199x + (f4 / 2.0f)) - ((f5 / 2.0f) + f8);
        float f12 = (motionPaths2.f200y + (f6 / 2.0f)) - (f9 + (f7 / 2.0f));
        float f13 = ((f4 - f5) * f2) / 2.0f;
        this.f199x = (int) ((f8 + (f11 * f10)) - f13);
        float f14 = ((f6 - f7) * f3) / 2.0f;
        this.f200y = (int) ((f9 + (f12 * f10)) - f14);
        ...
        this.mMode = 2;
        this.f199x = (int) (((motionPaths.f199x + (f15 * f11)) + (f17 * f12)) - f13);
        this.f200y = (int) (((motionPaths.f200y + (f11 * f16)) + (f12 * f10)) - f14);
    ...
    void initScreen(int i, int i2, KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f8 = motionPaths.f199x;
        float f9 = motionPaths.f200y;
        float f10 = motionPaths2.f199x + (f4 / 2.0f);
        float f11 = motionPaths2.f200y + (f6 / 2.0f);
        float f12 = (f4 - f5) * f2;
        this.f199x = (int) ((f8 + ((f10 - ((f5 / 2.0f) + f8)) * f)) - (f12 / 2.0f));
        float f13 = (f6 - f7) * f3;
        this.f200y = (int) ((f9 + ((f11 - (f9 + (f7 / 2.0f))) * f)) - (f13 / 2.0f));
        this.width = (int) (f5 + f12);
        this.height = (int) (f7 + f13);
        this.mMode = 3;
        if (!Float.isNaN(keyPosition.mPercentX)) {
            this.f199x = (int) (keyPosition.mPercentX * ((int) (i - this.width)));
        }
        if (!Float.isNaN(keyPosition.mPercentY)) {
            this.f200y = (int) (keyPosition.mPercentY * ((int) (i2 - this.height)));
        }
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void initPath(KeyPosition keyPosition, MotionPaths motionPaths, MotionPaths motionPaths2) {
        ...
        float f6 = motionPaths.f199x;
        float f7 = motionPaths.width;
        float f8 = motionPaths.f200y;
        float f9 = motionPaths.height;
        float f10 = f;
        float f11 = (motionPaths2.f199x + (motionPaths2.width / 2.0f)) - ((f7 / 2.0f) + f6);
        float f12 = (motionPaths2.f200y + (motionPaths2.height / 2.0f)) - ((f9 / 2.0f) + f8);
        float f13 = f11 * f10;
        float f14 = (f4 * f2) / 2.0f;
        this.f199x = (int) ((f6 + f13) - f14);
        float f15 = f12 * f10;
        float f16 = (f5 * f3) / 2.0f;
        this.f200y = (int) ((f8 + f15) - f16);
        this.width = (int) (f7 + r7);
        this.height = (int) (f9 + r8);
        float f17 = Float.isNaN(keyPosition.mPercentY) ? 0.0f : keyPosition.mPercentY;
        this.mMode = 1;
        float f18 = (int) ((motionPaths.f199x + f13) - f14);
        this.f199x = f18;
        float f19 = (int) ((motionPaths.f200y + f15) - f16);
        this.f199x = f18 + ((-f12) * f17);
        this.f200y = f19 + (f11 * f17);
        this.mKeyFrameEasing = Easing.getInterpolator(keyPosition.mTransitionEasing);
        this.mPathMotionArc = keyPosition.mPathMotionArc;
    }
    ...
    void different(MotionPaths motionPaths, boolean[] zArr, String[] strArr, boolean z) {
        ...
        zArr[1] = zArr[1] | diff(this.f199x, motionPaths.f199x) | z;
        zArr[2] = z | diff(this.f200y, motionPaths.f200y) | zArr[2];
    ...
    void setView(View view, int[] iArr, double[] dArr, double[] dArr2, double[] dArr3) {
        ...
        while (true) {
            ...
            if (zIsNaN && (dArr3 == null || dArr3[i2] == AudioStats.AUDIO_AMPLITUDE_NONE)) {
                f = f7;
                f2 = f3;
            } else {
                if (dArr3 != null) {
    ...
    void fillStandard(double[] dArr, int[] iArr) {
        float[] fArr = {this.position, this.f199x, this.f200y, this.width, this.height, this.mPathRotate};
        int i = 0;
        for (int i2 : iArr) {
            if (i2 < 6) {
                dArr[i] = fArr[r1];
