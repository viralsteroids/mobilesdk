...
public class WindowDecorActionBar extends ActionBar implements ActionBarOverlayLayout.ActionBarVisibilityCallback {
    ...
    private void init(View view) {
        ...
        this.mDecorToolbar = getDecorToolbar(view.findViewById(C0045R.id.action_bar));
        this.mContextView = (ActionBarContextView) view.findViewById(C0045R.id.action_context_bar);
        ...
        TypedArray typedArrayObtainStyledAttributes = this.mContext.obtainStyledAttributes(null, C0045R.styleable.ActionBar, C0045R.attr.actionBarStyle, 0);
        if (typedArrayObtainStyledAttributes.getBoolean(C0045R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int dimensionPixelSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(C0045R.styleable.ActionBar_elevation, 0);
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0045R.attr.actionBarWidgetTheme, typedValue, true);
