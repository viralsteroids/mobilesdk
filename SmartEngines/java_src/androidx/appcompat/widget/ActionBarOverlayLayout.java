...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent, NestedScrollingParent2, NestedScrollingParent3 {
    ...
    static final int[] ATTRS = {C0045R.attr.actionBarSize, R.attr.windowContentOverlay};
    private static final WindowInsetsCompat NON_EMPTY_SYSTEM_WINDOW_INSETS = new WindowInsetsCompat.Builder().setSystemWindowInsets(Insets.m315of(0, 1, 0, 1)).build();
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (!this.mOverlayMode && !z && decorFitsSystemWindows()) {
            ...
            this.mInnerInsets = new WindowInsetsCompat.Builder(this.mInnerInsets).setSystemWindowInsets(Insets.m315of(this.mInnerInsets.getSystemWindowInsetLeft(), this.mInnerInsets.getSystemWindowInsetTop() + measuredHeight, this.mInnerInsets.getSystemWindowInsetRight(), this.mInnerInsets.getSystemWindowInsetBottom())).build();
        }
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0045R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0045R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0045R.id.action_bar));
        }
    }
