...
public final class MailTo {
    ...
    /* renamed from: CC */
    private static final String f229CC = "cc";
    private static final String MAILTO = "mailto";
    public static final String MAILTO_SCHEME = "mailto:";
    private static final String SUBJECT = "subject";

    /* renamed from: TO */
    private static final String f230TO = "to";
    ...
    public static MailTo parse(String str) throws ParseException {
        ...
        mailTo.mHeaders.put(f230TO, strDecode);
        return mailTo;
    }
    ...
    public String getTo() {
        return this.mHeaders.get(f230TO);
    }

    public String getCc() {
        return this.mHeaders.get(f229CC);
    }
