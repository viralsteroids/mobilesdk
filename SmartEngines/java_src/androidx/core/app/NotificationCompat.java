...
public class NotificationCompat {
        ...
        */
        public RemoteViews applyStandardTemplate(boolean z, int i, boolean z2) throws Resources.NotFoundException {
            ...
            if (this.mBuilder.mLargeIcon != null) {
                remoteViews.setViewVisibility(C2022R.id.icon, 0);
                remoteViews.setImageViewBitmap(C2022R.id.icon, createColoredBitmap(this.mBuilder.mLargeIcon, 0));
                if (z && this.mBuilder.mNotification.icon != 0) {
                    int dimensionPixelSize = resources.getDimensionPixelSize(C2022R.dimen.notification_right_icon_size);
                    remoteViews.setImageViewBitmap(C2022R.id.right_icon, createIconWithBackground(this.mBuilder.mNotification.icon, dimensionPixelSize, dimensionPixelSize - (resources.getDimensionPixelSize(C2022R.dimen.notification_small_icon_background_padding) * 2), this.mBuilder.getColor()));
                    remoteViews.setViewVisibility(C2022R.id.right_icon, 0);
                }
            } else if (z && this.mBuilder.mNotification.icon != 0) {
                remoteViews.setViewVisibility(C2022R.id.icon, 0);
                remoteViews.setImageViewBitmap(C2022R.id.icon, createIconWithBackground(this.mBuilder.mNotification.icon, resources.getDimensionPixelSize(C2022R.dimen.notification_large_icon_width) - resources.getDimensionPixelSize(C2022R.dimen.notification_big_circle_margin), resources.getDimensionPixelSize(C2022R.dimen.notification_small_icon_size_as_large), this.mBuilder.getColor()));
            }
            if (this.mBuilder.mContentTitle != null) {
                remoteViews.setTextViewText(C2022R.id.title, this.mBuilder.mContentTitle);
            }
            boolean z5 = true;
            if (this.mBuilder.mContentText != null) {
                remoteViews.setTextViewText(C2022R.id.text, this.mBuilder.mContentText);
                z3 = true;
            } else {
                z3 = false;
            }
            if (this.mBuilder.mContentInfo != null) {
                remoteViews.setTextViewText(C2022R.id.info, this.mBuilder.mContentInfo);
                remoteViews.setViewVisibility(C2022R.id.info, 0);
            } else if (this.mBuilder.mNumber > 0) {
                if (this.mBuilder.mNumber > resources.getInteger(C2022R.integer.status_bar_notification_info_maxnum)) {
                    remoteViews.setTextViewText(C2022R.id.info, resources.getString(C2022R.string.status_bar_notification_info_overflow));
                } else {
                    remoteViews.setTextViewText(C2022R.id.info, NumberFormat.getIntegerInstance().format(this.mBuilder.mNumber));
                }
                remoteViews.setViewVisibility(C2022R.id.info, 0);
            } else {
                remoteViews.setViewVisibility(C2022R.id.info, 8);
                z4 = false;
                if (this.mBuilder.mSubText != null) {
                    remoteViews.setTextViewText(C2022R.id.text, this.mBuilder.mSubText);
                    if (this.mBuilder.mContentText != null) {
                        remoteViews.setTextViewText(C2022R.id.text2, this.mBuilder.mContentText);
                        remoteViews.setViewVisibility(C2022R.id.text2, 0);
                        if (z2) {
                            remoteViews.setTextViewTextSize(C2022R.id.text, 0, resources.getDimensionPixelSize(C2022R.dimen.notification_subtext_size));
                        }
                        remoteViews.setViewPadding(C2022R.id.line1, 0, 0, 0, 0);
                    } else {
                        remoteViews.setViewVisibility(C2022R.id.text2, 8);
                    }
                }
                if (this.mBuilder.getWhenIfShowing() != 0) {
                    z5 = z4;
                } else if (this.mBuilder.mUseChronometer) {
                    remoteViews.setViewVisibility(C2022R.id.chronometer, 0);
                    remoteViews.setLong(C2022R.id.chronometer, "setBase", this.mBuilder.getWhenIfShowing() + (SystemClock.elapsedRealtime() - System.currentTimeMillis()));
                    remoteViews.setBoolean(C2022R.id.chronometer, "setStarted", true);
                    if (this.mBuilder.mChronometerCountDown) {
                        Api24Impl.setChronometerCountDown(remoteViews, C2022R.id.chronometer, this.mBuilder.mChronometerCountDown);
                    }
                } else {
                    remoteViews.setViewVisibility(C2022R.id.time, 0);
                    remoteViews.setLong(C2022R.id.time, "setTime", this.mBuilder.getWhenIfShowing());
                }
                remoteViews.setViewVisibility(C2022R.id.right_side, !z5 ? 0 : 8);
                remoteViews.setViewVisibility(C2022R.id.line3, z3 ? 0 : 8);
                return remoteViews;
            }
            z3 = true;
            z4 = true;
        ...
        private Bitmap createIconWithBackground(int i, int i2, int i3, int i4) {
            int i5 = C2022R.drawable.notification_icon_background;
            if (i4 == 0) {
                i4 = 0;
            }
        ...
        public void buildIntoRemoteViews(RemoteViews remoteViews, RemoteViews remoteViews2) throws Resources.NotFoundException {
            ...
            remoteViews.removeAllViews(C2022R.id.notification_main_column);
            remoteViews.addView(C2022R.id.notification_main_column, remoteViews2.clone());
            remoteViews.setViewVisibility(C2022R.id.notification_main_column, 0);
            remoteViews.setViewPadding(C2022R.id.notification_main_column_container, 0, calculateTopPadding(), 0, 0);
        }

        private void hideNormalContent(RemoteViews remoteViews) {
            remoteViews.setViewVisibility(C2022R.id.title, 8);
            remoteViews.setViewVisibility(C2022R.id.text2, 8);
            remoteViews.setViewVisibility(C2022R.id.text, 8);
        }

        private int calculateTopPadding() throws Resources.NotFoundException {
            Resources resources = this.mBuilder.mContext.getResources();
            int dimensionPixelSize = resources.getDimensionPixelSize(C2022R.dimen.notification_top_pad);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C2022R.dimen.notification_top_pad_large_text);
    ...
    public static class CallStyle extends Style {
        ...
        private String getDefaultText() {
            int i = this.mCallType;
            if (i == 1) {
                return this.mBuilder.mContext.getResources().getString(C2022R.string.call_notification_incoming_text);
            }
            if (i == 2) {
                return this.mBuilder.mContext.getResources().getString(C2022R.string.call_notification_ongoing_text);
            }
            if (i != 3) {
                return null;
            }
            return this.mBuilder.mContext.getResources().getString(C2022R.string.call_notification_screening_text);
        }

        private Action makeNegativeAction() {
            int i = C2022R.drawable.ic_call_decline_low;
            int i2 = C2022R.drawable.ic_call_decline;
            if (this.mDeclineIntent == null) {
                return makeAction(i2, C2022R.string.call_notification_hang_up_action, this.mDeclineButtonColor, C2022R.color.call_notification_decline_color, this.mHangUpIntent);
            }
            return makeAction(i2, C2022R.string.call_notification_decline_action, this.mDeclineButtonColor, C2022R.color.call_notification_decline_color, this.mDeclineIntent);
        }

        private Action makeAnswerAction() {
            int i;
            int i2 = C2022R.drawable.ic_call_answer_video_low;
            int i3 = C2022R.drawable.ic_call_answer_low;
            int i4 = C2022R.drawable.ic_call_answer_video;
            int i5 = C2022R.drawable.ic_call_answer;
            ...
            int i6 = z ? i4 : i5;
            if (z) {
                i = C2022R.string.call_notification_answer_video_action;
            } else {
                i = C2022R.string.call_notification_answer_action;
            }
            return makeAction(i6, i, this.mAnswerButtonColor, C2022R.color.call_notification_answer_color, this.mAnswerIntent);
        }
    ...
    public static class DecoratedCustomViewStyle extends Style {
        ...
        private RemoteViews createRemoteViews(RemoteViews remoteViews, boolean z) {
            int iMin;
            int i = 0;
            RemoteViews remoteViewsApplyStandardTemplate = applyStandardTemplate(true, C2022R.layout.notification_template_custom_big, false);
            remoteViewsApplyStandardTemplate.removeAllViews(C2022R.id.actions);
            ...
            if (!z || nonContextualActions == null || (iMin = Math.min(nonContextualActions.size(), 3)) <= 0) {
                ...
                for (int i2 = 0; i2 < iMin; i2++) {
                    remoteViewsApplyStandardTemplate.addView(C2022R.id.actions, generateActionButton(nonContextualActions.get(i2)));
                }
            }
            remoteViewsApplyStandardTemplate.setViewVisibility(C2022R.id.actions, i);
            remoteViewsApplyStandardTemplate.setViewVisibility(C2022R.id.action_divider, i);
        ...
        private RemoteViews generateActionButton(Action action) {
            ...
            if (z) {
                i = C2022R.layout.notification_action_tombstone;
            } else {
                i = C2022R.layout.notification_action;
            }
            RemoteViews remoteViews = new RemoteViews(packageName, i);
            IconCompat iconCompat = action.getIconCompat();
            if (iconCompat != null) {
                remoteViews.setImageViewBitmap(C2022R.id.action_image, createColoredBitmap(iconCompat, C2022R.color.notification_action_color_filter));
            }
            remoteViews.setTextViewText(C2022R.id.action_text, action.title);
            if (!z) {
                remoteViews.setOnClickPendingIntent(C2022R.id.action_container, action.actionIntent);
            }
            remoteViews.setContentDescription(C2022R.id.action_container, action.title);
            return remoteViews;
        }
    ...
    public static class Action {
        ...
        public static final class WearableExtender implements Extender {
            ...
            public WearableExtender m7317clone() {
    ...
    public static final class WearableExtender implements Extender {
        ...
        /* renamed from: clone, reason: merged with bridge method [inline-methods] */
        public WearableExtender m7318clone() {
            WearableExtender wearableExtender = new WearableExtender();
    ...
    public static Bitmap reduceLargeIconSize(Context context, Bitmap bitmap) throws Resources.NotFoundException {
        if (bitmap != null && Build.VERSION.SDK_INT < 27) {
            ...
            int dimensionPixelSize = resources.getDimensionPixelSize(C2022R.dimen.compat_notification_large_icon_max_width);
            int dimensionPixelSize2 = resources.getDimensionPixelSize(C2022R.dimen.compat_notification_large_icon_max_height);
