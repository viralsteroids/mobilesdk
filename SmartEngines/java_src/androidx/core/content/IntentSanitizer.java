...
public class IntentSanitizer {
    ...
    public static final class Builder {
        ...
        public Builder allowAction(Predicate<String> predicate) {
            ...
            this.mAllowedActions = this.mAllowedActions.m340or(predicate);
            return this;
        }
        ...
        public Builder allowData(Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedData = this.mAllowedData.m340or(predicate);
            return this;
        }
        ...
        public Builder allowType(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedTypes = this.mAllowedTypes.m340or(predicate);
            return this;
        }
        ...
        public Builder allowCategory(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedCategories = this.mAllowedCategories.m340or(predicate);
            return this;
        }
        ...
        public Builder allowPackage(Predicate<String> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedPackages = this.mAllowedPackages.m340or(predicate);
            return this;
        }
        ...
        public Builder allowComponent(Predicate<ComponentName> predicate) {
            ...
            this.mAllowedComponents = this.mAllowedComponents.m340or(predicate);
            return this;
        }
        ...
        public Builder allowClipDataUri(Predicate<Uri> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipDataUri = this.mAllowedClipDataUri.m340or(predicate);
            return this;
        }

        public Builder allowClipData(Predicate<ClipData> predicate) {
            Preconditions.checkNotNull(predicate);
            this.mAllowedClipData = this.mAllowedClipData.m340or(predicate);
            return this;
        }
        ...
        public Builder allowExtra(String str, Predicate<Object> predicate) {
            ...
            this.mAllowedExtras.put(str, predicate2.m340or(predicate));
            return this;
        }
