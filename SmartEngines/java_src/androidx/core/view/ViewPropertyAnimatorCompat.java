...
public final class ViewPropertyAnimatorCompat {
    ...
    /* renamed from: x */
    public ViewPropertyAnimatorCompat m342x(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().x(f);
        }
    ...
    /* renamed from: y */
    public ViewPropertyAnimatorCompat m343y(float f) {
        View view = this.mView.get();
        if (view != null) {
            view.animate().y(f);
        }
    ...
    /* renamed from: z */
    public ViewPropertyAnimatorCompat m344z(float f) {
        View view = this.mView.get();
        if (view != null) {
            Api21Impl.m345z(view.animate(), f);
        }
        return this;
    }
    ...
    static class Api21Impl {
        ...
        /* renamed from: z */
        static ViewPropertyAnimator m345z(ViewPropertyAnimator viewPropertyAnimator, float f) {
