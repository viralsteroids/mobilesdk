...
public final class PausingDispatcherKt {
    ...
    @DebugMetadata(m532c = "androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2", m533f = "PausingDispatcher.jvm.kt", m534i = {0}, m535l = {205}, m536m = "invokeSuspend", m537n = {"controller"}, m538s = {"L$0"})
    /* renamed from: androidx.lifecycle.PausingDispatcherKt$whenStateAtLeast$2 */
    static final class C24132<T> extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super T>, Object> {
        ...
        C24132(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super C24132> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C24132 c24132 = new C24132(this.$this_whenStateAtLeast, this.$minState, this.$block, continuation);
            c24132.L$0 = obj;
            return c24132;
        }
        ...
        public final Object invoke(CoroutineScope coroutineScope, Continuation<? super T> continuation) {
            return ((C24132) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T> Object whenStateAtLeast(Lifecycle lifecycle, Lifecycle.State state, Function2<? super CoroutineScope, ? super Continuation<? super T>, ? extends Object> function2, Continuation<? super T> continuation) {
        return BuildersKt.withContext(Dispatchers.getMain().getImmediate(), new C24132(lifecycle, state, function2, null), continuation);
    }
}
