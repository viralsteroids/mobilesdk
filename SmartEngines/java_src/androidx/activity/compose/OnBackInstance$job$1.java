...
@DebugMetadata(m532c = "androidx.activity.compose.OnBackInstance$job$1", m533f = "PredictiveBackHandler.kt", m534i = {0}, m535l = {121}, m536m = "invokeSuspend", m537n = {"completed"}, m538s = {"L$0"})
...
final class OnBackInstance$job$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (this.$callback.getIsEnabled()) {
                ...
                Flow<BackEventCompat> flowOnCompletion = FlowKt.onCompletion(FlowKt.consumeAsFlow(this.this$0.getChannel()), new C00301(booleanRef2, null));
    ...
    /* compiled from: PredictiveBackHandler.kt */
    @Metadata(m513d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0003\u0010\u0000\u001a\u00020\u0001*\b\u0012\u0004\u0012\u00020\u00030\u00022\b\u0010\u0004\u001a\u0004\u0018\u00010\u0005H\u008a@"}, m514d2 = {"<anonymous>", "", "Lkotlinx/coroutines/flow/FlowCollector;", "Landroidx/activity/BackEventCompat;", "it", ""}, m515k = 3, m516mv = {1, 8, 0}, m518xi = 48)
    @DebugMetadata(m532c = "androidx.activity.compose.OnBackInstance$job$1$1", m533f = "PredictiveBackHandler.kt", m534i = {}, m535l = {}, m536m = "invokeSuspend", m537n = {}, m538s = {})
    /* renamed from: androidx.activity.compose.OnBackInstance$job$1$1 */
    static final class C00301 extends SuspendLambda implements Function3<FlowCollector<? super BackEventCompat>, Throwable, Continuation<? super Unit>, Object> {
        final /* synthetic */ Ref.BooleanRef $completed;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C00301(Ref.BooleanRef booleanRef, Continuation<? super C00301> continuation) {
        ...
        public final Object invoke(FlowCollector<? super BackEventCompat> flowCollector, Throwable th, Continuation<? super Unit> continuation) {
            return new C00301(this.$completed, continuation).invokeSuspend(Unit.INSTANCE);
        }
