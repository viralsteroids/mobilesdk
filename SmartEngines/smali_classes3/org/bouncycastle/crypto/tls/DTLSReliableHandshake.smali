...
.method private processRecord(II[BII)Z
    ...
    invoke-static {v4, v1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->readUint24([BI)I
    ...
    :cond_1
    invoke-static {v4, v9}, Lorg/bouncycastle/crypto/tls/TlsUtils;->readUint8([BI)S
    ...
    invoke-static {v4, v1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->readUint16([BI)I

    move-result v1

    iget v5, v0, Lorg/bouncycastle/crypto/tls/DTLSReliableHandshake;->next_receive_seq:I
    ...
    invoke-direct {v5, v2, v3}, Lorg/bouncycastle/crypto/tls/DTLSReassembler;-><init>(SI)V

    iget-object v12, v0, Lorg/bouncycastle/crypto/tls/DTLSReliableHandshake;->currentInboundFlight:Ljava/util/Hashtable;
    ...
    invoke-direct {v0}, Lorg/bouncycastle/crypto/tls/DTLSReliableHandshake;->resendOutboundFlight()V
...
.method receiveMessage()Lorg/bouncycastle/crypto/tls/DTLSReliableHandshake$Message;
    ...
    invoke-virtual {v0, v7, v1, v3, v2}, Lorg/bouncycastle/crypto/tls/DTLSRecordLayer;->receive([BIII)I
    ...
    invoke-virtual {v0}, Lorg/bouncycastle/crypto/tls/DTLSRecordLayer;->getReadEpoch()I
    ...
    invoke-direct {v3, v5}, Lorg/bouncycastle/crypto/tls/TlsFatalAlert;-><init>(S)V
